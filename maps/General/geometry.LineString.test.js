ymaps.modules.define(util.testfile(), [
    ...
    "geometry.LineString",
    "util.math.areEqual"
], function (provide, Map, LineString, areEqual) {
    ...
    describe('geometry.LineString', function () {
        ...
        it('Метод getPixelGeometry должен вернуть корректно значение координат', function () {
            ...
            var pixels = line.getPixelGeometry().getCoordinates();
            pixels = [
        ...
        it('Должен раскодировать координаты', function () {
            var geometry = LineString.fromEncodedCoordinates("6qE9AjZzUgN1-v__v_X__x_1__-dBgAA");
            expect(geometry.getCoordinates()).to.be.eql([
                [37.593578, 55.735094],
        ...
        it('Должен декодировать координаты', function () {
            var geometry = new LineString([
                ...
                encoded = LineString.toEncodedCoordinates(geometry);
            expect(encoded).to.be.eql("6qE9AjZzUgN1-v__v_X__x_1__-dBgAA");
        });
