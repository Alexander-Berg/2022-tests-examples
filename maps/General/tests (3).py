...
from maps.qa.geo_devices.usage_stat_report.lib.eval_report import (
    parse_yt_data,
    create_usage_statistics_st_report
)
...
def data_path(filename):
    return source_path('maps/qa/geo_devices/usage_stat_report/ut/data/' + filename)
...
class Tests(unittest.TestCase):
    ...
    def test_create_usage_statistics_st_report(self):
        input_data = read_json_file(data_path('parsed_yt_data.json'))
        output = create_usage_statistics_st_report(input_data)
