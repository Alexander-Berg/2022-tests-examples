...
namespace maps::wiki::infopoints_hypgen::migrations::tests {

namespace {

const std::string MIGRATIONS_PATH =
    ArcadiaSourceRoot() + "/maps/wikimap/infopoints_hypgen/migrations/migrations";
...
Y_UNIT_TEST(test_apply_migrations)
{
    ...
    postgres.createExtension("postgis");
