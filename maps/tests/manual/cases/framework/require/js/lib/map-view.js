define(['ready!ymaps', 'module'], function (ymaps, module) {
    ...
    MapView.prototype = {
        ...
        _createFixLayer: function () {
            return new ymaps.Layer("//yandex.ru/company/i/researches/2013/music_ua/notfound.png", {
                zIndex: 0,
                notFoundTile: "//yandex.ru/company/i/researches/2013/music_ua/notfound.png"
            });
        }
    };
