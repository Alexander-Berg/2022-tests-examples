define(['ready!ymaps'], function (ymaps) {
    ...
    UserLayerMapView.prototype = {
        ...
        _createLayer: function (data) {
            return function () {
                var layer = new ymaps.Layer("https://download.yandex.ru/company/figures/2014/series/" + data.tileUrlTemplate, {
                    tileTransparent: !data.isTransparent,
                    notFoundTile: "https://download.yandex.ru/company/figures/2014/series/" + data.notFoundTile
                });
