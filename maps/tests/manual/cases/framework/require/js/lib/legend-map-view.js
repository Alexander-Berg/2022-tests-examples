define(['ready!ymaps', 'module'], function (ymaps, module) {
    ...
    /**
     * Макет контрола.
     * @see https://api.yandex.ru/maps/doc/jsapi/2.x/ref/reference/templateLayoutFactory.xml
     * @class
    ...
    LegendControl.prototype = {
        ...
        setParent: function (parent) {
             ...
             * @see https://api.yandex.ru/maps/doc/jsapi/2.x/ref/reference/ILayout.xml#constructor-summary
             */
         ...
         * @see https://api.yandex.ru/maps/doc/jsapi/2.x/ref/reference/IControl.xml#getParent
         * @function
