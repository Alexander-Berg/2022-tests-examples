...
{
    static const std::string REFERENCE_IMAGES_ROOT = "/maps/factory/services/renderer/tests/data/";
...
std::string makeNewName(std::string name, Gateway& gateway)
{
    ...
    ASSERT(name.size() > s.size());
    // Result will have the same size as the original name.
