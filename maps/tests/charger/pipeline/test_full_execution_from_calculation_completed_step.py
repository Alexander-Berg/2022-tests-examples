...
@pytest.fixture
def pipeline_from_calculation_completed(
...
async def test_full_execution_from_calculation_completed_step(
    pipeline_from_calculation_completed, ch_client
):
    await pipeline_from_calculation_completed()
    ...
    expected_events = [
        make_event(*args)
        for args in (
            (4242, 10, "pin.show", Decimal(10)),  # prev day
            (4242, 10000, "pin.show", Decimal(10)),
            (4242, 86450, "pin.show", Decimal(10)),  # current day
            (4242, 86460, "pin.show", Decimal(10)),
            (4242, 86470, "pin.show", Decimal(10)),
            (4356, 86300, "pin.show", Decimal(5)),  # prev day
            (4356, 86450, "pin.show", Decimal(5)),  # current day
            (4356, 150000, "pin.show", Decimal(5)),
            (1242, 86000, "pin.show", Decimal(2)),  # prev day
            (1242, 172000, "pin.show", Decimal(10)),  # current day
            (7653, 86450, "pin.show", Decimal(10)),  # campaign is closed
            # new events added
            (4242, 86500, "pin.show", Decimal(2)),
            (4242, 86600, "pin.show", Decimal(3)),
            (4242, 86700, "pin.show", Decimal(3)),
            (4242, 86800, "pin.show", Decimal(3)),
            (4356, 86750, "pin.show", Decimal(4)),
            (1242, 86550, "pin.show", Decimal(5)),
            (1242, 86555, "pin.show", Decimal(5)),
        )
    ]
