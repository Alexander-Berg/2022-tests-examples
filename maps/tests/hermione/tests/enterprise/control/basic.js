describe('Энтерпрайз: enterprise/control/basic.html', function () {
    beforeEach(function () {
        return this.browser
            .openUrl('enterprise/control/basic.html', {enterprise: true})
            .waitReady();
    });

    it('Энтерпрайз: Строится простой маршрут', function () {
        return this.browser
    ...
    it('Энтерпрайз: Cтроится маршрут через границу', function () {
        return this.browser
    ...
    it('Энтерпрайз: Работает простой поиск', function () {
        return this.browser
    ...
    it('Энтерпрайз: Работает фулскрин', function () {
        return this.browser
    ...
    it('Энтерпрайз: Работает линейка', function () {
        return this.browser
    ...
    it('Энтерпрайз: Работает ПС', function () {
        return this.browser
    ...
    it('Энтерпрайз: Клик по надписи Яндекс перемещает на БЯК', function () {
        return this.browser
    ...
    it('Энтерпрайз: в выпадушке только один слой', function () {
        return this.browser
            .waitAndClick(PO.map.controls.listbox())
            .waitForVisible(PO.map.controls.listbox.selectedItem())
            .csVerifyMapScreenshot(PO.mapId(), 'mapWithListbox');
    });
});