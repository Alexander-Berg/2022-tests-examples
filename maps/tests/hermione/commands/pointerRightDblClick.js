/**
 * Поинтер даблклик правой кнопкой по координатам или элементу
 *
 * @name browser.pointerRightDblClick
...
module.exports = function (...args) {
    ...
    if (this.desiredCapabilities.browserName === 'firefox') {
        this.rightDblClickActions = function () {
            return this
                .actions([{
                    type: 'pointer',
                    id: 'mouse1',
        ...
        if (args.length === 2) {
            return this.rightDblClickActions()
        } else {
            return this
