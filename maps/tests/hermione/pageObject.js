var JsapiVersion = require('jsapi-version'),
    PO = {},
    cs = {},
    pageObject = require('@yandex-int/bem-page-object'),
    El = pageObject.Entity,
    parsed = JsapiVersion.parse(require('../../.qtools.json').registry.tag),
    yamaps = 'ymaps-' + parsed.withoutBuild().replace(/\./g, '-') + '-';
PO.link = new El('a');
...
PO.map.controls.zoom.plus = new El({block: yamaps + 'zoom', elem: 'plus'}).child(PO.ymaps);
...
PO.map.controls.zoom.minus = new El({block: yamaps + 'zoom', elem: 'minus'}).child(PO.ymaps);
...
PO.map.statusTime =  new El({ block: yamaps + 'islets_card__status-time'});
...
PO.map.controls.button =  new El({ block: yamaps + 'float-button'});
...
PO.map.controls.routeButton.panel.routeType.mass =  new El({ block: yamaps + 'route-panel-types', elem: 'type_masstransit'});
PO.map.controls.routeButton.panel.routeType.pedestrian =  new El({ block: yamaps + 'route-panel-types', elem: 'type_pedestrian'});
...
PO.map.controls.routeButton.panel.emptyInput =  new El({ block: yamaps + 'route-panel-input_empty'});

PO.map.controls.routePanel =  new El({ block: yamaps + 'route-panel'});
PO.map.controls.routePanel.svgB =  new El({ block: yamaps + 'route-panel-input', elem: 'icon_last'});
PO.map.controls.routePanel.routeType =  new El({ block: yamaps + 'route-panel-types'});
PO.map.controls.routePanel.routeType.auto =  new El({ block: yamaps + 'route-panel-types', elem: 'type_auto'});
PO.map.controls.routePanel.routeType.mass =  new El({ block: yamaps + 'route-panel-types', elem: 'type_masstransit'});
PO.map.controls.routePanel.routeType.pedestrian =  new El({ block: yamaps + 'route-panel-types', elem: 'type_pedestrian'});
PO.map.controls.routePanel.clear =  new El({ block: yamaps + 'route-panel', elem: 'clear'});
PO.map.controls.routePanel.location =  new El({ block: yamaps + 'route-panel-input', elem: 'location'});
PO.map.controls.routePanel.emptyInput =  new El({ block: yamaps + 'route-panel-input_empty'});
...
PO.map.dotIcon =  new El({ block: yamaps + 'islets_circle-dot-icon-with-caption'});
PO.map.placemark.svgIcon =  new El({ block: yamaps + 'svg-icon'});
PO.map.placemark.placemark =  new El({ block: yamaps + 'placemark-overlay'});
PO.map.placemark.placemark.redPlacemark =  new El({ block: yamaps + 'placemark_theme_red'});
PO.map.placemark.placemark.icon =  new El({ block: yamaps + 'islets_icon-with-caption'});
...
PO.map.balloon.layout =  new El({ block: yamaps + 'balloon__layout'});
...
PO.map.balloon.accordionItemTitle5 =  PO.map.balloon.accordionMenu.child(PO.ymaps).nthType(4);
...
PO.routePoints.pinB = new El({ block: yamaps + 'route-pin', elem: 'label-1'});
...
PO.routePoints.pedestrianPin = new El({ block: yamaps + 'transport-pin_tail_pedestrian'});

PO.pageError = new El('body .log_fail');
PO.pageReady = new El('body #ready_for_act');
PO.pageContainer = new El('body .container');
PO.pageLog = new El('body #logger');
PO.pageResult = new El('body #result');
PO.counterButton = new El('body #counter-button');

PO.geolink = new El({block: yamaps + 'geolink-processed'});
PO.geolink.popup = new El({block: yamaps + 'geolink-popup'});
PO.geolink.popup.close = new El({block: yamaps + 'geolink-popup', elem: 'close'});
PO.geolink.popup.header = new El({block: yamaps + 'geolink-popup', elem: 'header'});
PO.geolink.popup.map = new El({block: yamaps + 'geolink-popup', elem: 'map'});
PO.geolink.popup.footer = new El({block: yamaps + 'geolink-popup', elem: 'footer'});
PO.geolink.popup.footer.more = new El({block: yamaps + 'geolink-popup', elem: 'footer-cell-1'});
PO.geolink.popup.footer.howToGet = new El({block: yamaps + 'geolink-popup', elem: 'footer-cell-2'});

PO.panorama = new El({block: yamaps + 'panorama-screen'});
PO.panorama.plus = new El({block: yamaps + 'islets_button-icon_plus'});
PO.panorama.minus = new El({block: yamaps + 'islets_button-icon_minus'});

PO.maps = new El({block: 'body'});
PO.maps.routeInput = new El({block: 'input_medium__control'});
module.exports.PO = pageObject.create(PO);

cs = {
    geoObject: {
        cluster: {
            smallIcon: '[class^=ymaps][class*=islands_clusterSmallIcon] ymaps ymaps',
            smallInvertedIcon: '[class^=ymaps][class*=islands_clusterSmallInvertedIcon] ymaps ymaps',
            pieChart: '[class^=ymaps][class*=-pie-chart]'
        }
    }
};
