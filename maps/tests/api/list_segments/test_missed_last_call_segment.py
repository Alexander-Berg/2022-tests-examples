...
async def test_segments_as_missed_last_call_if_last_call_is_not_answered(
    ...
    assert parse_pb_segment_sizes(got, SegmentTypePb.MISSED_LAST_CALL)[0] == 1
...
async def test_does_not_segment_as_missed_last_call_if_events_does_not_match_conditions(
    ...
    assert parse_pb_segment_sizes(got, SegmentTypePb.MISSED_LAST_CALL)[0] == 0
...
async def test_counts_several_clients_as_expected(factory, api):
    ...
    assert parse_pb_segment_sizes(got, SegmentTypePb.MISSED_LAST_CALL)[0] == 2
...
async def test_returns_previous_segment_size(factory, api):
    ...
    assert parse_pb_segment_sizes(got, SegmentTypePb.MISSED_LAST_CALL)[1] == 3
