...
INSERT INTO revision.branch (id, type, state, created, created_by, finished, finished_by, attributes) VALUES (0, 'trunk', 'normal', '2015-05-12 18:15:06.995955+03', 0, NULL, 0, NULL);
...
INSERT INTO revision.commit (id, state, trunk, created, created_by, attributes, stable_branch_id, approve_order) VALUES (1, 'draft', true, '2014-08-22 00:21:10.828976+04', 127525902, '"action"=>"object-created", "primary-objects"=>"3"', NULL, 0);
INSERT INTO revision.commit (id, state, trunk, created, created_by, attributes, stable_branch_id, approve_order) VALUES (2, 'draft', true, '2014-08-22 00:21:44.44635+04', 127525902, '"action"=>"object-created", "primary-objects"=>"11"', NULL, 0);
INSERT INTO revision.commit (id, state, trunk, created, created_by, attributes, stable_branch_id, approve_order) VALUES (3, 'draft', true, '2014-08-22 00:22:01.412288+04', 127525902, '"action"=>"object-created", "primary-objects"=>"22"', NULL, 0);
INSERT INTO revision.commit (id, state, trunk, created, created_by, attributes, stable_branch_id, approve_order) VALUES (4, 'draft', true, '2014-08-22 00:22:54.290984+04', 127525902, '"action"=>"object-modified", "primary-objects"=>"11"', NULL, 0);
INSERT INTO revision.commit (id, state, trunk, created, created_by, attributes, stable_branch_id, approve_order) VALUES (5, 'draft', true, '2014-08-22 00:23:32.97145+04', 127525902, '"action"=>"object-modified", "primary-objects"=>"11"', NULL, 0);
INSERT INTO revision.commit (id, state, trunk, created, created_by, attributes, stable_branch_id, approve_order) VALUES (6, 'draft', true, '2014-08-22 00:23:47.779221+04', 127525902, '"action"=>"object-modified", "primary-objects"=>"2"', NULL, 0);
INSERT INTO revision.commit (id, state, trunk, created, created_by, attributes, stable_branch_id, approve_order) VALUES (7, 'draft', true, '2014-08-22 00:24:06.883708+04', 127525902, '"action"=>"object-deleted", "primary-objects"=>"11"', NULL, 0);
