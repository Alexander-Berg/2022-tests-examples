...
exports.ymapsmlResponse = exports.ymapsmlXml = void 0;
...
`;
exports.ymapsmlResponse = { "response": { "ymaps": { "schemaLocation": "http://maps.yandex.ru/schemas/ymaps/1.x/ymaps.xsd", "GeoObjectCollection": { "featureMembers": [{ "GeoObject": { "name": "Многоугольник", "description": "Внешняя граница многоугольника представляет собой замкнутую ломаную линию", "Polygon": { "exterior": { "polylod": { "polyline": "srELAnF7rgNtSAAAkyMAAKg1AACFEAAAzxoAAMji__8cZ___IOn__w==", "levels": "", "maxlevel": "" } } } } }] } } } };
