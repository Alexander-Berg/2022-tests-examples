...
public class BackgroundService extends Service {
    private static String TAG = "BackgroundGuidanceService";
    ...
    public void onCreate() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(
                this, NotificationChannels.BG_GUIDANCE_CHANNEL_ID);
        builder.setContentTitle("Background guidance running");
