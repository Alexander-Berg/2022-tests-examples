...
describe('Admin V.', function () {
  beforeEach(function () {
    cy.preserveCookies();
  });

  before(function () {
    cy.yandexLogin('companyVadmin');
    cy.get(selectors.content.dashboard.view).should('exist');
  });

  describe('Work with other companies', function () {
    // @see https://testpalm.yandex-team.ru/testcase/courier-133
  ...
  describe('Dashboard couriers', function () {
    // @see https://testpalm.yandex-team.ru/testcase/courier-134
  ...
  describe('Orders', function () {
    ...
    // @see https://testpalm.yandex-team.ru/testcase/courier-181
