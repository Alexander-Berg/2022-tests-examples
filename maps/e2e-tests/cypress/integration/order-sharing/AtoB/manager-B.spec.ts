...
describe('Manager B.', function () {
  beforeEach(function () {
    cy.preserveCookies();
  });

  before(function () {
    cy.yandexLogin('companyBmanager');
    cy.get(selectors.content.dashboard.view).should('exist');
  });

  describe('Work with other companies', function () {
    // @see https://testpalm.yandex-team.ru/testcase/courier-128
    ...
    // @see https://testpalm.yandex-team.ru/testcase/courier-129
    it('Goto company А', function () {
      cy.fixture('company-data').then(({ A }) => {
  ...
  describe('Dashboard couriers', function () {
    // @see https://testpalm.yandex-team.ru/testcase/courier-180
    it('Couriers is visivle in dashboard', function () {
    ...
    // @see https://testpalm.yandex-team.ru/testcase/courier-131
  ...
  describe('Depots', function () {
    // @see https://testpalm.yandex-team.ru/testcase/courier-178
