            ...
            report = {
              ...
              cookie_policy = {
                ...
                regexp = {
                  ...
                  __webauth_save_oauth_token = {
                    priority = 2;
                    match_fsm = {
                      path = "/__webauth_save_oauth_token";
                      case_insensitive = true;
                      surround = false;
                    }; -- match_fsm
                    shared = {
                      uuid = "3155432675693370524";
                      headers = {
                        create = {
                          ...
                          actions = {
                            {
                              ...
                              rewrite = "/save_oauth_token%1";
                              regexp = "/__webauth_save_oauth_token(.*)";
                            };
                          }; -- actions
                          shared = {
                            uuid = "3586658050146286302";
                            balancer2 = {
                              retry_policy = {
                                unique_policy = {};
                              }; -- retry_policy
