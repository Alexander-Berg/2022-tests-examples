...
public class SecurityPatcherV1Test extends SecurityPatcherV1BaseTest {
    ...
    private static Stream<Arguments> enableSoxSecurityFeaturesTestParameters() {
        return Stream.of(
                ...
                //// Arguments with disable default child-only and secret env == true
                // Arguments with sox == false
                Arguments.of(
                        false,
                        POD_AGENT_BINARY_RESOURCE_META_AFFECTED,
