...
instance = {
  ...
  addrs = {
    ...
    {
      ip = "::1";
      port = __BALANCER_PORT__;
      disabled = get_int_var("disable_external", 0);
    };
  }; -- addrs
  sd = {
    client_name = "awacs-l7-balancer(xxx)";
    host = "::1";
    port = __SD_PORT__;
  ...
  ipdispatch = {
    ...
    https_section = {
      ...
      errorlog = {
        log_level = "ERROR";
        log = get_log_path("error_log", __BALANCER_PORT__, "/place/db/www/logs");
        ssl_sni = {
          force_ssl = true;
          events = {
            stats = "report";
          ...
          contexts = {
            default = {
              ...
              log = get_log_path("ssl_sni", __BALANCER_PORT__, "/place/db/www/logs");
              priv = get_private_cert_path("_.awacslet.yandex.net.pem", "/dev/shm/balancer/priv");
              cert = get_public_cert_path("allCAs-_.awacslet.yandex.net.pem", "/dev/shm/balancer");
              ticket_keys_list = {
                {
                  priority = 3;
                  keyfile = get_private_cert_path("1st._.awacslet.yandex.net.key", "/dev/shm/balancer/priv");
                };
                {
                  priority = 2;
                  keyfile = get_private_cert_path("2nd._.awacslet.yandex.net.key", "/dev/shm/balancer/priv");
                };
                {
                  priority = 1;
                  keyfile = get_private_cert_path("3rd._.awacslet.yandex.net.key", "/dev/shm/balancer/priv");
                };
              }; -- ticket_keys_list
            }; -- default
          }; -- contexts
          http = {
            ...
            no_keepalive_file = "./controls/keepalive_disabled";
              ...
              accesslog = {
                log = get_log_path("access_log", __BALANCER_PORT__, "/place/db/www/logs");
                report = {
                  uuid = "http";
                  ...
                  regexp = {
                    ...
                    default = {
                      ...
                      errordocument = {
                        status = 200;
                        content = "Hey! I am powered by awacslet!";
                      }; -- errordocument
                    }; -- default
                  }; -- regexp
                }; -- report
