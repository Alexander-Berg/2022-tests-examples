...
instance = {
  ...
  sd = {
    client_name = "awacs-l7-balancer(test-namespace:balancer-id_sas)";
    host = "sd.yandex.net";
    port = 8080;
                    ...
                    balancer2 = {
                      ...
                      rr = {
                        ...
                        hey2_man = {
                          weight = 1.000;
                          report = {
                            uuid = "requests_upstream-1-id_to_man";
                            ranges = get_str_var("default_ranges");
                            just_storage = false;
                            disable_robotness = true;
                            disable_sslness = true;
                            ...
                            balancer2 = {
                              ...
                              dynamic = {
                                ...
                                backends_name = "backend_1";
                                unpack(gen_proxy_backends({
                                  { "1-instance.yandex.ru"; 80; 1.000; "::1"; };
                                }, {
                        ...
                        hey2_devnull = {
                          weight = -1.000;
                          report = {
                            uuid = "requests_upstream-1-id_to_devnull";
                            ranges = get_str_var("default_ranges");
                            just_storage = false;
                            disable_robotness = true;
                            disable_sslness = true;
