...
import ru.yandex.webmaster3.core.semantic.semantic_document_parser.struct_data.MusicRecording;
 ...
 */
public class MusicRecordingSerializer implements EntitySerializer {
    @Override
    public String serialize(Entity e) throws JSONException {
        if(e.getTag().equals("MusicRecordingOrgEntity")){
            ...
            String newStr = prettyFormat(XML.toString(EntityToClearJsonSerializer.toClearJson(e), "musicrecording"), 0);
            ...
            Element element = (Element) doc.getElementsByTagName("musicrecording").item(0);

            // Adds a new attribute. If an attribute with that name is already present
            // in the element, its value is changed to be that of the value parameter
            element.setAttribute("type-id", "19.1");
    ...
    public String testMusicGroup(String urlSource) throws Exception {
        ...
        for (final Microdata data : result) {
            final MusicRecording org =
                    StructuredDataTransformers.fromSchemaOrgMusicRecording((ComplexMicrodata) data, url.toString());
            if (org != null) {
