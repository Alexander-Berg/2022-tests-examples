...
import ru.yandex.webmaster3.core.semantic.semantic_document_parser.struct_data.Chords;
...
/**
 * Created by aleksart on 09.07.14.
 */
public class ChordsSerializer implements EntitySerializer {
    @Override
    public String serialize(Entity e) throws JSONException {
        if(e.getTag().equals("ChordsOrgEntity")){
            ...
            String newStr = prettyFormat(XML.toString(EntityToClearJsonSerializer.toClearJson(e), "chords"), 0);
            ...
            Element element = (Element) doc.getElementsByTagName("chords").item(0);

            // Adds a new attribute. If an attribute with that name is already present
            // in the element, its value is changed to be that of the value parameter
            element.setAttribute("type-id", "23");
    ...
    public String testWork(String urlSource) throws Exception {
        ...
        for (final Microdata data : result) {
            final Chords org =
                    StructuredDataTransformers.fromSchemaOrgChords((ComplexMicrodata) data, url.toString(), "eng");
            if (org != null) {
