...
DIFF_TOOL_TIMEOUT = 300


def test_b2b(stand):
    trim_data = False
    profiles = get_profiles(stand, problems_interval_seconds=None, problems_max_count=None, trim_data=trim_data, resharder_enabled=False)

    # differ will be included in next patch
