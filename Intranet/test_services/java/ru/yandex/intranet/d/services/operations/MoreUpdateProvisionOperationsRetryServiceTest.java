 ...
 */
@IntegrationTest
public class MoreUpdateProvisionOperationsRetryServiceTest {
    ...
    public void testSuccessAfterRefreshNoAccountsSpacePushOperationIdMatch() {
        ...
        Assertions.assertEquals(195L, updatedQuotas.get(0).getBalance());
        ...
        Assertions.assertEquals(105L, updatedProvisions.get(0).getProvidedQuota());
        Assertions.assertEquals(75L, updatedProvisions.get(0).getAllocatedQuota());
        ...
        Assertions.assertEquals(new QuotasByResource(Map.of(resource.getId(), 200L)), newOpLog.get(0).getOldBalance());
        Assertions.assertEquals(new QuotasByResource(Map.of(resource.getId(), 195L)), newOpLog.get(0).getNewBalance());
        ...
        Assertions.assertEquals(new QuotasByAccount(Map.of(account.getId(),
                new ProvisionsByResource(Map.of(resource.getId(), new ProvisionHistoryModel(105L, null))))),
    ...
    @Test
    @SuppressWarnings("MethodLength")
    public void testTwoFailuresNoAccountsSpacePush() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, false,
                true, true, false, false, false, false, true);
        FolderModel folder = folderModel(1L);
        ResourceTypeModel resourceType = resourceTypeModel(provider.getId(), "test",
        ...
        stubProviderService.setGetAccountResponses(
                List.of(
                        ...
                        GrpcResponse.failure(new StatusRuntimeException(Status.INVALID_ARGUMENT, new Metadata())),
                        GrpcResponse.failure(new StatusRuntimeException(Status.INVALID_ARGUMENT, new Metadata())),
                        GrpcResponse.failure(new StatusRuntimeException(Status.INVALID_ARGUMENT, new Metadata()))
                )
        );
    ...
    @Test
    @SuppressWarnings("MethodLength")
    public void testNextIterationAfterRefreshNoAccountsSpacePush() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, false,
                true, true, false, false, false, false, true);
        FolderModel folder = folderModel(1L);
        ResourceTypeModel resourceType = resourceTypeModel(provider.getId(), "test",
        ...
        stubProviderService.setGetAccountResponses(
                List.of(
                        GrpcResponse.failure(new StatusRuntimeException(Status.UNAVAILABLE, new Metadata())),
                        GrpcResponse.failure(new StatusRuntimeException(Status.UNAVAILABLE, new Metadata())),
                        GrpcResponse.failure(new StatusRuntimeException(Status.UNAVAILABLE, new Metadata()))
                )
        );
        ...
        Assertions.assertEquals(AccountsQuotasOperationsModel.RequestStatus.WAITING,
                updatedOperation.get().getRequestStatus().get());
        Assertions.assertTrue(updatedOperation.get().getOrders().getCloseOrder().isEmpty());
        Assertions.assertFalse(updatedOperation.get().getErrorMessage().isPresent());
        List<OperationInProgressModel> inProgressAfter = tableClient.usingSessionMonoRetryable(session ->
                session.usingTxMonoRetryable(TransactionMode.SERIALIZABLE_READ_WRITE, txSession ->
                        operationsInProgressDao.getAllByTenant(txSession, Tenants.DEFAULT_TENANT_ID)))
                .block();
        ...
        Assertions.assertEquals(40L, updatedQuotas.get(0).getFrozenQuota());
        List<AccountsQuotasModel> updatedProvisions = tableClient.usingSessionMonoRetryable(session -> session
                .usingTxMonoRetryable(TransactionMode.SERIALIZABLE_READ_WRITE, txSession -> accountsQuotasDao
                        .getAllByAccountIds(txSession, Tenants.DEFAULT_TENANT_ID, Set.of(account.getId()))))
                .block();
    ...
    @Test
    @SuppressWarnings("MethodLength")
    public void testNextIterationAfterRetryNoAccountsSpacePush() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, false,
                true, true, false, false, false, false, true);
        FolderModel folder = folderModel(1L);
        ResourceTypeModel resourceType = resourceTypeModel(provider.getId(), "test",
    ...
    @Test
    @SuppressWarnings("MethodLength")
    public void testNextIterationAfterPostRetryRefreshNoAccountsSpacePush() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, false,
                true, true, false, false, false, false, true);
        FolderModel folder = folderModel(1L);
        ResourceTypeModel resourceType = resourceTypeModel(provider.getId(), "test",
    ...
    @Test
    @SuppressWarnings("MethodLength")
    public void testSuccessAfterRetryNoAccountsSpacePushRefreshNotSupported() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, false,
                true, true, false, false, false, false, true);
        FolderModel folder = folderModel(1L);
        ResourceTypeModel resourceType = resourceTypeModel(provider.getId(), "test",
    ...
    @Test
    @SuppressWarnings("MethodLength")
    public void testSuccessAfterRefreshNoAccountsSpacePushOperationIdAndVersionMatch() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, false,
                                ...
                                Account.newBuilder()
                                        ...
                                        .addProvisions(Provision.newBuilder()
                                                ...
                                                .setLastUpdate(LastUpdate.newBuilder()
                                                        .setOperationId(operation.getOperationId())
                                                        .build())
                                                .setVersion(CurrentVersion.newBuilder()
                                                        .setVersion(2L)
                                                        .build())
                                                .build())
                                        .build()
        ...
        Assertions.assertEquals(105L, updatedProvisions.get(0).getProvidedQuota());
        Assertions.assertEquals(75L, updatedProvisions.get(0).getAllocatedQuota());
        Assertions.assertTrue(updatedProvisions.get(0).getLastReceivedProvisionVersion().isPresent());
        Assertions.assertEquals(2L, updatedProvisions.get(0).getLastReceivedProvisionVersion().get());
        Assertions.assertTrue(updatedProvisions.get(0).getLatestSuccessfulProvisionOperationId().isPresent());
        Assertions.assertEquals(operation.getOperationId(), updatedProvisions.get(0)
                .getLatestSuccessfulProvisionOperationId().get());
        List<FolderOperationLogModel> newOpLog = tableClient.usingSessionMonoRetryable(session -> session
        ...
        Assertions.assertEquals(new QuotasByResource(Map.of(resource.getId(), 195L)), newOpLog.get(0).getNewBalance());
        Assertions.assertEquals(new QuotasByAccount(Map.of(account.getId(),
                new ProvisionsByResource(Map.of(resource.getId(), new ProvisionHistoryModel(60L, 1L))))),
                newOpLog.get(0).getOldProvisions());
        Assertions.assertEquals(new QuotasByAccount(Map.of(account.getId(),
                new ProvisionsByResource(Map.of(resource.getId(), new ProvisionHistoryModel(100L, 1L))))),
                newOpLog.get(0).getNewProvisions());
        Assertions.assertEquals(new QuotasByAccount(Map.of(account.getId(),
                new ProvisionsByResource(Map.of(resource.getId(), new ProvisionHistoryModel(105L, 2L))))),
                newOpLog.get(0).getActuallyAppliedProvisions().get());
        Assertions.assertTrue(newOpLog.get(0).getOldAccounts().isEmpty());
        Assertions.assertTrue(newOpLog.get(0).getNewAccounts().isEmpty());
        Assertions.assertEquals(2L, newOpLog.get(0).getOrder());
    ...
    @Test
    @SuppressWarnings("MethodLength")
    public void testSuccessAfterRefreshNoAccountsSpacePushOperationIdAndAccountVersionMatch() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, false,
        ...
        Assertions.assertEquals("test", updatedAccount.get().getOuterAccountKeyInProvider().get());
        Assertions.assertEquals(folder.getId(), updatedAccount.get().getFolderId());
        Assertions.assertEquals("Test update", updatedAccount.get().getDisplayName().get());
        Assertions.assertEquals(1L, updatedAccount.get().getVersion());
        Assertions.assertFalse(updatedAccount.get().isDeleted());
        Assertions.assertTrue(updatedAccount.get().getLastReceivedVersion().isPresent());
        Assertions.assertEquals(2L, updatedAccount.get().getLastReceivedVersion().get());
        Assertions.assertTrue(updatedAccount.get().getLatestSuccessfulAccountOperationId().isEmpty());
        Optional<AccountsQuotasOperationsModel> updatedOperation = tableClient.usingSessionMonoRetryable(session ->
                session.usingTxMonoRetryable(TransactionMode.SERIALIZABLE_READ_WRITE, txSession ->
                        accountsQuotasOperationsDao.getById(txSession, operation.getOperationId(),
        ...
        Assertions.assertEquals(new QuotasByAccount(Map.of(account.getId(),
                new ProvisionsByResource(Map.of(resource.getId(), new ProvisionHistoryModel(105L, null))))),
                newOpLog.get(0).getActuallyAppliedProvisions().get());
        Assertions.assertTrue(newOpLog.get(0).getOldAccounts().isPresent());
        Assertions.assertEquals(1L, newOpLog.get(0).getOldAccounts().get().getAccounts()
                .get(account.getId()).getLastReceivedVersion().get());
        Assertions.assertEquals("Test", newOpLog.get(0).getOldAccounts().get().getAccounts()
                .get(account.getId()).getDisplayName().get());
        Assertions.assertTrue(newOpLog.get(0).getNewAccounts().isPresent());
        Assertions.assertEquals(2L, newOpLog.get(0).getNewAccounts().get().getAccounts()
                .get(account.getId()).getLastReceivedVersion().get());
        Assertions.assertEquals("Test update", newOpLog.get(0).getNewAccounts().get().getAccounts()
                .get(account.getId()).getDisplayName().get());
        Assertions.assertEquals(2L, newOpLog.get(0).getOrder());
        Assertions.assertEquals(operation.getOperationId(), newOpLog.get(0).getAccountsQuotasOperationsId().get());
        stubProviderService.reset();
