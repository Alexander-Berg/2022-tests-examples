 ...
 */
@IntegrationTest
public class AnotherAccountsSyncServiceTest {
    ...
    public void testBasicSyncCreateThenUpdateRestoreUpdateOperation() {
        ...
        String updatedProvisionOperationId = UUID.randomUUID().toString();
                        ...
                        .addAccounts(Account.newBuilder()
                                ...
                                .setLastUpdate(LastUpdate.newBuilder()
                                        .setAuthor(UserID.newBuilder()
                                                ...
                                                .build())
                                        .setOperationId(accountOperationId)
                                        .setTimestamp(Timestamps.fromMillis(now.plusSeconds(2).toEpochMilli()))
                                        .build())
                                .addProvisions(Provision.newBuilder()
                                        .setResourceKey(ResourceKey.newBuilder()
                                                .setCompoundKey(CompoundResourceKey.newBuilder()
                                        ...
                                        .setLastUpdate(LastUpdate.newBuilder()
                                                .setAuthor(UserID.newBuilder()
                                                        ...
                                                        .setStaffLogin(StaffLogin.newBuilder()
                                                                ...
                                                                .build())
                                                        .build())
                                                .setOperationId(updatedProvisionOperationId)
        ...
        AccountsQuotasOperationsModel operation = updateProvisionOperationModel(updatedProvisionOperationId,
                null, provider.getId(), AccountsQuotasOperationsModel.RequestStatus.ERROR,
                syncedAccount.get().getId(), List.of(Tuples.of(resource.getId(), 4_000_000L)), 2L,
        ...
        Assertions.assertTrue(syncedAgainProvisions.get(0).getLatestSuccessfulProvisionOperationId().isPresent());
        Assertions.assertEquals(updatedProvisionOperationId, syncedAgainProvisions.get(0)
        ...
        Assertions.assertEquals(3, syncedAgainOpLog.size());
        ...
        Assertions.assertFalse(syncedAgainOpLog.get(1).getOldAccounts().isPresent());
        Assertions.assertFalse(syncedAgainOpLog.get(1).getNewAccounts().isPresent());
        Assertions.assertEquals(2L, syncedAgainOpLog.get(1).getOrder());
        Assertions.assertTrue(syncedAgainOpLog.get(1).getAccountsQuotasOperationsId().isPresent());
        Assertions.assertEquals(updatedProvisionOperationId,
                syncedAgainOpLog.get(1).getAccountsQuotasOperationsId().get());
        Assertions.assertEquals(folder.getId(), syncedAgainOpLog.get(2).getFolderId());
        Assertions.assertEquals(FolderOperationType.SYNC_WITH_PROVIDER, syncedAgainOpLog.get(2).getOperationType());
        Assertions.assertEquals("0b204534-d0ec-452d-99fe-a3d1da5a49a9",
                syncedAgainOpLog.get(2).getAuthorUserId().get());
        Assertions.assertEquals("1120000000000001", syncedAgainOpLog.get(2).getAuthorUserUid().get());
        Assertions.assertTrue(syncedAgainOpLog.get(2).getAuthorProviderId().isEmpty());
        Assertions.assertTrue(syncedAgainOpLog.get(2).getSourceFolderOperationsLogId().isEmpty());
        Assertions.assertTrue(syncedAgainOpLog.get(2).getOldFolderFields().isEmpty());
        Assertions.assertTrue(syncedAgainOpLog.get(2).getNewFolderFields().isEmpty());
        Assertions.assertEquals(new QuotasByResource(Map.of()), syncedAgainOpLog.get(2).getOldQuotas());
        Assertions.assertEquals(new QuotasByResource(Map.of()), syncedAgainOpLog.get(2).getNewQuotas());
        Assertions.assertEquals(new QuotasByResource(Map.of()), syncedAgainOpLog.get(2).getOldBalance());
        Assertions.assertEquals(new QuotasByResource(Map.of()), syncedAgainOpLog.get(2).getNewBalance());
        Assertions.assertEquals(new QuotasByAccount(Map.of()), syncedAgainOpLog.get(2).getOldProvisions());
        Assertions.assertEquals(new QuotasByAccount(Map.of()), syncedAgainOpLog.get(2).getNewProvisions());
        Assertions.assertTrue(syncedAgainOpLog.get(2).getOldAccounts().isPresent());
        Assertions.assertTrue(syncedAgainOpLog.get(2).getOldAccounts().get().getAccounts()
                .containsKey(syncedAgainAccount.get().getId()));
        Assertions.assertEquals("sync-test-1", syncedAgainOpLog.get(2).getOldAccounts().get().getAccounts()
                .get(syncedAgainAccount.get().getId()).getDisplayName().get());
        Assertions.assertTrue(syncedAgainOpLog.get(2).getNewAccounts().isPresent());
        Assertions.assertTrue(syncedAgainOpLog.get(2).getNewAccounts().get().getAccounts()
                .containsKey(syncedAgainAccount.get().getId()));
        Assertions.assertEquals("sync-test-2", syncedAgainOpLog.get(2).getNewAccounts().get().getAccounts()
                .get(syncedAgainAccount.get().getId()).getDisplayName().get());
        Assertions.assertEquals(3L, syncedAgainOpLog.get(2).getOrder());
        Assertions.assertFalse(syncedAgainOpLog.get(2).getAccountsQuotasOperationsId().isPresent());
        Optional<AccountsQuotasOperationsModel> syncedOperation = tableClient.usingSessionMonoRetryable(session ->
                session.usingTxMonoRetryable(TransactionMode.SERIALIZABLE_READ_WRITE, txSession ->
                        accountsQuotasOperationsDao.getById(txSession, updatedProvisionOperationId,
                                Tenants.DEFAULT_TENANT_ID)))
                .block();
        Assertions.assertNotNull(syncedOperation);
        Assertions.assertTrue(syncedOperation.isPresent());
        Assertions.assertEquals(2L, syncedOperation.get().getOrders().getRestoreOrder().get());
        Assertions.assertEquals(AccountsQuotasOperationsModel.RequestStatus.OK,
                syncedOperation.get().getRequestStatus().get());
        stubProviderService.reset();
    }

    @Test
    @SuppressWarnings("MethodLength")
    public void testBasicSyncCreateThenUpdateSkipUpdateOperationInProgress() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, true);
        ResourceTypeModel resourceType = resourceTypeModel(provider.getId(), "test",
                "b02344bf-96af-4cc5-937c-66a479989ce8");
        ResourceSegmentationModel locationSegmentation = resourceSegmentationModel(provider.getId(), "location");
        ...
        Assertions.assertTrue(syncedOpLog.get(0).getAccountsQuotasOperationsId().isEmpty());
        AccountsQuotasOperationsModel operation = updateProvisionOperationModel(updatedProvisionOperationId,
                null, provider.getId(), AccountsQuotasOperationsModel.RequestStatus.WAITING,
                syncedAccount.get().getId(), List.of(Tuples.of(resource.getId(), 4_000_000L)), 2L,
                null, Clock.systemUTC());
        tableClient.usingSessionMonoRetryable(session -> session.usingTxMonoRetryable(
                TransactionMode.SERIALIZABLE_READ_WRITE, txSession -> accountsQuotasOperationsDao
        ...
        Assertions.assertFalse(syncedAgainProvisions.get(0).getLatestSuccessfulProvisionOperationId().isPresent());
        List<FolderOperationLogModel> syncedAgainOpLog = tableClient.usingSessionMonoRetryable(session -> session
                .usingTxMonoRetryable(TransactionMode.SERIALIZABLE_READ_WRITE, txSession -> folderOperationLogDao
                        .getFirstPageByFolder(txSession, Tenants.DEFAULT_TENANT_ID, folder.getId(), SortOrderDto.ASC,
                                100)))
    ...
    @Test
    @SuppressWarnings("MethodLength")
    public void testBasicSyncCreateThenMoveRestoreMoveOperation() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, true);
        ResourceTypeModel resourceType = resourceTypeModel(provider.getId(), "test",
                "b02344bf-96af-4cc5-937c-66a479989ce8");
        ResourceSegmentationModel locationSegmentation = resourceSegmentationModel(provider.getId(), "location");
        ...
        String accountOperationId = UUID.randomUUID().toString();
        String provisionOperationId = UUID.randomUUID().toString();
        String moveOperationId = UUID.randomUUID().toString();
        Instant now = Instant.now();
        stubProviderService.setListAccountsResponses(List.of(GrpcResponse
                        .success(ListAccountsResponse.newBuilder()
                                .addAccounts(Account.newBuilder()
                                ...
                                .setLastUpdate(LastUpdate.newBuilder()
                                        .setAuthor(UserID.newBuilder()
                                                ...
                                                .setStaffLogin(StaffLogin.newBuilder()
                                                        ...
                                                        .build())
                                                .build())
                                        .setOperationId(moveOperationId)
                                        .setTimestamp(Timestamps.fromMillis(now.plusSeconds(1).toEpochMilli()))
                                        .build())
                                .addProvisions(Provision.newBuilder()
                                        .setResourceKey(ResourceKey.newBuilder()
        ...
        Assertions.assertEquals(1L, syncedOpLog.get(0).getOrder());
        Assertions.assertTrue(syncedOpLog.get(0).getAccountsQuotasOperationsId().isEmpty());
        AccountsQuotasOperationsModel operation = moveAccountOperationModel(moveOperationId,
                null, provider.getId(), AccountsQuotasOperationsModel.RequestStatus.ERROR,
                syncedAccount.get().getId(), anotherFolder.getId(), 2L,
                null, Clock.systemUTC());
        tableClient.usingSessionMonoRetryable(session -> session.usingTxMonoRetryable(
                TransactionMode.SERIALIZABLE_READ_WRITE, txSession -> accountsQuotasOperationsDao
                        .upsertOneRetryable(txSession, operation)))
        ...
        Assertions.assertFalse(syncedAgainAccount.get().isDeleted());
        Assertions.assertEquals(1L, syncedAgainAccount.get().getLastReceivedVersion().get());
        Assertions.assertTrue(syncedAgainAccount.get().getLatestSuccessfulAccountOperationId().isPresent());
        Assertions.assertEquals(moveOperationId,
                syncedAgainAccount.get().getLatestSuccessfulAccountOperationId().get());
                ...
                .usingSessionMonoRetryable(session -> session
                        .usingTxMonoRetryable(TransactionMode.SERIALIZABLE_READ_WRITE,
                                txSession -> folderOperationLogDao.getFirstPageByFolder(txSession,
                                        Tenants.DEFAULT_TENANT_ID, anotherFolder.getId(), SortOrderDto.ASC,
                                        100)))
                .block();
        ...
        Assertions.assertEquals(1L, syncedAgainOpLogDestination.get(0).getNewAccounts().get().getAccounts()
                .get(syncedAgainAccount.get().getId()).getLastReceivedVersion().get());
        Assertions.assertTrue(syncedAgainOpLogDestination.get(0).getAccountsQuotasOperationsId().isPresent());
        Assertions.assertEquals(moveOperationId,
                syncedAgainOpLogDestination.get(0).getAccountsQuotasOperationsId().get());
        ...
        Assertions.assertEquals(1L, syncedAgainOpLogSource.get(1).getNewAccounts().get().getAccounts()
                .get(syncedAgainAccount.get().getId()).getLastReceivedVersion().get());
        Assertions.assertTrue(syncedAgainOpLogSource.get(1).getAccountsQuotasOperationsId().isPresent());
        Assertions.assertEquals(moveOperationId, syncedAgainOpLogSource.get(1).getAccountsQuotasOperationsId().get());
        Assertions.assertEquals(2L, syncedAgainOpLogSource.get(1).getOrder());
        Optional<AccountsQuotasOperationsModel> syncedOperation = tableClient.usingSessionMonoRetryable(session ->
                session.usingTxMonoRetryable(TransactionMode.SERIALIZABLE_READ_WRITE, txSession ->
                        accountsQuotasOperationsDao.getById(txSession, moveOperationId,
                                Tenants.DEFAULT_TENANT_ID)))
                .block();
        Assertions.assertNotNull(syncedOperation);
        Assertions.assertTrue(syncedOperation.isPresent());
        Assertions.assertEquals(2L, syncedOperation.get().getOrders().getRestoreOrder().get());
        Assertions.assertEquals(1L, syncedOperation.get().getOrders().getDestinationRestoreOrder().get());
        Assertions.assertEquals(AccountsQuotasOperationsModel.RequestStatus.OK,
                syncedOperation.get().getRequestStatus().get());
        stubProviderService.reset();
    }
    ...
    private AccountsQuotasOperationsModel updateProvisionOperationModel(
            ...
            String accountId,
            List<Tuple2<String, Long>> provisions,
            long submitOrder,
            Long closeOrder,
            Clock clock) {
        ...
        return new AccountsQuotasOperationsModel.Builder()
                ...
                .setRequestedChanges(OperationChangesModel.builder()
                        .accountId(accountId)
                        .updatedProvisions(provisions.stream()
                                .map(t -> new OperationChangesModel.Provision(t.getT1(), t.getT2()))
    ...
    @SuppressWarnings("ParameterNumber")
    private AccountsQuotasOperationsModel moveAccountOperationModel(
            String operationId,
            String accountsSpaceId,
            String providerId,
            AccountsQuotasOperationsModel.RequestStatus requestStatus,
        ...
        return new AccountsQuotasOperationsModel.Builder()
                ...
                .setCreateDateTime(now)
                .setOperationSource(OperationSource.USER)
                .setOperationType(AccountsQuotasOperationsModel.OperationType.MOVE_ACCOUNT)
                .setAuthorUserId("0b204534-d0ec-452d-99fe-a3d1da5a49a9")
                .setAuthorUserUid("1120000000000001")
                .setProviderId(providerId)
                .setAccountsSpaceId(accountsSpaceId)
    ...
    @Test
    @SuppressWarnings("MethodLength")
    public void testBasicSyncCreateThenUpdateToZero() {
        ProviderModel provider = providerModel(GRPC_URI, null, false, true);
        ResourceTypeModel resourceType = resourceTypeModel(provider.getId(), "test",
                "b02344bf-96af-4cc5-937c-66a479989ce8");
        ResourceSegmentationModel locationSegmentation = resourceSegmentationModel(provider.getId(), "location");
        ...
        Assertions.assertEquals(new QuotasByAccount(Map.of(syncedAgainAccount.get().getId(),
                ...
                syncedAgainOpLog.get(1).getOldProvisions());
        Assertions.assertEquals(new QuotasByAccount(Map.of(syncedAgainAccount.get().getId(),
                new ProvisionsByResource(Map.of(resource.getId(), new ProvisionHistoryModel(0L, 1L))))),
                syncedAgainOpLog.get(1).getNewProvisions());
