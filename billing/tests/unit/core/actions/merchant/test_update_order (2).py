...
from billing.yandex_pay_plus.yandex_pay_plus.core.exceptions import (
    MerchantClientRateLimitError,
    MerchantOrderUpdateError,
)
from billing.yandex_pay_plus.yandex_pay_plus.interactions.merchant import MerchantZoraClient
from billing.yandex_pay_plus.yandex_pay_plus.utils.stats import merchant_order_update_failures
...
def mock_update_transaction_status(mocker):
    ...
    return mocker.patch.object(MerchantZoraClient, 'update_transaction_status', mock)
...
async def test_update_order(
    ...
    mock_update_transaction_status.assert_called_once_with(
        base_url=yandex_pay_plus_settings.SPLIT_MERCHANT_URL,
        merchant_id=merchant_id,
