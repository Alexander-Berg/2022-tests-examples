...
from billing.yandex_pay_admin.yandex_pay_admin.api.handlers.utility import PingDBHandler, PingHandler
...
async def test_swagger_json_accessible(app, swagger_expected_paths):
    ...
    expected_info_part = has_entries({'title': 'Yandex.Pay Admin API', 'version': anything()})
