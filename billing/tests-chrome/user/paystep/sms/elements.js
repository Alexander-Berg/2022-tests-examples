const elements = {
    ...
    phonePopup: {
        phonePicker: '.yb-confirmation-phone',
        phone: 'div[data-key=item-1]',
        send: '.yb-resend-confirmation-code__resend',
        codeInput: 'input[placeholder="Код"]',
        confirm: '.yb-pay-confirmation__buttons',
        success: '.yb-paystep-success__sum'
    },
    ignoreElements: {
