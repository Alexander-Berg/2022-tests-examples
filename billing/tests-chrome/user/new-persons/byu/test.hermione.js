    ...
    describe('new-persons', () => {
        describe(`${personType.byu.name}`, () => {
            describe('создание', () => {
                describe('клиент', () => {
                    it('создание со обязательными полямм', async function () {
                        ...
                        await browser.click(personType.byu.selector);
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.byu.name} создание с обяз. полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.byu.name} создание с обяз. полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.byu.name}, создание с обяз. полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.byu.name} создание со всеми полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.byu.name} создание со всеми  полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.byu.name}, создание со всеми полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                });
            ...
            describe('редактирование', () => {
                describe('клиент', () => {
                    it('редактирование всех доступных полей', async function () {
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.byu.name} карточка плательщика клиент (перед редактированием)`,
                            elements.page
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.byu.name}, форма перед редакитрованием, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.byu.name}, форма после редакитрованием, клиент, часть 1`,
                            elements.page
                        );
                        await browser.scroll(elements.city);
                        await browser.ybAssertView(
                            `new-persons, ${personType.byu.name}, форма после редакитрованием, клиент, часть 2`,
                            elements.page
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.byu.name}, карточка после редакитрования, клиент`,
                            elements.page
                        );
                    });
                });
            ...
            it('Проверка обязательности', async function () {
                ...
                await takeScreenshots(
                    browser,
                    `${personType.byu.name}, проверка обязтельности полей при создании плательщика, клиент`
                );
                ...
                await takeScreenshots(
                    browser,
                    `${personType.byu.name}, проверка обязательности при редактировании, клиент`
                );
            });
        });
    });
