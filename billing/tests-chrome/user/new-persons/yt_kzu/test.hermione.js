...
describe('user', () => {
    describe('new-persons', () => {
        describe(`${personType.yt_kzu.name}`, () => {
            describe('создание', () => {
                describe('клиент', () => {
                    it('создание со обязательными полямм', async function () {
                        ...
                        await browser.click(personType.yt_kzu.selector);
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.yt_kzu.name} создание с обяз. полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.yt_kzu.name} создание с обяз. полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.yt_kzu.name}, создание с обяз. полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.yt_kzu.name} создание со всеми полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.yt_kzu.name} создание со всеми  полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.scroll('h1');
                        await browser.ybAssertView(
                            `new-persons, ${personType.yt_kzu.name}, создание со всеми полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                });
            ...
            describe('редактирование', () => {
                describe('клиент', () => {
                    it('редактирование всех доступных полей', async function () {
                        ...
                        await browser.scroll('h1');
                        await browser.ybAssertView(
                            `new-persons, ${personType.yt_kzu.name} карточка плательщика клиент (перед редактированием)`,
                            elements.page
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.yt_kzu.name}, форма перед редакитрованием, клиент`
                        );
                        ...
                        await browser.scroll('h1');
                        await browser.ybAssertView(
                            `new-persons, ${personType.yt_kzu.name}, форма после редакитрованием, клиент, часть 1`,
                            elements.page
                        );
                        await browser.scroll(elements.city);
                        await browser.ybAssertView(
                            `new-persons, ${personType.yt_kzu.name}, форма после редакитрованием, клиент, часть 2`,
                            elements.page
                        );
                        ...
                        await browser.scroll('h1');
                        await browser.ybAssertView(
                            `new-persons, ${personType.yt_kzu.name}, карточка после редакитрования, клиент`,
                            elements.page
                        );
                    });
                });
            ...
            it('Проверка обязательности', async function () {
                ...
                await takeScreenshots(
                    browser,
                    `${personType.yt_kzu.name}, проверка обязтельности полей при создании плательщика, клиент`
                );
                ...
                // убрать обязательные поля и поменять на норм
                ...
                await takeScreenshots(
                    browser,
                    `${personType.yt_kzu.name}, проверка обязательности при редактировании, клиент`
                );
            });
        });
    });
