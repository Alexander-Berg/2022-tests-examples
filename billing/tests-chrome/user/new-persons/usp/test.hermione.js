    ...
    describe('new-persons', () => {
        describe(`${personType.usp.name}`, () => {
            describe('создание', () => {
                describe('клиент', () => {
                    it('создание со обязательными полямм', async function () {
                        ...
                        await browser.click(personType.usp.selector);
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.usp.name} создание с обяз. полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.usp.name} создание с обяз. полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.usp.name}, создание с обяз. полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.usp.name} создание со всеми полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.usp.name} создание со всеми  полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.usp.name}, создание со всеми полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                });
            ...
            describe('редактирование', () => {
                describe('клиент', () => {
                    it('редактирование всех доступных полей', async function () {
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.usp.name} карточка плательщика клиент (перед редактированием)`,
                            elements.page
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.usp.name}, форма перед редакитрованием, клиент`,
                            elements.page
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.usp.name}, форма после редактирования, клиент`,
                            elements.page
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.usp.name}, карточка после редакитрования, клиент`,
                            elements.page
                        );
                    });
                });
            ...
            it('Проверка обязательности', async function () {
                ...
                await browser.scroll('h1');
                await browser.ybAssertView(
                    `new-persons, ${personType.usp.name}, проверка обязтельности полей при создании плательщика, клиент, часть 1`,
                    elements.page
                );
                await browser.scroll(elements.city);
                await browser.ybAssertView(
                    `new-persons, ${personType.usp.name}, проверка обязтельности полей при создании плательщика, клиент, часть 2`,
                    elements.page
                );
                ...
                await browser.scroll('h1');
                await browser.ybAssertView(
                    `new-persons, ${personType.usp.name}, проверка обязательности при редактировании, клиент, часть 1`,
                    elements.page
                );
                await browser.scroll(elements.city);
                await browser.ybAssertView(
                    `new-persons, ${personType.usp.name}, проверка обязательности при редактировании, клиент, часть 2`,
                    elements.page
                );
            });
        });
