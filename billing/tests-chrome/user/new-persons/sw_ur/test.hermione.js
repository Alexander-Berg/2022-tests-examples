...
describe(`user`, () => {
    describe('new-persons', () => {
        describe(`${personType.sw_ur.name}`, () => {
            describe(`создание`, () => {
                describe('клиент', () => {
                    it(`создание с обязательными полями`, async function () {
                        ...
                        await browser.click(personType.sw_ur.selector);
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание с обяз. полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание с обяз. полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ur.name}, создание с обяз. полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями, вид счета не выбран', async function () {
                        const { browser } = this;
                        const { login } = await browser.ybSignIn({ isAdmin: false });
                        await browser.ybRun('create_client_for_user', {
                            login
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание со всеми полями (вид счета не выбран), форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание со всеми полями (вид счета не выбран), заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ur.name}, создание со всеми полями (вид счета не выбран), карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями, IBAN', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание со всеми полями (IBAN), форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание со всеми полями (IBAN), заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ur.name}, создание со всеми полями (IBAN), карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями, р.с.', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание со всеми полями (Расчетный счет), форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание со всеми полями (Расчетный счет), заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ur.name}, создание со всеми полями (Расчетный счет), карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями, вид счета: прочее', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание со всеми полями (Прочее), форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} создание со всеми полями (Прочее), заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ur.name}, создание со всеми полями (Прочее), карточка плательщика клиент`,
                            elements.page
                        );
                    });
                });
            ...
            describe('редактирование', () => {
                describe('клиент', () => {
                    it('редактирование всех возможный полей', async function () {
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ur.name} карточка плательщика клиент (перед редактированием)`,
                            elements.page
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name} редактирование, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ur.name}, форма после редактирования, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ur.name}, карточка после редакитрования, клиент`,
                            elements.page
                        );
                    });
                });
            ...
            it('Проверка обязательности', async function () {
                ...
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_ur.name}, создание плательщика, IBAN обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_ur.name}, создание плательщика, р.с. обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_ur.name}, создание плательщика, прочее обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_ur.name}, редактирование плательщика, доступные обязательные поля обязательны, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_ur.name}, редактирование  плательщика, IBAN обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_ur.name}, редактирование плательщика, р.с. обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_ur.name}, редактирование плательщика, прочее обязателен, клиент`,
                    elements.page
                );
            });
        });
