...
describe('user', () => {
    describe('new-persons', () => {
        describe(`${personType.gb_ur.name}`, () => {
            describe('создание', () => {
                describe('клиент', () => {
                    it('создание со обязательными полямм', async function () {
                        ...
                        await browser.click(personType.gb_ur.selector);
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.gb_ur.name} создание с обяз. полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.gb_ur.name} создание с обяз. полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.gb_ur.name}, создание с обяз. полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.gb_ur.name} создание со всеми полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.gb_ur.name} создание со всеми  полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.gb_ur.name}, создание со всеми полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                });
            ...
            describe('редактирование', () => {
                describe('клиент', () => {
                    it('редактирование всех доступных полей', async function () {
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.gb_ur.name} карточка плательщика клиент (перед редактированием)`,
                            elements.page
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.gb_ur.name}, форма перед редакитрованием, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.gb_ur.name}, форма после редакитрованием, клиент`,
                            elements.page
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.gb_ur.name}, карточка после редакитрования, клиент`,
                            elements.page
                        );
                    });
                });
            ...
            it('Проверка обязательности', async function () {
                ...
                await browser.ybAssertView(
                    `new-persons, ${personType.gb_ur.name}, проверка обязательности при создании, клиент, часть 1`,
                    elements.page
                );
                await browser.scroll(elements.email);
                await browser.ybAssertView(
                    `new-persons, ${personType.gb_ur.name}, проверка обязательности при создании, клиент, часть 2`,
                    elements.page
                );
                ...
                await browser.ybAssertView(
                    `new-persons, ${personType.gb_ur.name}, проверка обязательности при редактировании, клиент, часть 1`,
                    elements.page
                );
                await browser.scroll(elements.email);
                await browser.ybAssertView(
                    `new-persons, ${personType.gb_ur.name}, проверка обязательности при редактировании, клиент, часть 2`,
                    elements.page
                );
            });
        });
