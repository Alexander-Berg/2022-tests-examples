...
describe('user', () => {
    describe('new-persons', () => {
        describe(`${personType.sw_ph.name}`, () => {
            describe('создание', () => {
                describe('клиент', () => {
                    it('создание с обязательными полями', async function () {
                        ...
                        await browser.click(personType.sw_ph.selector);
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ph.name} создание с обяз. полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ph.name} создание с обяз. полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ph.name}, создание с обяз. полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ph.name} создание со всеми полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_ph.name} создание со всеми полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ph.name}, создание со всеми полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                });
            ...
            describe('редактирование', () => {
                describe('клиент', () => {
                    it('редактирование всех доступных полей', async function () {
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ph.name} карточка плательщика клиент (перед редактированием)`,
                            elements.page
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ph.name}, форма перед редакитрованием, клиент`,
                            elements.page
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ph.name}, форма после редактирования, клиент`,
                            elements.page
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_ph.name}, карточка после редакитрования, клиент`,
                            elements.page
                        );
                    });
                });
            ...
            it('Проверка обязательности', async function () {
                ...
                await browser.scroll('h1');
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_ph.name}, проверка обязательности при редактировании, клиент`,
                    elements.page
                );
            });
        });
