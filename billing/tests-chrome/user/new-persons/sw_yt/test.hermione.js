...
describe(`user`, () => {
    describe('new-persons', () => {
        describe(`${personType.sw_yt.name}`, () => {
            describe(`создание`, () => {
                describe('клиент', () => {
                    it(`создание с обязательными полями`, async function () {
                        ...
                        await browser.click(personType.sw_yt.selector);
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание с обяз. полями, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание с обяз. полями, заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_yt.name}, создание с обяз. полями, карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями, вид счета не выбран', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание со всеми полями (вид счета не выбран), форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание со всеми полями (вид счета не выбран), заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_yt.name}, создание со всеми полями (вид счета не выбран), карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями, IBAN', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание со всеми полями (IBAN), форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание со всеми полями (IBAN), заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_yt.name}, создание со всеми полями (IBAN), карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями, р.с.', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание со всеми полями (Расчетный счет), форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание со всеми полями (Расчетный счет), заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_yt.name}, создание со всеми полями (Расчетный счет), карточка плательщика клиент`,
                            elements.page
                        );
                    });
                    it('создание со всеми полями, вид счета: прочее', async function () {
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание со всеми полями (Прочее), форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} создание со всеми полями (Прочее), заполненная форма, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_yt.name}, создание со всеми полями (Прочее), карточка плательщика клиент`,
                            elements.page
                        );
                    });
                });
            ...
            describe('редактирование', () => {
                describe('клиент', () => {
                    it('редактирование всех возможный полей', async function () {
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_yt.name} карточка плательщика клиент (перед редактированием)`,
                            elements.page
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name} редактирование, форма, клиент`
                        );
                        ...
                        await takeScreenshots(
                            browser,
                            `${personType.sw_yt.name}, форма после редактирования, клиент`
                        );
                        ...
                        await browser.ybAssertView(
                            `new-persons, ${personType.sw_yt.name}, карточка после редакитрования, клиент`,
                            elements.page
                        );
                    });
                });
            ...
            it('Проверка обязательности', async function () {
                ...
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_yt.name}, создание плательщика, IBAN обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_yt.name}, создание плательщика, р.с. обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_yt.name}, создание плательщика, прочее обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_yt.name}, редактирование плательщика, доступные обязательные поля обязательны, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_yt.name}, редактирование  плательщика, IBAN обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_yt.name}, редактирование плательщика, р.с. обязателен, клиент`,
                    elements.page
                );
                ...
                await browser.scroll(elements.payType.button);
                await browser.ybAssertView(
                    `new-persons, ${personType.sw_yt.name}, редактирование плательщика, прочее обязателен, клиент`,
                    elements.page
                );
            });
        });
