    ...
    describe('change-person', () => {
        describe(`${personType} ${partner}`, () => {
            describe('редактирование', () => {
                it('редактирует поле name и проставляет чекбокс invalidAddress);', async function () {
                    const { browser } = this;
                    ...
                    await browser.ybAssertView(
                        'форма - редактирование, изменено name и проставлен чекбокс invalidAddress',
                    ...
                    await browser.waitForVisible(elements.personsList);
                    await browser.ybAssertView(
                        'subpersons.xml - карточка плательщика с измененным полем name и проставленным чекбоксом invalidAddress',
