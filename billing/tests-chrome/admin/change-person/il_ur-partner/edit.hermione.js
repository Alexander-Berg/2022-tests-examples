    ...
    describe('change-person', () => {
        describe(`${personType} ${partner}`, () => {
            describe('редактирование', () => {
                it('редактирует поле longname', async function () {
                    const { browser } = this;
                    ...
                    await setValue(browser, details.longname, true);
                ...
                it('нет права PersonPostAddressEdit', async function () {
                    ...
                    await browser.ybSetSteps('Проверяет, что часть полей заблокирована');
                    await browser.ybAssertView(
