...
PAYMENT_TYPES = [
    PaymentType.DOOH_FIX,
    PaymentType.DOOH_RENT,
    PaymentType.DOOH_BONUS,
]
...
@pytest.mark.parametrize('context', [
    DIGITAL_COROBA_RU_CONTEXT_SPENDABLE,
])
def test_digital_coroba_sidepayment(context):
...
def test_digital_coroba_sidepayment_refund(context):
