...
@pytest.mark.parametrize('context', [
    ZAXI_SELFEMPLOYED_RU_CONTEXT_SPENDABLE,
])
def test_zaxi_selfemployed_sidepayment(context):
...
def test_zaxi_selfemployed_sidepayment_refund(context):
