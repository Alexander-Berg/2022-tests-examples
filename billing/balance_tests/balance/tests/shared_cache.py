# coding: utf-8
# Забрал весь файл, т.к. присутствие balance/tests/check не дает нормально импортировать в balance/tests/conftest
# из check! При переименовании balance/tests/check на агентах тимсити остаются файлы balance/tests/check/__init__.pyc,
# и импорт все так же не работает.
__author__ = 'chihiro'
