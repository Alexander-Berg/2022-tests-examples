...
from stager_data_steps import DT, make_cloud_context, make_avia_context, make_taxi_tl_closed_attributes, \
    make_default_context, make_blue_market_context, make_hosting_service_context
...
YT_FOLDER = "//home/balance-test/test/stager-tests-data"
...
PROJECTS_MAPPING = {
    ...
    StagerProject.CLOUD: {
        'input': ['marketplace_in', 'events_src'],
        'output': ['completions', 'errors', 'marketplace_out'],
        'temp': ['timeline', 'distinct_projects', 'events']
    },

    StagerProject.HOSTING_SERVICE: {
        'input': ['events_src'],
        'output': ['completions', 'errors'],
        'temp': ['timeline', 'distinct_projects', 'events']
    },
    ...
    StagerProject.TAXI: {
        'input': ['tl_revenues_in'],
        'output': ['tl_revenues_copy', 'tl_revenues_out', 'tl_distrib_out', 'errors'],
        'temp': ['currency'],
        'closing': ['tl_revenues_copy', 'tl_revenues_out', 'tl_distrib_out']
    },
    StagerProject.BLUE_MARKET: {
        'input': ['tl_revenues_in', ],
        'output': ['tl_revenues_copy', 'tl_revenues_out', 'errors', ],
        'closing': ['tl_revenues_copy', 'tl_revenues_out', ]
    },
    StagerProject.BLUE_MARKETING_SERVICES: {
        'input': ('tl_revenues_in',),
        'output': ('tl_revenues_copy', 'tl_revenues_out', 'errors',),
        'closing': ('tl_revenues_copy', 'tl_revenues_out',),
    },
...
CONTEXT_MAPPING = {
    ...
    StagerProject.HOSTING_SERVICE: make_hosting_service_context,
    StagerProject.AVIA: make_avia_context,
    StagerProject.BLUE_MARKET: make_blue_market_context,
}
...
def test_taxi_tl_table_closing(project):
