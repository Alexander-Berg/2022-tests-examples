...
# query = "Update t_client set FULLNAME = u'UL Nonres', CURRENCY_PAYMENT = 'USD', IS_NON_RESIDENT = 1 where ID = :client_id"
...
# Далее в скрипте будут фигурировать "владелец счёта": агентство или клиент и "владелец заказа": всегда клиент:
order_owner = client_id
invoice_owner = agency_id or client_id

# Привязать клиента к логину
# steps.ClientSteps.link(client_id, 'yndx-tst-custom-role-2')
...
person_id = None or steps.PersonSteps.create(invoice_owner, PersonTypes.UR.code, person_params)
