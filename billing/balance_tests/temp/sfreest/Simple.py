...
from btestlib.constants import Services, PersonTypes, Paysyses, Products, Managers, Regions
from temp.igogor.balance_objects import Contexts, Client
...
_Product = namedtuple('Product', 'id service type multicurrency_type')
context = Contexts.GEO_RUB_CONTEXT.new(
    name='GEO_KZT',
    service=Services.GEO,
    person_type=PersonTypes.KZU,
    paysys=Paysyses.CC_KZ_UR_TG,
    product=_Product(id=510794, service=Services.GEO, type=None, multicurrency_type=None),
    price=D('30.0'),
    manager=Managers.SOME_MANAGER,
    client_template=Client(id=None, region=Regions.KZ))
