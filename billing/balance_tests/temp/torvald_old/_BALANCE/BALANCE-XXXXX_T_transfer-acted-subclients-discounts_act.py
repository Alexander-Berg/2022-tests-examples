...
after = datetime.datetime(2015, 7, 26, 11, 0, 0)
...
def test_client():
    ...
    mtl.get_direct_discount(client_id, datetime.datetime(2015, 7, 11), pct=3)
    mtl.get_direct_discount(client_id2, datetime.datetime(2015, 7, 11), pct=5)
    mtl.get_direct_discount(client_id3, datetime.datetime(2015, 7, 11), pct=7)
        ...
        {"QtyOld": "100.000000", "ServiceOrderID": service_order_id, "ServiceID": 7, "QtyNew": "20.000000",
         'AllQty': 1}], \
                                       [{"QtyDelta": "92.158000", "ServiceOrderID": service_order_id2, "ServiceID": 7}, \
                                        {"QtyDelta": "92.158000", "ServiceOrderID": service_order_id3, "ServiceID": 7}])
    ## Here we should make discount for client_id2 or client_id3
    print '... (3)';
    time.sleep(3)
    mtl.do_campaigns(7, service_order_id2, {'Bucks': 6, 'Money': 0}, 0, campaigns_dt)
