...
def test_client():
    ...
    ##    mtl.do_campaigns(7, service_order_id, {'Bucks': 23, 'Money': 0}, 0, campaigns_dt)
    ...
    test_rpc.ExecuteSQL(
        'update t_client_service_data set migrate_to_currency = trunc(sysdate) where class_id = :client_id',
        {'client_id': client_id})
