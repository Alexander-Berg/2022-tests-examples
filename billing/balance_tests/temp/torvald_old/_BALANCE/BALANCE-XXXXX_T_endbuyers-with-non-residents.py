...
def test_client():
    ...
    ## Нерезидент
    test.ExecuteSQL('''Update t_client set FULLNAME = u'UL КП Директ нерезидент USD полное', CURRENCY_PAYMENT = 'USD', ISO_CURRENCY_PAYMENT = 'USD', IS_NON_RESIDENT = 1
                    where ID = :client_id ''',
                    {'client_id': client_id})
    ## Счет одним вызовом (+external_id)
    paysys_id = 1026
    ...
    ## Нерезидент
    test.ExecuteSQL('''Update t_client set FULLNAME = u'UL КП Директ нерезидент EUR полное', CURRENCY_PAYMENT = 'EUR', ISO_CURRENCY_PAYMENT = 'EUR', IS_NON_RESIDENT = 1
                    where ID = :client_id ''',
                    {'client_id': client_id})
    ## Счет одним вызовом (+external_id)
    paysys_id = 1027
    ...
    ## Нерезидент
    test.ExecuteSQL('''Update t_client set FULLNAME = u'UL КП Директ нерезидент RUR полное', CURRENCY_PAYMENT = 'RUR', ISO_CURRENCY_PAYMENT = 'RUB', IS_NON_RESIDENT = 1
                    where ID = :client_id ''',
                    {'client_id': client_id})
    ## Счет одним вызовом (+external_id)
    paysys_id = 1025
    ...
    force = 1
    p = MTestlib.act_accounter(agency_id, force, act_dt)
