...
after = datetime.datetime(2015, 2, 1, 11, 0, 0)
...
def test_client():
    ...
    print '%shttps://balance-admin.%s.yandex.ru/invoice.xml?invoice_id=%s&mt-login=yb-adm&mt-password=get_secret(*UsersPwd.YANDEX_TEAM_REG_CQR5_PWD)' % (
