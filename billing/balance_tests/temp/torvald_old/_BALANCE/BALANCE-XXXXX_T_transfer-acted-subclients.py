...
def test_client():
    ...
    person_id = None or mtl.create_person(invoice_owner, 'ur', {'phone': '234', 'kpp': '123456789'})
    contract_id = None
    ...
    order_id3 = mtl.create_or_update_order(order_owner, product_id, service_id, service_order_id3,
                                           {'TEXT': 'Py_Test order'}, agency_id=agency_id, manager_uid=manager_uid)

    service_order_id4 = mtl.get_next_service_order_id(service_id)
    order_id3 = mtl.create_or_update_order(order_owner3, product_id, service_id, service_order_id4,
                                           {'TEXT': 'Py_Test order'}, agency_id=agency_id, manager_uid=manager_uid)
