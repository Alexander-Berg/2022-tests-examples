...
after = datetime.datetime(2015, 4, 13, 11, 0, 0)
disc_dt = datetime.datetime(2015, 4, 13, 11, 0, 0)
...
def test_client():
    ...
    ##    client_id = 29276785 or mtl.create_client({'IS_AGENCY': 0, 'NAME': u'Petrov3'})
    ...
    ##    contract_id = mtl.create_contract2('comm_post',{'client_id': agency_id, 'person_id': person_id, 'dt': '2015-02-28T00:00:00'})
    ##    contract_id = mtl.create_contract2('ukr_opt_ag_prem',{'client_id': agency_id, 'person_id': person_id, 'dt': '2015-02-28T00:00:00'})
    ##    contract_id = None

    mtl.get_overdraft(client_id, 7, 1000, firm_id=2)
