...
def data_generator():
    ...
    mtl.do_campaigns(7, service_order_id3, {'Bucks': 10, 'Money': 0}, 0, campaigns_dt)
    mtl.get_direct_discount(client_id4, datetime.datetime(2015, 8, 1), pct=5)
    mtl.do_campaigns(7, service_order_id4, {'Bucks': 10.526492, 'Money': 0}, 0, campaigns_dt)  # 10.526491 - for no act
    mtl.act_accounter(invoice_owner, 1, campaigns_dt)
