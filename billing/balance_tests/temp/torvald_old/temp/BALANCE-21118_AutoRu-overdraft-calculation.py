...
service_id = 99;
product_id = 504601  ##504534, 504697 505123
##service_id = 102; product_id = 504654

qty = 18.750375  # 18.749938 #9.749937
qty2 = 18.749938
paysys_id = 1091
...
# person_id2 = None or mtl.log(mtl.create_person)(invoice_owner, 'ur_autoru', {'phone':'234'})
contract_id = None

# mtl.create_contract2('auto_ru_non_agency',{'client_id': invoice_owner, 'person_id': person_id2,
...
after = datetime.datetime(2015, 8, 30, 12, 0, 0)

service_order_id = None or mtl.get_next_service_order_id(service_id)
...
mtl.do_campaigns(99, service_order_id, {'Bucks': 0, 'Days': qty, 'Money': 0}, 0, after)
mtl.act_accounter(invoice_owner, 1, after)
# ---------------------------------------------------------------------------------------------
# after = datetime.datetime(2015,8,30,12,0,0)
#
# service_order_id2 = None or mtl.get_next_service_order_id(service_id)
# order_id2 = mtl.create_or_update_order (client_id, product_id, service_id, service_order_id2,
#     {'TEXT':'Py_Test order', 'unmoderated': 0}, agency_id = agency_id, manager_uid = manager_uid)
# orders_list = [
#     {'ServiceID': service_id, 'ServiceOrderID': service_order_id2, 'Qty': qty2, 'BeginDT': begin_dt}
#   # , {'ServiceID': service_id, 'ServiceOrderID': service_order_id2, 'Qty': qty2, 'BeginDT': begin_dt}
# ]
...
# mtl.OEBS_payment(invoice_id)
# mtl.do_campaigns(99,service_order_id2, {'Bucks': 0, 'Days': qty2, 'Money': 0}, 0, after)
# mtl.act_accounter(invoice_owner, 1, after)

test_rpc.TestBalance.CalculateOverdraft([client_id])

service_order_id3 = None or mtl.get_next_service_order_id(service_id)
order_id3 = mtl.create_or_update_order(client_id, 505123, service_id, service_order_id3,
                                       {'TEXT': 'Py_Test order', 'unmoderated': 0}, agency_id=agency_id,
                                       manager_uid=manager_uid)
orders_list = [
    {'ServiceID': service_id, 'ServiceOrderID': service_order_id3, 'Qty': 500, 'BeginDT': begin_dt}
    # , {'ServiceID': service_id, 'ServiceOrderID': service_order_id2, 'Qty': qty2, 'BeginDT': begin_dt}
]
