...
price = 116
simple = xmlrpclib.ServerProxy('http://greed-tm1f.yandex.ru:8002/simple/xmlrpc')
...
def test_method():
    ...
    res = simple.BalanceSimple.PayBasket(service_token, {'uid': '3000248777', 'trust_payment_id': trust_payment_id,
                                                         'user_ip': '127.0.0.1', 'paymethod_id': 'card-x49062278',
                                                         'bypass_auth': True})
    print res
    PaymentForm = simple.BalanceSimple.PayBasket(service_token, {'trust_payment_id': trust_payment_id,
