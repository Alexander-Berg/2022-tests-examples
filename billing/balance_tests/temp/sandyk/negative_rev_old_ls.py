...
after = datetime.datetime(2015,10,8)
##datetime.datetime.now()
##datetime.datetime(2015,2,26,11,0,0)
current =datetime.datetime(2015,10,8)
##datetime.datetime.now()
##datetime.datetime(2015,10,8)
...
def test_client():
    ...
    person_id = None or mtl.create_person(invoice_owner, 'usp', {'phone':'234'})
    ########
    contract_id = mtl.create_contract2('usa_comm_post',{'client_id': client_id, 'person_id': person_id,'dt': '2015-09-22T00:00:00','is_faxed': '2015-09-22T00:00:00','dt': '2015-09-16T00:00:00'},'Contract')
############
...
##    service_order_id2 = 47616101
##    client_id = 30325923
##    invoice_id = 42824385
    mtl.do_campaigns(7, service_order_id2, {'Bucks': 70, 'Money': 0}, 0, campaigns_dt)

    print client_id
    print campaigns_dt
    mtl.act_accounter(client_id, 1, campaigns_dt)
    mtl.do_campaigns(7, service_order_id2, {'Bucks': 20, 'Money': 0}, 0, campaigns_dt)
    rpc.Balance.CreateTransferMultiple(16571028,[{"QtyOld":"100.000000","ServiceOrderID": service_order_id,"ServiceID":7,"QtyNew":"99.00001", 'AllQty': 0}],[{"QtyDelta":"92.158000","ServiceOrderID":service_order_id2,"ServiceID":7}])
