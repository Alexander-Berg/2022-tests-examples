...
def test_fair_overdraft_mv_client():
    # client_id = 57054881
    # person_id = 6110204
    client_id = steps.ClientSteps.create(params={'IS_AGENCY': 0, 'REGION_ID': 225})
    # client_id = 56582567
    # steps.ClientSteps.link(client_id,'yndx-web-test-uid-1')
    #
    # person_id = steps.PersonSteps.create(client_id, PERSON_TYPE, params={'region':'225'})
    #
    person_id = steps.PersonSteps.create(client_id, PERSON_TYPE)
    # person_id = steps.PersonSteps.create(client_id, 'ur',
    #                                      params={'legal_address_postcode': "191025", 'legal_adress_home': u"а/я Кладр 0"})
    ...
    # steps.ClientSteps.set_overdraft(client_id, SERVICE_ID, 30000, firm_id=1, start_dt=MAIN_DT,
    ...
    # api.medium().GetPersonalAccount({'PersonID': person_id, 'PaysysID': PAYSYS_ID, 'FirmID': FIRM_ID, 'ProductID': NON_CURRENCY_PRODUCT_ID})
    ...
    # steps.ExportSteps.export_oebs(client_id=client_id, invoice_id=invoice_id, person_id=person_id)
    ...
    #
    # service_order_id='20000000237004'
    # client_id =56216640

    steps.InvoiceSteps.pay(invoice_id)
    # steps.InvoiceSteps.pay_fair(invoice_id)
    # service_order_id = 21220577
    # client_id = 5940336
    steps.CampaignsSteps.do_campaigns(SERVICE_ID, service_order_id, {'Bucks': 15000}, 0, campaigns_dt=MAIN_DT)
