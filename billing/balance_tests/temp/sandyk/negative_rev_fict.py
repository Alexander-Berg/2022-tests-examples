...
def test_client():
    ...
    ########
    contract_id = mtl.create_contract2('no_agency_post',{'client_id': client_id, 'person_id': person_id,'dt': '2015-09-22T00:00:00','is_faxed': '2015-09-22T00:00:00','dt': '2015-09-16T00:00:00'},'Contract')
############
