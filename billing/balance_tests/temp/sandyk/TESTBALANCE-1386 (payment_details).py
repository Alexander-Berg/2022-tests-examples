...
def payment_details(paysys_id, person_type, dt=datetime.datetime.now(), orders=['7-1475'], multi=None,
                    mode='paypreview'):
...
payment_details(1003, 'ur', datetime.datetime(2013, 8, 25), ['7-503162'], 'RUB', 'invoice');
