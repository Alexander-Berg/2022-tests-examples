...
##    person_id = None or mtl.create_person(invoice_owner, 'ph', {'phone':'234'})
    ########
##    contract_id = mtl.create_contract2('opt_prem_post',{'client_id': client_id, 'person_id': person_id,'dt': '2015-09-22T00:00:00','is_faxed': '2015-09-22T00:00:00','dt': '2015-09-16T00:00:00'},'Contract')
##############
...
##    service_order_id2 = 47615815
##    client_id = 30324568
##    invoice_id = 42824385
##    mtl.do_campaigns(7, service_order_id2, {'Bucks': 3  , 'Money': 0}, 0, campaigns_dt)
    mtl.act_accounter(client_id, 1, campaigns_dt)
##    mtl.do_campaigns(7, service_order_id2, {'Bucks': 20, 'Money': 0}, 0, campaigns_dt)
##    mtl.OEBS_payment(invoice_id, 3000, None)
