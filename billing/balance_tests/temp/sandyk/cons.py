...
##
####    mtl.get_overdraft(client_id,service_id,150,1,datetime.datetime.now(),None,None)
##    mtl.get_force_overdraft(client_id,service_id,500,1,datetime.datetime.now())
##
##    if order_owner == invoice_owner: agency_id = None
##    person_id = None or mtl.create_person(invoice_owner, 'ph', {'phone':'234'})
##    ########
####    contract_id = mtl.create_contract2('opt_prem',{'client_id': client_id, 'person_id': person_id,'dt': '2015-09-22T00:00:00','is_faxed': '2015-09-22T00:00:00','dt': '2015-09-16T00:00:00'},'Contract')
################
...
##    invoice_id = mtl.create_invoice (request_id, person_id, paysys_id, 0,None, overdraft = 1)
##    print '111'
####
##    mtl.OEBS_payment(invoice_id, None, None)
    service_order_id2 = 52630560
##    client_id = 30325923
##    invoice_id = 42824385
    mtl.do_campaigns(7, service_order_id2, {'Bucks': 152, 'Money': 0}, 0, campaigns_dt)
##    print '222'
