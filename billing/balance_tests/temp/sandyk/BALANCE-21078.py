...
##    contract_id
    contract_id = None
##    mtl.create_contract2('mine', {'client_id':client_id, 'person_id':person_id})
####
    print '1'
##    service_order_id=52653246
    service_order_id = mtl.get_next_service_order_id(service_id)
    print '2'
    qty = 3
    print client_id, product_id, service_id, service_order_id
    ...
    print client_id, orders_list, begin_dt
    request_id = mtl.create_request (client_id, orders_list, begin_dt)

##
##
##    invoice_id = mtl.create_invoice (request_id, person_id, 1031, 1,contract_id, 0)
##
##    service_order_id = 22417750
##    invoice_id = 42733740
##    mtl.do_campaigns(service_id, service_order_id, {'Bucks': 50, 'Money': 0}, 0, campaigns_dt)
...
##    invoice_id = 42698909
##    mtl.OEBS_payment(42701553, 30000, datetime.datetime(2015,8,15))
