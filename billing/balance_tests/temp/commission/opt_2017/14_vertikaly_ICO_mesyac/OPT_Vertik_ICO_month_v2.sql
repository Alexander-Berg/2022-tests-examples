...
s_ar_acts as (
    ...
    b.contract_eid,
      ...
      join xxxx_new_comm_contract_basic     xxx on b.invoice_id = xxx.invoice_id
                                           ...
                                           -- BALANCE-24798: исключаем ЛК  c 2017-03-01
...
s_acts as (
    select b.*
      from s_acts_src   b
     where b.commission_type = 19
)
,
s_kv_control as (
    select d.*,
           case
           when amt_rub >= 5000000
           then 0
           else 1
            end as failed
      from (
                select contract_id, from_dt,
