      ...
      from (
          ...
          from (
            ...
            select d.contract_id, d.contract_eid, d.reward_type,d.discount_type,
             ...
             union all
            select d.contract_id, contract_eid, d.reward_type,d.discount_type,
                   d.from_dt, d.till_dt,
                   d.nds, d.currency,
                   d.turnover_to_charge,
                   d.reward_to_charge,
...
--            least(reward_to_charge_sum, reward_to_pay_sum) as a,
--          least(reward_to_charge_sum_prev, reward_to_pay_sum_prev) as b,
--          least(reward_to_charge_sum, reward_to_pay_sum) -
--          least(reward_to_charge_sum_prev, reward_to_pay_sum_prev) as "a-b"
      from (
            select d.*,
