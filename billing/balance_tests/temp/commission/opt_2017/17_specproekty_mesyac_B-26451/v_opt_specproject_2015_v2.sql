...
--                                                    BALANCE-20041
                                ...
                                or
                                                (
                                                    -- Маркет
                                                    contract_commission_type in (12, 13) and
                                                    nvl(commission_type,
                                                        discount_type) in
                                                    (11)
                                                )
                                                ...
                                                (
                                                    -- Маркет, спецпроекты
                                                    contract_commission_type in (14) and
                                                    nvl(commission_type,
                                                        discount_type) in
                                                    (33)
                                                )
                                                ...
                                                (
                                                    ...
                                                    -- BALANCE-23716
                                                    contract_commission_type in (6) and
                                                    nvl(commission_type,
                                                        discount_type) in
...
s_kv_control as (
    select D.*,
      ...
      from (
                select contract_id, from_dt,         -- BALANCE-26451
