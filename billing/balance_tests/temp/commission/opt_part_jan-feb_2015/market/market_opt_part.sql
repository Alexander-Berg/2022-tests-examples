...
s_pre as (
    ...
    opt.contract_id,
           ...
           opt.commission_type,
           -- к начислению
           opt.turnover_to_charge   - nvl(com.turnover_to_charge, 0)  as turnover_to_charge,                              -- оборот к начислению
           opt.reward_to_charge*.8 - nvl(com.reward_to_charge, 0)       as reward_to_charge,        -- комиссия к начислению
           opt.reward_to_charge*.2 - nvl(com.delkredere_to_charge, 0)   as delkredere_to_charge,    -- делькредере к начислению
           opt.dkv_to_charge       - nvl(com.dkv_to_charge, 0)          as dkv_to_charge,
           -- к перечислению
           opt.turnover_to_pay_w_nds - nvl(com.turnover_to_pay_w_nds, 0)   as turnover_to_pay_w_nds,                                 -- оборот к перечислению
           opt.turnover_to_pay       - nvl(com.turnover_to_pay, 0)  as  turnover_to_pay,                           -- оборот к перечислению (с НДС)
           opt.reward_to_pay*.8    - nvl(com.reward_to_pay, 0)          as reward_to_pay,           -- комиссия к перечислению
           opt.reward_to_pay*.2    - nvl(com.delkredere_to_pay, 0)      as delkredere_to_pay,       -- делькредере к перечислению
