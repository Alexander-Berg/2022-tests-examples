...
--where add_months(trunc(sysdate, 'MM'), -1) between from_dt and till_dt
)
...
order by contract_id , from_dt,till_dt, nds, currency,discount_type, reward_type, turnover_to_charge,
