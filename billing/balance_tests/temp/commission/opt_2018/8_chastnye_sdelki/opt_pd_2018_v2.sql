	...
	select 
      ...
      d."AMT_RUR_WO_NDS",d."COSTCUR",d."INSERT_DT",
	     dl.name                      as deal_name,    --VARCHAR2(512 BYTE) Указанное площадкой название сделки. Ограничение в директе - 255 символов
		   ...
		   null as doc_date,   -- DATE Дата уведомления о подтверждении условий сделки
		   null as doc_number  -- VARCHAR2(64 BYTE)?  Номер уведомления о подтверждении условий сделки
