...
CREATE OR REPLACE FORCE EDITIONABLE VIEW "BO"."XXX_OPT_2015_ACTS" ( "CONTRACT_EID", "CONTRACT_ID", "INVOICE_EID", "INVOICE_ID", "INVOICE_DT", "INVOICE_TYPE", "CONTRACT_FROM_DT", 
