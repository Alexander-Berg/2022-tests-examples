  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BO"."V_OPT_2015_BASE_Q" ("CONTRACT_EID", "CONTRACT_ID", "CONTRACT_ID_ORIG", "AGENCY_ID", "CONTRACT_FROM_DT", "CONTRACT_TILL_DT", "DISCOUNT_TYPE", "FROM_DT", "TILL_DT", "TILL_DT_FC", "AMT_W_NDS_RUB", "AMT", "AMT_FOR_FORECAST", "AMT_AG", "AMT_AG_Q", "AMT_AG_PREV", "AMT_AG_PREV_FM", "FAILED", "FAILED_BOK", "FAILED_MEDIA", "EXCLUDED") AS 
