...
--           decode(c.cons_type, null, d.contract_id,  c.contract_id)     as contract_id,
           d.contract_eid as contract_eid,
           d.contract_id  as contract_id,
...
--                       from xxx_ar_consolidations_q   j
...
CREATE OR REPLACE FORCE EDITIONABLE VIEW "BO"."XXX_AR_ACTS_Q_EXT" ("CONTRACT_EID", "CONTRACT_ID", "AGENCY_ID", "DISCOUNT_TYPE", "COMMISSION_TYPE", "FROM_DT", "TILL_DT","AMT", "AMT_W_NDS", "AMT_Q", "AMT_PREV_Q", "FAILED", "FAILED_BOK") AS 
 with
...
--              36, 1,
      ...
      from xxxx_acts         a
      join xxxx_invoice     i on i.inv_id = a.invoice_id
                             and nvl(i.commission_type, i.discount_type) in
