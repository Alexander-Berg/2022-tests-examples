...
with
counting_date as (select date'2019-01-03' as dt from dual),   
...
--      join s_brands                               brand on brand.client_id = xxx.client_id
  ...
  and (
       ...
       or (b.commission_type in (20) and b.commission_type in (7, 37))
       )
)
...
s_payments as (
	...
	-- BALANCE-29611: начиная с 2019-01-01 считаем по новому и в питоне.
       ...
       and b.invoice_dt < date'2018-12-01'
)
