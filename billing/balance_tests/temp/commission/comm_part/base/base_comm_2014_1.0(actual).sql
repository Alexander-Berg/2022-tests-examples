...
s_comm_base_2014_acts_q as (
     select b.contract_eid,
       ...
       b.discount_type,
       b.loyal_clients,
       trunc(b.act_dt, 'Q')                         as from_dt,
       add_months(
        trunc(b.act_dt, 'Q'), 3) - 1/84600          as till_dt,
       b.client_id,
       b.act_dt,
       b.amt_w_nds,
       b.amt,
...
select contract_id,
  ...
  from (
       ...
       order by contract_id ,type, from_dt, turn_p_nds, turn_p,rew_p,del_p,dkv_p, disc, currency, nds;