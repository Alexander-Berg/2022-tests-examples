...
s_opt_2015_ua_skv as (select d."CONTRACT_EID",d."CONTRACT_ID",d."CONTRACT_FROM_DT",d."CONTRACT_TILL_DT",d."CURRENCY",d."NDS",d."DISCOUNT_TYPE",d."COMMISSION_TYPE",d."NDS_COUNT",d."CURRENCY_COUNT",d."CLIENT_ID",d."FROM_DT",d."TILL_DT",d."TILL_DT_FC",d."AMT_W_NDS",d."AMT_FOR_FORECAST",d."AMT",
...
s_skv as (
    select d.*,
           bo.pk_comm.calc_ua_skv(d.amt, d.from_dt) as reward
      from (
