...
s_skv as (select d."CONTRACT_EID",d."CONTRACT_ID",d."CONTRACT_FROM_DT",d."CONTRACT_TILL_DT",d."DISCOUNT_TYPE",d."COMMISSION_TYPE",d."CLIENT_ID",d."NDS",d."NDS_COUNT",d."CURRENCY_COUNT",d."FROM_DT",d."TILL_DT",d."TILL_DT_FC",d."AMT_W_NDS_RUB",d."AMT_RUB_NOT_LC",
 ...
 select contract_eid, contract_id,
                  ...
                  xx_calc_market_skv(amt_forecast, from_dt) as reward
             from (
                select contract_eid, contract_id,
                        from_dt, till_dt,  
                        contract_from_dt, 
                        contract_till_dt, 
                       sum(amt_for_forecast)    as amt_forecast,
