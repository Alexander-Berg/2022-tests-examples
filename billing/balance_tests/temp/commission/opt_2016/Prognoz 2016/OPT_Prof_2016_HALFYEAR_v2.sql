...
select d."CONTRACT_EID",d."CONTRACT_ID",d."CONTRACT_FROM_DT",d."CONTRACT_TILL_DT",d."DISCOUNT_TYPE",d."NDS",d."CLIENT_ID",d."FROM_DT",d."TILL_DT",d."TILL_DT_FC",d."AMT_W_NDS_RUB",d."AMT_RUB_NOT_LC",d."AMT_RUB_LC",
...
s_skv as (
    select d.*,
           bo.pk_comm.calc_prof_skv(d.amt_rub, d.from_dt) as reward
      from (
