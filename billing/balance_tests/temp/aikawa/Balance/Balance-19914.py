...
def test5():
    ...
    person_id = steps.PersonSteps.create(client_id, PERSON_TYPE, {'early_docs': '1'})
    ...
    steps.CampaignsSteps.update_campaigns(SERVICE_ID, service_order_id, {'Bucks': 100}, 0, dt)
    steps.CampaignsSteps.do_campaigns(SERVICE_ID, service_order_id, {'Bucks': 100}, 0, dt)
    steps.CommonSteps.wait_for("select ")
