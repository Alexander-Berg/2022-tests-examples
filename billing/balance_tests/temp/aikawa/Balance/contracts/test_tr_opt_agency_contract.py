...
CONTRACT_CONTEXT = contracts_defaults.TR_OPT_AGENCY
...
def test_finish_dt_is_strictly_needed(payment_type):
...
@pytest.mark.parametrize('default_firm', [Firms.YANDEX_TURKEY_8],
                         ids=lambda a: '{}'.format(CONTRACT_CONTEXT.name))
