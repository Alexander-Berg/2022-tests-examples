...
CONTRACT_CONTEXT = contracts_defaults.SW_OPT_AGENCY
...
@pytest.mark.parametrize('default_firm', [Firms.EUROPE_AG_7],
...
@pytest.mark.parametrize('default_firm',
                         [Firms.EUROPE_AG_7, Firms.AUTO_RU_AG_14, Firms.SERVICES_AG_16],
...
@pytest.mark.parametrize('default_firm',
                         [Firms.YANDEX_1, Firms.KINOPOISK_9, Firms.VERTICAL_12, Firms.TAXI_13, Firms.OFD_18,
                          ...
                          Firms.YANDEX_UA_2, Firms.KAZNET_3, Firms.YANDEX_INC_4, Firms.BELFACTA_5,
                          Firms.EUROPE_BV_6, Firms.YANDEX_TURKEY_8, Firms.AUTO_RU_10, Firms.TAXI_BV_22,
                          Firms.TAXI_UA_23,
                          Firms.TAXI_KAZ_24, Firms.KZ_25, Firms.TAXI_AM_26, Firms.REKLAMA_BEL_27, Firms.YANDEX_NV_29],
                         ids=lambda a: '{}{}'.format(CONTRACT_CONTEXT.name, a.id))
def test_non_available_firms(default_firm):
    adds = {'FIRM': default_firm.id}
    contracts_defaults.check_param(context=CONTRACT_CONTEXT.new(adds=adds), param_name='FIRM',
                                   with_default=Firms.EUROPE_AG_7.id)
