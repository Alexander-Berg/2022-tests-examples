...
CONTRACT_CONTEXT = contracts_defaults.SW_OPT_CLIENT
...
def test_available_firms(firm):
    # тест с негативными проверок есть в швейцарском оптовом агенством договоре
    adds = {'FIRM': firm.id}
