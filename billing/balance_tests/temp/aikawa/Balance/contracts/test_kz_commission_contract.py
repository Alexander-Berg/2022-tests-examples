...
from btestlib.constants import ContractCommissionType, PersonTypes, CommissionType
...
CONTRACT_CONTEXT = CommonContract.new(type=ContractCommissionType.KZ_COMMISSION,
                                      name='KZ_COMMISSION',
...
def test_minimal_attrs_set():
    adds = {'COMMISSION': CONTRACT_CONTEXT.type.id,
            'COMMISSION_TYPE': CommissionType.KZ}
