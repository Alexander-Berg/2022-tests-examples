...
CONTRACT_CONTEXT = CommonContract.new(type=ContractCommissionType.BEL_OPT_AGENCY_PREM,
                                      name='BEL_OPT_AGENCY_PREM',
...
# from btestlib.constants import AwardsScaleType, Firms, ContractPaymentType
#
# to_iso = utils.Date.date_to_iso_format
#
# CONTRACT_CONTEXT = contracts_defaults.BEL_OPT_AGENCY_PREM
#
...
#                           ('WHOLESALE_AGENT_PREMIUM_AWARDS_SCALE_TYPE', AwardsScaleType.BEL_PREM, {})
#                           ])
...
#                        Firms.YANDEX_1.id, Firms.KINOPOISK_9.id, Firms.VERTICAL_12.id, Firms.TAXI_13.id, Firms.OFD_18.id,
...
#                              AwardsScaleType.AUTO_RU, AwardsScaleType.OFD_WO_COUNT,
