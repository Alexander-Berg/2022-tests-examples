...
paysys_id, person_type, contract_type, cmp_name, cmp_type, code_name = cmp_parameters.param('aob')
compare_type = 'aob'
...
class AOB_RU(TestBase):
    ...
    @classmethod
    def run_check(cls):
        ##            Compares.pycron_command(cmp_name, code_name, 3087869)
        ##            Compares.start_cmp(cmp_name, 'greed-ts1f')
        ##            AOB_RU.cmp_id = Compares.get_cmp_id(compare_type)
        print AOB_RU.act_id
        #######            file_name = datetime.datetime.now().strftime(date_format)
        #######            F = open('tom.pkl', 'wb')
        #######            import pickle
        #######            pickle.dump(AOB_RU.act_id, F)
        #######            F.close()
        print AOB_RU.cmp_id

    #####забираем данные за вчера для запуска сверки, удаляем дату
    base_path = os.path.dirname(__file__)
    filename_tod = os.path.join(base_path, '..', 'data', 'AOB_RU_tod.pkl')
...
##            AOB_RU.act_id['a3'] = act_id_3
##            Compares.insert_into_t_act_check(act_id_3)
##            print u'Case_2_0 prepared'
##
##        def Case_2_0(self):
##            act_id = AOB_RU.act_id['a3']
##            external_id  = test.ExecuteSQL('balance', 'select external_id from t_act where id = :act_id ', {'act_id': act_id})[0]['external_id']
##            results = Compares.check(compare_type, external_id, AOB_RU.cmp_id,2 )
...
##             AOB_RU.act_id['a5'] = act_id_5
##             Compares.insert_into_t_act_check(act_id_5)
##             print u'Case_3_0 prepared'
##
##        def Case_3_0(self):
##            act_id = AOB_RU.act_id['a5']
##            external_id  = test.ExecuteSQL('balance', 'select external_id from t_act where id = :act_id ', {'act_id': act_id})[0]['external_id']
##            results = Compares.check(compare_type, external_id, AOB_RU.cmp_id,3 )
...
##             AOB_RU.act_id['a7'] = act_id_7
##             Compares.insert_into_t_act_check(act_id_7)
##             print u'Case_4_0 prepared'
##
##        def Case_4_0(self):
##            act_id = AOB_RU.act_id['a7']
##            external_id  = test.ExecuteSQL('balance', 'select external_id from t_act where id = :act_id ', {'act_id': act_id})[0]['external_id']
##            results = Compares.check(compare_type, external_id, AOB_RU.cmp_id,4 )
...
##             AOB_RU.act_id['a8'] = act_id_8
##             Compares.insert_into_t_act_check(act_id_8)
##             print u'Case_4_1 prepared'
##
##        def Case_4_1(self):
##            act_id = AOB_RU.act_id['a8']
##            external_id  = test.ExecuteSQL('balance', 'select external_id from t_act where id = :act_id ', {'act_id': act_id})[0]['external_id']
##            results = Compares.check(compare_type, external_id, AOB_RU.cmp_id,5 )
...
##             AOB_RU.act_id['a11'] = act_id_11
##             Compares.insert_into_t_act_check(act_id_11)
##             print u'Case_0_0 prepared'
##
##        def Case_0_0(self):
##            act_id = AOB_RU.act_id['a11']
##            external_id  = test.ExecuteSQL('balance', 'select external_id from t_act where id = :act_id ', {'act_id': act_id})[0]['external_id']
##            results = Compares.check(compare_type, external_id, AOB_RU.cmp_id,0 )
...
##             AOB_RU.act_id['a13'] = act_id_13
##             Compares.insert_into_t_act_check(act_id_13)
##
##        def test_Case13(self):
##            act_id = AOB_RU.act_id['a13']
##            external_id  = test.ExecuteSQL('balance', 'select external_id from t_act where id = :act_id ', {'act_id': act_id})[0]['external_id']
##            results = Compares.check(compare_type, external_id, AOB_RU.cmp_id,0 )
...
##             AOB_RU.act_id['a14'] = act_id_14
##             Compares.insert_into_t_act_check(act_id_14)
##        def test_Case14(self):
##            act_id = AOB_RU.act_id['a14']
##            external_id  = test.ExecuteSQL('balance', 'select external_id from t_act where id = :act_id ', {'act_id': act_id})[0]['external_id']
##            results = Compares.check(compare_type, external_id, AOB_RU.cmp_id,0 )
...
if __name__ == '__main__':
    ...
    case_list = [
        '__main__:AOB_RU.Case_1_0'
        ##        , '__main__:AOB_RU.Case_1_1'
        ##         '__main__:AOB_RU.Case_2_0'
        ##        , '__main__:AOB_RU.Case_2_1'
        ##        , '__main__:AOB_RU.Case_3_0'
        ##        , '__main__:AOB_RU.Case_3_1'
        ##        , '__main__:AOB_RU.Case_4_0'
        ##        , '__main__:AOB_RU.Case_4_1'
        ##        , '__main__:AOB_RU.Case_5_0'
        ##        , '__main__:AOB_RU.Case_5_1'
        ##        , '__main__:AOB_RU.Case_0_0'
        ##        , '__main__:AOB_RU.Case_0_1'
        ###        , '__main__:AOB_RU.test_Case13'
        #####       , '__main__:AOB_RU.test_Case14'
    ]
    nose.core.runmodule(case_list, argv=['-v', '-s'])
    # nose.core.runmodule([], argv = ['-v', '-s'])
##    #nose.core.runmodule(argv = ['-v', '-s'])
##    nose.core.runmodule(['__main__:AOB_RU.test_Case3', '__main__:AOB_RU.test_Case4'], argv = ['-v', '-s'])
