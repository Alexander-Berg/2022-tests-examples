...
variable "description" {
    description = "Hotbilling Cluster Description"
    type = string
    default = "Hotbilling postgres cluster"
}

variable "pgversion" {
    description = "Hotbilling Cluster Postgres version"
    type = number
}
...
variable "pgconfig" {
    description = "Hotbilling PG database configuration"
    type = map(string)
    default = {}
}
