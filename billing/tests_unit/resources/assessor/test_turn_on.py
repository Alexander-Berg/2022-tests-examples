...
class TestMakePayment(TestCaseApiAppBase):
    BASE_API = u'/assessor/invoice/turn-on'
    QTY = 5

    def test_turn_on_partially(self, invoice):
        invoice_data = {
    ...
    @pytest.mark.parametrize('invoice_data', [{}, {'payment_sum': 0}])
    def test_turn_on_full(self, invoice, invoice_data):
