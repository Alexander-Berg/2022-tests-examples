...
from agency_rewards.rewards.utils.const import Scale, CommType
        ...
        session.execute(
            ...
            [
                act_q_ext(
                    ...
                    commission_type=Scale.BaseMsk.value,
                    amt_q=1_000_001,
                    amt_prev_q=0,
                ),
                act_q_ext(
        ...
        session.execute(
            ...
            [
                act_q_ext(
                    ...
                    commission_type=Scale.BaseRegions.value,
                    amt_q=2_500_001,
                    amt_prev_q=0,
                ),
                act_q_ext(
        ...
        session.execute(
            ...
            [
                act_q_ext(
                    ...
                    commission_type=Scale.BaseSpb.value,
                    amt_q=3_000_001,
                    amt_prev_q=0,
                ),
                act_q_ext(
