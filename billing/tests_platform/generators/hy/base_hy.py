...
from billing.agency_rewards.tests_platform.common.scheme import v_ar_acts_hy
    ...
    def setup_fixtures(cls, session):
        session.execute(
            ...
            [
                act(
                    cls.contract_id1,
                    CommType.Direct.value,
                    Scale.BaseRegions.value,
                    amt=Decimal('10_000'),
                    amt_cons=Decimal('25_000_001'),
                ),
                act(
                    cls.contract_id2,
                    CommType.Direct.value,
