...
class TestNoDzenAndDirectory(TestBase):
    """
    Премии по Справочнику,Дзен и Директу равны нулю
    """
    ...
    def test_media_common_cons(self):
        ...
        tests = [
            dict(
                ...
                amt=Decimal('10_000'),
                amt_w_nds=Decimal('10_000') * Decimal('1.2'),
                reward=Decimal('10_000') * Decimal('0.05'),
            ),
            dict(
                contract_id=self.contract_id1,
                ...
                amt=Decimal('20_000'),
                amt_w_nds=Decimal('20_000') * Decimal('1.2'),
                reward=Decimal('20_000') * Decimal('0.05'),
            ),
            dict(
                contract_id=self.contract_id1,
                ...
                reward=Decimal('30_000') * Decimal('0.05'),
            ),
            dict(
                contract_id=self.contract_id1,
                ...
                reward=Decimal('40_000') * Decimal('0.05'),
            ),
        ]
