...
import (
	...
	"a.yandex-team.ru/{{cookiecutter.project_path}}/pkg/commands"
	"a.yandex-team.ru/{{cookiecutter.project_path}}/pkg/core"
	"a.yandex-team.ru/{{cookiecutter.project_path}}/pkg/storage/db"
)
