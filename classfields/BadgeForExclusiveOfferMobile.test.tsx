...
import BadgeForExclusiveOfferMobile from './BadgeForExclusiveOfferMobile';
import type { Props } from './BadgeForExclusiveOfferMobile';
...
function shallowRenderComponent(props: Props) {
    ...
    return shallow(
        <ContextProvider>
            <BadgeForExclusiveOfferMobile { ...props }/>
        </ContextProvider>,
    ).dive();
}
