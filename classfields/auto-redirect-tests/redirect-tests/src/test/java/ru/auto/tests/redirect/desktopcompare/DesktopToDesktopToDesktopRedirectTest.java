package ru.auto.tests.redirect.desktopcompare;
...
public class DesktopToDesktopToDesktopRedirectTest {

    private static final String RESOURCE = "desktopcompare/desktop_to_desktop.csv";
    ...
    public static List getParameters() {
        InputStream dataStream = DesktopToDesktopToDesktopRedirectTest.class.getClassLoader().getResourceAsStream(RESOURCE);
