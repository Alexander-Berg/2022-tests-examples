...
public class DesktopToMobileRedirectTest {
    ...
    private static final String RESOURCE = "desktop/desktop_to_mobile.csv";
    ...
    public void shouldSeeRedirect() throws IOException {
        ...
        assertThat(responseWithoutRedirect.code(), anyOf(equalTo(HTTP_MOVED_PERM), equalTo(HTTP_MOVED_TEMP)));
        assertThat(responseWithoutRedirect.header("Location"), equalTo(location));
    }
}
