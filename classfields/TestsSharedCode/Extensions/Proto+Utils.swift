...
private class BundlePlaceholder {}
extension Message {
    init(mockFile: String, subdirectory: String? = nil, setup mutation: ((inout Self) -> Void)? = nil) {
        guard let fileURL = Bundle(for: BundlePlaceholder.self).url(forResource: mockFile, withExtension: "json", subdirectory: subdirectory) else {
