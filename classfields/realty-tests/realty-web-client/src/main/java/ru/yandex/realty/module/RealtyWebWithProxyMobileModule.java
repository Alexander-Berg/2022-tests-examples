...
import ru.yandex.realty.rules.ProxyTimeoutResource;
import ru.yandex.realty.rules.ServiceUnavailableRule;
import ru.yandex.realty.rules.SetCookieRule;
import ru.yandex.realty.webdriver.MobileWebDriverResource;
import ru.yandex.realty.webdriver.WebDriverResource;

public class RealtyWebWithProxyMobileModule extends AbstractModule {
