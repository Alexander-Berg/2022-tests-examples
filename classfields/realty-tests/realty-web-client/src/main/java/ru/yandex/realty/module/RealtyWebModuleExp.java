...
public class RealtyWebModuleExp extends AbstractModule {
    ...
    protected void configure() {
        ...
        rulesBinder.addBinding().to(CreateOfferRule.class);
