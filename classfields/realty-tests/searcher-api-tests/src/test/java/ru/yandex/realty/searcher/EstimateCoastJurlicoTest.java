...
import static ru.yandex.realty.PricesSet.JURLICO;
import static ru.yandex.realty.PricesSet.getRegionPricesFor;

/**
 * @author kurau (Yuri Kalinin)
 */
@DisplayName("Юрлицо. Все категории")
@RunWith(Parameterized.class)
@GuiceModules(RealtyApiModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class EstimateCoastJurlicoTest {
    ...
    public static Collection<Object[]> getParameters() {
        return getRegionPricesFor(JURLICO);
    }
