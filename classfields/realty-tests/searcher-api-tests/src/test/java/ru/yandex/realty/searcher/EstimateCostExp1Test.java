 ...
 */
@DisplayName("Тестирование цен в зависимости от региона. Эксперимент 1")
@RunWith(Parameterized.class)
@GuiceModules(RealtyApiModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
@Issue("REALTY-12155")
@Ignore
public class EstimateCostExp1Test {

    private static String BUCKET_13 = "13";
    ...
    @Test
    public void shouldSeeRaisingAndPremiumPriceExp1() {
        List<Datum> datum = searcher.estimateCostjson().withRgid(rgid)
                .withCategory(category.value()).withType(type.value()).withBucket(BUCKET_13)
                .withPricingPeriod(pricePeriod.value()).get(validatedWith(shouldBe200OkJSON()))
