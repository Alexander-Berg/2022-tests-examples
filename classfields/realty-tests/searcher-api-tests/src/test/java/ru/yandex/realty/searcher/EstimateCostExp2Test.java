 ...
 */
@DisplayName("Тестирование цен в зависимости от региона. Эксперимент 2")
@RunWith(Parameterized.class)
@GuiceModules(RealtyApiModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
@Issue("REALTY-12155")
@Ignore
public class EstimateCostExp2Test {

    private static String BUCKET_14 = "14";
    ...
    @Test
    public void shouldSeeRaisingAndPremiumPriceExp2() {
        List<Datum> datum = searcher.estimateCostjson().withRgid(rgid)
                .withCategory(category.value()).withType(type.value()).withBucket(BUCKET_14)
