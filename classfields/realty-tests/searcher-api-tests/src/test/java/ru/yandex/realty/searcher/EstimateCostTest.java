...
@DisplayName("Тестирование цен в зависимости от региона")
...
public class EstimateCostTest {
    ...
    private static final long DEFAULT_PROMOTION = 106L;
    private static final long PROMOTION_PERIOD = 30L;
