...
import static ru.yandex.realty.PricesSet.JURLICO_COM;
import static ru.yandex.realty.PricesSet.getRegionComPricesFor;

/**
 * @author kurau (Yuri Kalinin)
 */
@DisplayName("Юрлицо. Коммерция")
@RunWith(Parameterized.class)
@GuiceModules(RealtyApiModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class EstimateCoastJurlicoComTest {

    private static final String JURIDICAL_PERSON = "JURIDICAL_PERSON";
    private static final long DEFAULT_JUR_PERIOD = 1L;
    ...
    public static Collection<Object[]> getParameters() {
        return getRegionComPricesFor(JURLICO_COM);
    }
    ...
    public void before() {
        List<Datum> datum = searcher.estimateCostjson().withRgid(rgid)
                ...
                .withPaymentType(JURIDICAL_PERSON)
