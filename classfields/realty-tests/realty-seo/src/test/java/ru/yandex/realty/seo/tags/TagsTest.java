...
@DisplayName("Проверка тегов. Десктоп")
...
public class TagsTest {
    ...
    public void shouldSeeTags() {
        jSoupSteps.connectTo(config.getProductionURI() + "/" + config.getRegion() + url).get();
        ...
        jSoupSteps.connectTo(config.getTestingURI() + "/" + config.getRegion() + url).get();
