...
@DisplayName("Проверка тегов. Amp")
@RunWith(Parameterized.class)
@GuiceModules(RealtySeoModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class TagsAmpTest {
    ...
    @Before
    public void before() {
        testHost = seoTestSteps.replaceHostToAmp(config.getTestingURI());
        prodHost = seoTestSteps.replaceHostToAmp(config.getProductionURI());
    }
