...
public class ExtendedProfFiltersRentCommercialPriceTest {
    ...
    public void shouldSeePricingPeriodFiltersInUrl() {
        user.onProfSearchPage().extendFilters().select("Цена за месяц", "Цена за год");
