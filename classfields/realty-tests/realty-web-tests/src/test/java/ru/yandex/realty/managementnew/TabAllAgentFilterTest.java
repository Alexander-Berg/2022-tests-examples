...
public class TabAllAgentFilterTest {
    ...
    @DisplayName("Кликаем на таб «Все», проверяем что отобразилось в урле")
    public void shouldNotSeeTabInUrl() {
        managementSteps.onManagementNewPage().agentOfferFilters().tab("Все").waitUntil(isDisplayed()).click();
