...
public class VillageClassVillagesFilterTest {
    ...
    public void shouldSeeVillageClass() {
        ...
        basePageSteps.onMapPage().extendFilters().select("Класс посёлка", name);
        basePageSteps.onMapPage().extendFilters().applyFiltersButton().click();
        urlSteps.queryParam("villageClass", expected).shouldNotDiffWithWebDriverUrl();
    }
}
