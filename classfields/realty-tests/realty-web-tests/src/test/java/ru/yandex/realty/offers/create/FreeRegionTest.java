...
public class FreeRegionTest {
    ...
    @Test
    @DisplayName("Скриншот блока публикации c табом «Продать быстрее» в бесплатном регионе с фото")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeRegionWithPhotoFasterSalePublishBlock() {
    ...
    @Test
    @DisplayName("Скриншот блока публикации c табом «Обычная продажа» в бесплатном регионе с фото c услугой")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeRegionWithPhotoNormalSalePublishBlock() {
    ...
    @Test
    @DisplayName("Скриншот блока публикации c табом «Обычная продажа» в бесплатном регионе с фото без услуг")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeRegionWithPhotoFreePublishBlock() {
