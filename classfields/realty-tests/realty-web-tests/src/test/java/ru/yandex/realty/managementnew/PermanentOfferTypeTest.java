...
public class PermanentOfferTypeTest {
    ...
    public void shouldNotChangeSaveOffer() {
        ...
        offerAddSteps.onOfferAddPage().offerType().button(buttonName).should(exists());
        offerAddSteps.onOfferAddPage().offerType().button(buttonName).should(isDisabled());
    }
}
