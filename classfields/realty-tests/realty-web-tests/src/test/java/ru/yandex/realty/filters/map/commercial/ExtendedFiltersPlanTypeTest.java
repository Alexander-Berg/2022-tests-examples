...
public class ExtendedFiltersPlanTypeTest {
    ...
    public void shouldSeePlanTypeInUrl() {
        ...
        basePageSteps.onMapPage().closeExtFilter();
        urlSteps.queryParam("commercialPlanType", expected).shouldNotDiffWithWebDriverUrl();
    }
}
