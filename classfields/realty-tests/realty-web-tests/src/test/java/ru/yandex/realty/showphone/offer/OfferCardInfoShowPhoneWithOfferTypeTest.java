...
import static ru.yandex.realty.mock.MockOffer.SELL_APARTMENT_AD_AGENCY;
...
@DisplayName("Показ телефона. Карточка оффера. Микрокарточка. Оффер агентства")
@Feature(OFFER_CARD)
@Link("https://st.yandex-team.ru/VERTISTEST-1599")
@RunWith(GuiceTestRunner.class)
@GuiceModules(RealtyWebModule.class)
public class OfferCardInfoShowPhoneWithOfferTypeTest {
    ...
    @Before
    public void before() {
        offer = mockOffer(SELL_APARTMENT_AD_AGENCY);
