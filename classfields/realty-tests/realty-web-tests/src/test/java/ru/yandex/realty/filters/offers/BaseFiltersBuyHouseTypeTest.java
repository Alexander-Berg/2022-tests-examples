...
public class BaseFiltersBuyHouseTypeTest {
    ...
    public void openSaleAdsPage() {
        ...
        user.onOffersSearchPage().filters().waitUntil(isDisplayed());
    }
    ...
    public void shouldSeeHouseTypeInUrl() {
        ...
        user.loaderWait();
        urlSteps.queryParam("houseType", expected).shouldNotDiffWithWebDriverUrl();
        user.shouldSeeRequestInBrowser(hasItem(urlParam("houseType", expected)));
    }
}
