...
public class FreeRegionWithMoneyPromocodeTest {
    ...
    @Test
    @DisplayName("Скриншот блока публикации c табом «Продать быстрее» в бесплатном регионе с промокодом на деньги")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeRegionMoneyPromoFasterSalePublishBlock() {
    ...
    @Test
    @DisplayName("Скриншот блока публикации c табом «Обычная продажа» в бесплатном регионе c услугой с промо на деньги")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeRegionMoneyPromoNormalSalePublishBlock() {
