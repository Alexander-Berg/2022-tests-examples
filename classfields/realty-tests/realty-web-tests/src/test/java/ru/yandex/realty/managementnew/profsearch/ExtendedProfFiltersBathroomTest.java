...
public class ExtendedProfFiltersBathroomTest {
    ...
    public static Collection<Object[]> bathroom() {
        return asList(new Object[][]{
                {"Санузел совмещённый", "MATCHED"},
                {"Санузел раздельный", "SEPARATED"},
                {"Несколько санузлов", "TWO_AND_MORE"}
        });
    }
    ...
    public void shouldSeeBathroomInUrl() {
        user.onProfSearchPage().extendFilters().clickDropdown("Тип санузла неважен");
