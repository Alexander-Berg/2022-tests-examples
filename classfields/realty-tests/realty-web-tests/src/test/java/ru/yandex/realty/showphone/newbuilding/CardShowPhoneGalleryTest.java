...
public class CardShowPhoneGalleryTest {
    ...
    public void shouldSeePhoneFreeJkNormalCase() {
        ...
        basePageSteps.onNewBuildingSitePage().galleryAside().showPhoneClick();
    ...
    public void shouldSeePhone500() {
        ...
        basePageSteps.onNewBuildingSitePage().galleryAside().showPhoneButton().should(isDisplayed());
    }
    ...
    public void shouldSeeAllPhones() {
        ...
        basePageSteps.onNewBuildingSitePage().galleryAside().showPhoneClick();
        basePageSteps.onNewBuildingSitePage().galleryAside().shouldSeePhone(TEST_PHONE);
        basePageSteps.onNewBuildingSitePage().closeGallery().click();
