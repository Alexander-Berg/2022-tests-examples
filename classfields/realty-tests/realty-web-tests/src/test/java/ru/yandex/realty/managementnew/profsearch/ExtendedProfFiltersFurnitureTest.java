...
public class ExtendedProfFiltersFurnitureTest {
    ...
    public void shouldSeeFurnitureInUrl() {
        user.onProfSearchPage().extendFilters().select("Мебель неважна", label);
        user.onProfSearchPage().extendFilters().applyFiltersButton().waitUntil(isEnabled()).click();
