...
public class ExtendedLocationFiltersDistanceChpuTest {
    ...
    public void shouldSeeOnFootTimeToMetroInUrl() {
        ...
        user.onOffersSearchPage().extendFilters().checkButton("10 мин");
        user.onOffersSearchPage().extendFilters().applyFiltersButton().click();
        urlSteps.path("/ryadom-metro/").shouldNotDiffWithWebDriverUrl();
    }
}
