...
public class ExtendedFiltersBuildingTypeTest {
    ...
    public static Collection<Object[]> testParameters() {
        return asList(new Object[][]{
                ...
                {"Отдельно стоящее здание", "DETACHED_BUILDING"},
                {"Встроенное помещение, жилой дом", "RESIDENTIAL_BUILDING"}
        });
    }
    ...
    public void shouldSeeBuildingTypeInUrl() {
        ...
        urlSteps.queryParam("commercialBuildingType", expected).shouldNotDiffWithWebDriverUrl();
    }
}
