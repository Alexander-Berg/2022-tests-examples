...
public class InfrastructureNearZhDVillagesExtendedFilterTest {
    ...
    public void shouldSeeLandType() {
        ...
        basePageSteps.onVillageListing().extendFilters().selectCheckBox("Рядом ж/д станция");
        basePageSteps.onVillageListing().extendFilters().applyFiltersButton().click();
        urlSteps.queryParam("hasRailwayStation", "YES").shouldNotDiffWithWebDriverUrl();
    }
}
