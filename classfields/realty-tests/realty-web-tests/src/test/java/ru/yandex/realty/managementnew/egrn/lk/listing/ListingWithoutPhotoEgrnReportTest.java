...
public class ListingWithoutPhotoEgrnReportTest {
    ...
    public void before() {
        ...
        mockRuleConfigurable.paidReportStub(account.getId(), "mock/egrn/paidReportsWithoutPhoto.json")
                .createWithDefaults();
    ...
    @Test
    @Owner(KANTEMIROV)
    @DisplayName("Успешное формирование. Без фото. Скриншот")
    public void shouldSeeWithoutPhotoEgrnReportScreenshot() {
