...
import static ru.yandex.realty.element.saleads.FiltersBlock.HOUSE_TYPE;
...
public class ExtendedProfFiltersBuildingTypesTest {
    ...
    public void before() {
        ...
        user.scrollToElement(user.onProfSearchPage().extendFilters().button(HOUSE_TYPE));
        user.onProfSearchPage().extendFilters().clickDropdown(HOUSE_TYPE);
    }
