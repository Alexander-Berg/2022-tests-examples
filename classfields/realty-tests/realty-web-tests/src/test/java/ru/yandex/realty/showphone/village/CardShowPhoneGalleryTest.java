...
public class CardShowPhoneGalleryTest {
    ...
    public void shouldSeePhoneFreeVillageNormalCase() {
        ...
        basePageSteps.onVillageSitePage().galleryAside().showPhoneClick();
    ...
    public void shouldSeePhone500() {
        ...
        basePageSteps.onVillageSitePage().galleryAside().showPhoneButton().should(isDisplayed());
    }
    ...
    public void shouldSeePhoneFreeVillageTwoPhones() {
        ...
        basePageSteps.onVillageSitePage().galleryPic().click();
        basePageSteps.onVillageSitePage().galleryAside().showPhoneClick();
        basePageSteps.onVillageSitePage().galleryAside().phones().should(hasSize(2)).get(0)
                .should(hasText(makePhoneFormatted(TEST_PHONE, PHONE_PATTERN_BRACKETS)));
        basePageSteps.onVillageSitePage().galleryAside().phones().should(hasSize(2)).get(1)
    ...
    public void shouldSeeAllPhones() {
        ...
        basePageSteps.onVillageSitePage().galleryAside().showPhoneClick();
        basePageSteps.onVillageSitePage().galleryAside().shouldSeePhone(TEST_PHONE);
        basePageSteps.onVillageSitePage().closeGallery().click();
