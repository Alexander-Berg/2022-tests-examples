...
@DisplayName("Продвижение существующего оффера")
@Feature(RealtyFeatures.MANAGEMENT_NEW)
@RunWith(GuiceTestRunner.class)
@GuiceModules(RealtyWebWithPhoneModule.class)
public class PromotionEnableOnExistOfferTest {
    ...
    public void openWallet() {
        ...
        managementSteps.refreshUntil(() -> managementSteps.onManagementNewPage().offer(FIRST).servicesPanel(),
                isDisplayed());
        managementSteps.onManagementNewPage().offer(FIRST).servicesPanel().service("Продвижение").button("Подключить")
                .click();
    }
