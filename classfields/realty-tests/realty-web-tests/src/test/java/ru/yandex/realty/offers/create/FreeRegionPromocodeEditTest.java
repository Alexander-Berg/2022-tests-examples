...
public class FreeRegionPromocodeEditTest {
    ...
    @Test
    @DisplayName("Редактирование активного оффера в регионе с промокодом. Видим полный и зачеркнутый прайс")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeFreeRegionEditOfferWithServiceExtraPrice() {
