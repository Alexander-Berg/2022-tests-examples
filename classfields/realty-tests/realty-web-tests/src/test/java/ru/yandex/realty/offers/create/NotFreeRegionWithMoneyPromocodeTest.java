...
public class NotFreeRegionWithMoneyPromocodeTest {
    ...
    @Test
    @DisplayName("Скриншот блока публикации c табом «Продать быстрее» в платном регионе с промокодом на деньги")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeNotFreeRegionMoneyPromoFasterSalePublishBlock() {
    ...
    @Test
    @DisplayName("Скриншот блока публикации c табом «Обычная продажа» в платном регионе c услугой с промо на деньги")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeNotFreeRegionMoneyPromoNormalSalePublishBlock() {
