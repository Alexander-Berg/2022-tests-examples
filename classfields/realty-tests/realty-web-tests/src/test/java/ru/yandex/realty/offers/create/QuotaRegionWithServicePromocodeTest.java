...
public class QuotaRegionWithServicePromocodeTest {
    ...
    @Test
    @DisplayName("Скриншот блока публикации второго оффера(квота=1) c табом «Обычная продажа» в платном регионе с промо на услугу")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeQuotaRegionServicePromoNormalSalePublishBlock() {
