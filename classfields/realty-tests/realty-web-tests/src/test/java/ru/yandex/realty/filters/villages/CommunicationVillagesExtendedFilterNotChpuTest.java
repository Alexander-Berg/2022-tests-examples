...
public class CommunicationVillagesExtendedFilterNotChpuTest {
    ...
    public void shouldSeeCommunications() {
        ...
        basePageSteps.onVillageListing().extendFilters().clickDropdown("Коммуникации");
        basePageSteps.onVillageListing().selectPopup().selectCheckBox(name);
