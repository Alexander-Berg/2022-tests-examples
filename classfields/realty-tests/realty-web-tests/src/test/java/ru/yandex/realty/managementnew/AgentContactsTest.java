...
import static ru.yandex.realty.consts.RealtyTags.AGENTS;
...
@DisplayName("Агент. Контакты.")
@Tag(AGENTS)
@Feature(RealtyFeatures.MANAGEMENT_NEW)
@RunWith(GuiceTestRunner.class)
@GuiceModules(RealtyWebWithPhoneModule.class)
public class AgentContactsTest {
    ...
    public void shouldRedirectToAddPage() {
        ...
        urlSteps.testing().path(MANAGEMENT_NEW_ADD).ignoreParam("draftId").shouldNotDiffWithWebDriverUrl();
