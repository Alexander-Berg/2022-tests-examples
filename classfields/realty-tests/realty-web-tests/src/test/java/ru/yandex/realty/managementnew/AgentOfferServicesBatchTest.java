...
public class AgentOfferServicesBatchTest {
    ...
    public void shouldApplyServiceAllOffers() {
        ...
        walletSteps.onWalletPage().promocodePopup().popupHeader()
                .waitUntil(hasText(containsString("для 2 объявлений")));
