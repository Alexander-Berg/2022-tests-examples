...
public class ExtendedBuildingFiltersApartmentTest {
    ...
    public static Collection<Object[]> testParams() {
        return asList(new Object[][]{
                {"Только апартаменты", YES_VALUE},
                {"Без апартаментов", NO_VALUE}
        });
    }

    @Test
    @Owner(KANTEMIROV)
    @DisplayName("Параметр «Апартаменты»")
    public void shouldSeeApartmentsInUrl() {
        ...
        urlSteps.queryParam("apartments", expected).shouldNotDiffWithWebDriverUrl();
    }
}
