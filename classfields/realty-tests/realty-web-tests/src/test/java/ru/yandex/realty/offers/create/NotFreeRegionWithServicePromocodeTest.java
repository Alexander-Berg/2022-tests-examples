...
public class NotFreeRegionWithServicePromocodeTest {
    ...
    public void openManagementAddPage() {
        ...
        offerAddSteps.fillRequiredFieldsForPublishBlock(OfferAddSteps.MOSCOW_LOCATION);
    }

    @Test
    @DisplayName("Скриншот блока публикации c табом «Обычная продажа» в платном регионе с промо на услугу")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeNotFreeRegionServicePromoNormalSalePublishBlock() {
