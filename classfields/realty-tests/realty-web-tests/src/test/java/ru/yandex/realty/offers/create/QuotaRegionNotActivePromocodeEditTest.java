...
public class QuotaRegionNotActivePromocodeEditTest {
    ...
    @Test
    @DisplayName("Редактирование не активного оффера в платном регионе с промокодом. Видим полный и зачеркнутый прайс")
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeQuotaRegionEditOfferWithServiceExtraPrice() {
