...
public class VillageClassVillagesExtendedFilterNotChpuTest {

    private static final String VILLAGE_CLASS = "villageClass";
    ...
    public void shouldSeeVillageClass() {
        ...
        basePageSteps.onVillageListing().extendFilters().select("Класс посёлка", name);
        basePageSteps.onVillageListing().extendFilters().applyFiltersButton().click();
        urlSteps.queryParam(VILLAGE_CLASS, expected).shouldNotDiffWithWebDriverUrl();
    }
}
