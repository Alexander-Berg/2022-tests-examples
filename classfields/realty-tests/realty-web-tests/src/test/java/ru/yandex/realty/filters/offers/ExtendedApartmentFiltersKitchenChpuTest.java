...
public class ExtendedApartmentFiltersKitchenChpuTest {

    private static final String BUTTON_NAME = "от 10 м²";
    ...
    public void shouldSeeKitchenInUrl() {
        ...
        urlSteps.path("/s-bolshoy-kuhney/").shouldNotDiffWithWebDriverUrl();
    }
}
