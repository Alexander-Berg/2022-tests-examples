...
public class SeoDeveloperTest {
    ...
    private static final String DESCRIPTION_WITH_OFFERS = "✅ Купить квартиру в .* в новостройках от " +
            "застройщика 4D на Яндекс.Недвижимости. Свежие объявления в 5 жилых комплексах от застройщика 4D";
    private static final String DESCRIPTION_WITHOUT_OFFERS = "✅ Купить квартиру в .* в новостройках от " +
            "застройщика 4D на Яндекс.Недвижимости. 5 жилых комплексов 4D.";
    private static final String H1 = "4D в .*";
    ...
    public static Collection<Object[]> testParams() {
        return asList(new Object[][]{
                {"Застройщик с офферами", mockDeveloper(ENHANCED_DEVELOPER), TITLE_WITH_OFFERS,
                        DESCRIPTION_WITH_OFFERS},
                {"Застройщик без офферов", mockDeveloper(ENHANCED_DEVELOPER).removeOfferStatistic(),
    ...
    @Before
    public void before() {
        mockRuleConfigurable.developerStub(ENHANCED_DEV_ID, developer.setId(ENHANCED_DEV_ID).build())
                .createWithDefaults();
    }
    ...
    public void shouldSeeSeoDescription() {
        ...
        basePageSteps.onDeveloperPage().pageDescription().should(hasAttribute("content", findPattern(description)));
    }
    ...
    public void shouldSeeH1() {
        ...
        basePageSteps.onDeveloperPage().pageH1().should(hasText(findPattern(H1)));
    }
