...
public class ErrorPageAuthTest {
    ...
    public void shouldSee404() {
        urlSteps.testing().path(MANAGEMENT_NEW).path(WRONG_PATH).open();
    ...
    public void shouldSee500() {
        urlSteps.testing().path(MANAGEMENT_NEW).path(MOSKVA).queryParam(WRONG_QUERY_NAME, WRONG_QUERY_VALUE).open();
