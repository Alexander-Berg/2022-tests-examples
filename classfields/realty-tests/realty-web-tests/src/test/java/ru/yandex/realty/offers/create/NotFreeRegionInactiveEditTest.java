...
public class NotFreeRegionInactiveEditTest {
    ...
    public void shouldSeeNotFreeRegionInactiveEditOfferWithoutServiceRedirectLk() {
    ...
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeNotFreeRegionInactiveEditOfferWithServiceRedirectLk() {
        offerAddSteps.onOfferAddPage().publishBlock().payButton().waitUntil(hasText(SAVE_AND_CONTINUE)).click();
    ...
    @Owner(KANTEMIROV)
    @Category({Regression.class, Testing.class})
    public void shouldSeeNotFreeRegionInactiveEditOfferWithServiceRedirectToPay() {
        offerAddSteps.onOfferAddPage().publishBlock().payButton().waitUntil(hasText(SAVE_AND_CONTINUE)).click();
