...
public class ListingShowPhoneTest {
    ...
    public void shouldSeePhoneNormalCaseListing() {
        ...
        basePageSteps.onOffersSearchPage().showPhonePopup().phones()
    ...
    public void shouldSeePhone500Listing() {
        ...
        urlSteps.testing().path(MOSKVA).path(KUPIT).path(KVARTIRA).open();
        basePageSteps.onOffersSearchPage().offer(FIRST).button(SHOW_PHONE).click();
        basePageSteps.onOffersSearchPage().showPhonePopup().phoneError()
    ...
    public void shouldSeePhoneRedirectListing() {
        ...
        urlSteps.testing().path(MOSKVA).path(KUPIT).path(KVARTIRA).open();
        basePageSteps.onOffersSearchPage().offer(FIRST).button(SHOW_PHONE).click();
        basePageSteps.onOffersSearchPage().showPhonePopup().phoneProtectSign().should(isDisplayed());
        basePageSteps.onOffersSearchPage().showPhonePopup().phones()
                .should(hasSize(1)).get(0).should(hasText(makePhoneFormatted(TEST_PHONE, PHONE_PATTERN_DASHES)));
    }
    ...
    public void shouldSeeTwoPhoneListing() {
        ...
        urlSteps.testing().path(MOSKVA).path(KUPIT).path(KVARTIRA).open();
        basePageSteps.onOffersSearchPage().offer(FIRST).button(SHOW_PHONE).click();
        basePageSteps.onOffersSearchPage().showPhonePopup().phones().should(hasSize(2));
        basePageSteps.onOffersSearchPage().showPhonePopup().phones().get(0)
                .should(hasText(makePhoneFormatted(TEST_PHONE, PHONE_PATTERN_DASHES)));
        basePageSteps.onOffersSearchPage().showPhonePopup().phones().get(1)
