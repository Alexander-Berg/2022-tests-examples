...
public class ExtendedLocationFiltersToMoscowTest {
    ...
    @Test
    @Owner(KANTEMIROV)
    @DisplayName("Параметр «От Москвы»")
    public void shouldSeeNearbyFilters() {
        ...
        urlSteps.queryParam("directionDistanceMax", expected).shouldNotDiffWithWebDriverUrl();
    }
}
