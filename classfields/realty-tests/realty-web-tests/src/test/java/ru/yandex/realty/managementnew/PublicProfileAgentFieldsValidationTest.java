...
import static ru.yandex.realty.element.management.PublicProfile.ADD_PHOTO_WARN;
...
public class PublicProfileAgentFieldsValidationTest {
    ...
    @Test
    @Owner(KANTEMIROV)
    @DisplayName("Сохраняем без полей -> видим все предупреждения кроме адреса")
    public void shouldSeeAllWarnMessage() {
        ...
        managementSteps.onManagementNewPage().settingsContent().publicProfile().message(ADD_PHOTO_WARN)
                .should(isDisplayed());
