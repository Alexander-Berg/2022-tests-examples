...
public class ExtendedApartmentFiltersCellingHeightChpuTest {

    private static final String BUTTON_NAME = "от 3 м";
    @Rule
    @Inject
    ...
    @Test
    @Owner(KANTEMIROV)
    @DisplayName("Параметр «Высота потолков от 3 м»")
    public void shouldSeeCellingHeightInUrl() {
        ...
        urlSteps.path("/s-vysokimi-potolkami/").shouldNotDiffWithWebDriverUrl();
    }
}
