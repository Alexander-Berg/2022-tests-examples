...
from ops import *
from queries import COLLECT_CALLS_FOR_CLS_TEMPLATE, ADD_NO_SCRIPT_TEXTS_TEMPALTE, \
    HELPER_TEMPALTE, LOAD_RESULT_TEMPLATE, BRANDS_DICT


@vh3.decorator.graph(release_workflow='fa6945ee-f936-49b3-bbfb-9591d1b1f710')
...
def main(
    *,
    ...
    calls_directory: vh3.String = "home/verticals/broker/test/warehouse/dust/nirvana_clustering/call_scenario_autoru/1h",
    ...
    table_with_result_latest: vh3.String = "home/verticals/vsml/autoru_call_clusterization/classification_auto_test_result_latest",
    bucket_name: vh3.String = 'auto',
    vectorizer_s3_path: vh3.String = 'auto/call_clustering/script_detection/script_call_detection_vectorizer.joblib',
    classifier_s3_path: vh3.String = 'auto/call_clustering/script_detection/script_call_detection_clf.joblib',
    version_info_s3_path: vh3.String = 'auto/call_clustering/current/version_info.json'
) -> None:
    """
    auto_calls_classification[test]
    ...
    get_target_arcadia_revision_result: vh3.JSON = get_arcadia_revision(
        path=vh3.Expr("trunk/arcadia/classifieds/vsml/moderation/calls_clusterization_common/scripts/"),
    ...
    svn_checkout_target_result: SvnCheckoutDeterministicOutput = svn_checkout_deterministic(
        arcadia_path=vh3.Expr("classifieds/vsml/moderation/calls_clusterization_common/scripts/"),
        revision=9554364,
    ...
    collect_calls_for_classification_result: Yql1Output = yql_1(
        ...
        request=vh3.Expr(COLLECT_CALLS_FOR_CLS_TEMPLATE),
        mr_account=mr_account,
        yt_pool=yt_pool,
        yt_token=yt_token,
        yql_token=yql_token,
    ...
    download_current_version_info_result: MdsS3DownloadFileWithMetaOutput = mds_s3_download_file_with_meta(
        ...
        aws_secret_access_key="vertis_mdst_s3_secret_access_key",
        bucket=bucket_name,
        file_path=vh3.Expr(version_info_s3_path),
        **vh3.block_args(
    ...
    download_vectorizer_result1: MdsS3DownloadFileWithMetaOutput = mds_s3_download_file_with_meta(
        ...
        aws_secret_access_key="vertis_mdst_s3_secret_access_key",
        bucket=bucket_name,
        file_path=vh3.Expr("auto/call_clustering/current/vectorizer.joblib"),
        **vh3.block_args(
    ...
    download_cluster_info_result: MdsS3DownloadFileWithMetaOutput = mds_s3_download_file_with_meta(
        ...
        aws_secret_access_key="vertis_mdst_s3_secret_access_key",
        bucket=bucket_name,
        file_path=vh3.Expr("auto/call_clustering/current/cluster_info.json"),
        **vh3.block_args(
    ...
    helper_result: Yql1Output = yql_1(
        input1=[get_last_mr_table_result],
        request=vh3.Expr(HELPER_TEMPALTE),
        mr_account=mr_account,
        yt_pool=yt_pool,
        yt_token=yt_token,
        yql_token=yql_token,
    ...
    load_table_with_result_result1: vh3.MRTable = get_mr_table(
        cluster="hahn",
        table=vh3.Expr("//home/verticals/.tmp/table_with_version_auto_test"),
        yt_token="robot_vertis_ml_yt_token",
        **vh3.block_args(
            cache_options=vh3.graph.execution_block.BlockCacheOptions(enable_cache=False, source_block=None),
            code="get_mr_table_6",
    ...
    mr_write_json_result: MrWriteJsonOutput = mr_write_json(
        json=binary_to_json_result,
        dst_table=load_table_with_result_result1,
        yt_token=yt_token,
        write_mode="OVERWRITE",
        mr_account=mr_account,
        **vh3.block_args(code="mr_write_json", name="MR Write JSON")
    )

    add_no_sctipt_texts_result: Yql2Output = yql_2(
        input1=[mr_write_tsv_create_new_result],
        input2=[mr_write_json_result.new_table],
        request=vh3.Expr(ADD_NO_SCRIPT_TEXTS_TEMPALTE),
        mr_account=mr_account,
        yt_pool=yt_pool,
        yt_token=yt_token,
        yql_token=yql_token,
        mr_output_path=mr_output_path,
        **vh3.block_args(code="yql_4", name="add no_sctipt texts")
    )
    ...
    build_result_result: MrWriteJsonOutput = mr_write_json(
        dst_table=load_table_with_result_result,
        json=predict_cluster_result.result_json,
        yt_token=yt_token,
        write_mode="OVERWRITE",
        mr_account=mr_account,
        **vh3.block_args(code="mr_write_json_3", name="build result")
    )
    load_results_to_yt_result: Yql4Output = yql_4(
        ...
        input1=[build_result_result.new_table],
        request=vh3.Expr(LOAD_RESULT_TEMPLATE),
