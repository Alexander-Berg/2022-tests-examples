...
export HBASE_MASTER_OPTS="$HBASE_MASTER_OPTS -Xmx8192m $JDK_DEPENDED_OPTS"
export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS -Xmn3272m -XX:CMSInitiatingOccupancyFraction=70  -Xms16384m -Xmx16384m $JDK_DEPENDED_OPTS"
