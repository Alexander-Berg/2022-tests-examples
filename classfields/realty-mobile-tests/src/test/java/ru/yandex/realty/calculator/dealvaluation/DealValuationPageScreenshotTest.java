package ru.yandex.realty.calculator.dealvaluation;
...
public class DealValuationPageScreenshotTest {
    ...
    public void shouldSeeCalcPage() {
        ...
        Screenshot testing = compareSteps.takeScreenshot(basePageSteps.onBasePage().pageRoot());
        urlSteps.setMobileProductionHost().open();
        Screenshot production = compareSteps.takeScreenshot(basePageSteps.onBasePage().pageRoot());
    ...
    public void shouldSeeDocsRentPage() {
        ...
        basePageSteps.onBasePage().link("Стоимость продажи 2-комнатной квартиры").click();
