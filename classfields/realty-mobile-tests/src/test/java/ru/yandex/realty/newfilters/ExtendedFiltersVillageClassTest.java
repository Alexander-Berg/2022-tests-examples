...
public class ExtendedFiltersVillageClassTest {

    private static final String VILLAGE_CLASS_URL_PARAM = "villageClass";
    ...
    public void shouldSeeVillageClass() {
        ...
        urlSteps.testing().path(SPB_I_LO).path(KUPIT).path(KOTTEDZHNYE_POSELKI)
                .queryParam(VILLAGE_CLASS_URL_PARAM, expected).queryParam(CATEGORY_URL_PARAM, HOUSE_URL_PARAM)
