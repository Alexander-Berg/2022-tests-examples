...
@DisplayName("Расширенные фильтры. Тип дома")
@Feature(FILTERS)
@RunWith(Parameterized.class)
@GuiceModules(RealtyWebMobileModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class ExtendedFiltersBuildingTypesNotChpuTest {
    ...
    public void shouldSeeTypesBuildingInUrl() {
        ...
        urlSteps.path(KUPIT).path(KVARTIRA).queryParam("buildingType", type).shouldNotDiffWithWebDriverUrl();
    }
}
