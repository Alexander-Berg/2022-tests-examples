...
public class FavoriteTouchMapShowPhoneTest {
    ...
    @Test
    @Owner(KANTEMIROV)
    @DisplayName("Клик на «Позвонить» в избранном на карте")
    ...
    public void shouldSeeTwoPhoneFavMap() {
        ...
        assertThat(basePageSteps.onFavoritesPage().phones().stream().map(p -> p.getAttribute("href"))
