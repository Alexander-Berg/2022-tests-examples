...
public class ListingShowPhoneTest {
    ...
    public void shouldSeePhoneFreeJkNormalCase() {
        ...
        basePageSteps.onNewBuildingPage().site(FIRST).call().click();
        basePageSteps.onNewBuildingPage().site(FIRST).link(CALL)
    ...
    public void shouldSeePhone500() {
        ...
        basePageSteps.onNewBuildingPage().site(FIRST).link(CALL).should(isDisplayed());
    }
}
