...
@Feature(NEWBUILDING)
@DisplayName("Видим скриншот замороженной новостройки в избранном")
@RunWith(GuiceTestRunner.class)
@GuiceModules(RealtyWebMobileModule.class)
public class NewbuildingSuspendedFavoritesScreenshotTest {
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("Видим скриншот замороженной новостройки в избранном")
    public void shouldSeeConstructionSuspendedSiteScreenshot() {
        mockRuleConfigurable.offerWithSiteSearchStub(offerWithSiteSearchTemplate().sites(asList(
                site.setState("CONSTRUCTION_SUSPENDED"))).buildSite())
                .createWithDefaults();
