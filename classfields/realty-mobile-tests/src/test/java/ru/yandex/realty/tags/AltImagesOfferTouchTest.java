...
public class AltImagesOfferTouchTest {
    ...
    public void before() {
        ...
        jSoupSteps.connectTo(format("%s/offer/%s/", host, offerId)).mobileHeader().cookie("mockritsa_imposter", port)
                .get();
    }
    ...
    public void shouldSeeAltInImgInOffer() {
        ...
        final String altExpected = "Купить 3-комнатную квартиру 85 м², 3/17 этаж - изображение 1";
