...
public class ListingShowPhoneTest {
    ...
    public void shouldSeePhoneFreeVillageNormalCase() {
        ...
        basePageSteps.onVillageOffersPage().offer(FIRST).link(CALL).click();
        basePageSteps.onVillageOffersPage().offer(FIRST).link(CALL)
    ...
    public void shouldSeePhone500() {
        ...
        basePageSteps.onVillageOffersPage().offer(FIRST).link(CALL).should(isDisplayed());
    }
}
