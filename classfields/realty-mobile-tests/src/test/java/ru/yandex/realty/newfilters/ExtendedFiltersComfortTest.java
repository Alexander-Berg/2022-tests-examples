...
@DisplayName("Расширенные фильтры. Удобства")
@Feature(FILTERS)
@RunWith(Parameterized.class)
@GuiceModules(RealtyWebMobileModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class ExtendedFiltersComfortTest {

    private static final String COMFORT = "Удобства";
    ...
    public void shouldSeeComfortUrl() {
        ...
        urlSteps.path(SNYAT).path(KVARTIRA).queryParam(expected, "YES").shouldNotDiffWithWebDriverUrl();
    }
}
