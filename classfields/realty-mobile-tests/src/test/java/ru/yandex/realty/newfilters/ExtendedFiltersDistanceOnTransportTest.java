...
@DisplayName("Расширенные фильтры. Время до метро «Транспорт»")
@Feature(FILTERS)
@RunWith(Parameterized.class)
@GuiceModules(RealtyWebMobileModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class ExtendedFiltersDistanceOnTransportTest {
    ...
    public void shouldSeeOnTransportTimeToMetroInUrl() {
        ...
        basePageSteps.onMobileMainPage().extendFilters().button("На транспорте").click();
        ...
        urlSteps.path(KUPIT).path(KVARTIRA).queryParam(METRO_TRANSPORT, "ON_TRANSPORT")
                .queryParam(TIME_TO_METRO, expected).shouldNotDiffWithWebDriverUrl();
    }
}
