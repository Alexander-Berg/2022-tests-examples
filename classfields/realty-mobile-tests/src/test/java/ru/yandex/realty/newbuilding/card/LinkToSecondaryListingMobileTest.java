...
public class LinkToSecondaryListingMobileTest {
    ...
    public void shouldSeeLinkUrl() {
        ...
        basePageSteps.onNewBuildingCardPage().secondarySearchLink().link().should(hasHref(equalTo(TEST_STRING)));
    }
    ...
    public void shouldSeeLinkToOfferScreenshot() {
        basePageSteps.resize(375, 7000);
        urlSteps.testing().newbuildingSiteMock().open();
        basePageSteps.scrollElementToCenter(basePageSteps.onNewBuildingCardPage().secondarySearchLink());
        Screenshot testing = compareSteps.takeScreenshot(basePageSteps.onNewBuildingCardPage().secondarySearchLink());
        urlSteps.setMobileProductionHost().open();
        basePageSteps.scrollElementToCenter(basePageSteps.onNewBuildingCardPage().secondarySearchLink());
        Screenshot production = compareSteps.takeScreenshot(basePageSteps.onNewBuildingCardPage().secondarySearchLink());
