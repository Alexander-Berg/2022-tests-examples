...
public class OfferCardTouchGalleryShowPhoneTest {
    ...
    @Test
    @Owner(KANTEMIROV)
    @DisplayName("Клик на «Позвонить» в галерее")
    public void shouldSeePhoneNormalCaseGallery() {
        ...
        basePageSteps.onOfferCardPage().offersGallery().waitUntil(WebElementMatchers.isDisplayed());
        basePageSteps.onOfferCardPage().offersGallery().link(CALL_BUTTON).click();
        basePageSteps.onOfferCardPage().offersGallery().link(CALL_BUTTON)
    ...
    public void shouldSeeTwoPhoneGallery() {
        ...
        basePageSteps.onOfferCardPage().offerPhoto().click();
        basePageSteps.onOfferCardPage().offersGallery().waitUntil(WebElementMatchers.isDisplayed());
        basePageSteps.onOfferCardPage().offersGallery().spanLink(CALL_BUTTON).click();
