...
@Feature(NEWBUILDING)
@DisplayName("Видим скриншот сниппета новостройки без цены в избранном")
@RunWith(GuiceTestRunner.class)
@GuiceModules(RealtyWebMobileModule.class)
public class NewbuildingNoPriceFavoritesTest {
