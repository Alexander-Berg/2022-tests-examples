...
public class ExtendedFiltersExtraTest {
    ...
    public static Collection<Object[]> testParams() {
        return asList(new Object[][]{
                {"Без похожих", "showSimilar", "NO"},
                {"Только с фото", "hasPhoto", "YES"},
                {"Проверенные в ЕГРН", "withExcerptsOnly", "YES"},
                {"Есть видео", "videoUrl", "YES"},
                {"Онлайн-показ", "onlineShow", "YES"},
        });
    }
    ...
    public void shouldSeeExtraFilters() {
        basePageSteps.scrollToElement(basePageSteps.onMobileMainPage().extendFilters().byName("Рядом"));
