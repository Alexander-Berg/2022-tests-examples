...
@Feature(AMP_FEATURE)
@DisplayName("amp. Нет страниц ЖК и КП")
@RunWith(Parameterized.class)
@GuiceModules(RealtyWebMobileModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class AmpJkKpTest {
    ...
    public void shouldNotSeeJkKpLinkAmp() {
        urlSteps.testing().path(AMP).path(MOSKVA).path(KUPIT).path(label).open();
        basePageSteps.onAmpSaleAdsPage().errorPage(PAGE_NOT_FOUND).should(isDisplayed());
    }
}
