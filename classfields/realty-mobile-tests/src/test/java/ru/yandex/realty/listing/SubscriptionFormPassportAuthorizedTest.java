...
@DisplayName("Блок подписки авторизованного в паспорте")
@RunWith(GuiceTestRunner.class)
@GuiceModules(RealtyWebMobileModule.class)
public class SubscriptionFormPassportAuthorizedTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Email соответствует")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Кнопка «Подписаться» активна")
    public void shouldSeeSubscribeButtonEnabledPassportAuthorized() {
        basePageSteps.onMobileSaleAdsPage().subscriptionForm().button(SUBSCRIBE).should(isEnabled());
    }

    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Чекбокс подписки на спам активен")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Ссылка на «Подписки» после оформления")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Подписка активирована")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Подписка активирована, без промо")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Промо подписка подтверждена")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Промо подписка не активна")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. После рефреша подписка активна")
    public void shouldSeeSuccessSubscriptionAfterRefreshPassportAuthorized() {
        basePageSteps.onMobileSaleAdsPage().subscriptionForm().button(SUBSCRIBE).click();
        basePageSteps.refresh();
        basePageSteps.scrollToElement(basePageSteps.onMobileSaleAdsPage().subscriptionForm());

        basePageSteps.onMobileSaleAdsPage().subscriptionForm().subscriptionSuccess().should(isDisplayed());
    }

    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Нет чекбокса на промо, при активной подписке на промо")
    public void shouldNotSeePromoCheckboxWithActivePromoPassportAuthorized() {
        ...
        basePageSteps.onMobileSaleAdsPage().subscriptionForm().checkbox().should(not(isDisplayed()));
    }

    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Блок подписки. Юзер из паспорта. Подтверждение емейла отличного от паспортного")
    public void shouldSeeEmailConfirmationPassportAuthorized() {
        basePageSteps.scrollToElement(basePageSteps.onMobileSaleAdsPage().subscriptionForm());
        basePageSteps.onMobileSaleAdsPage().subscriptionForm().clearInput().click();
