...
public class ShivaTest {
    ...
    private static final String URL_TEMPLATE = "https://auth.%s/release";
    ...
    public void shouldSeeDifferentPackages() {
        ...
        String testingPackage = basePageSteps.onBasePage().body().should(hasText(startsWith("af-auth="))).getText();

        cookieSteps.setCookieForBaseDomain(urlSteps.getConfig().getBranchCookieName(), "production");
        urlSteps.refresh();

        String prodPackage = basePageSteps.onBasePage().body().should(hasText(startsWith("af-auth="))).getText();
    ...
    public void shouldSeeSamePackages() {
        ...
        String autotestPackage = basePageSteps.onBasePage().body().should(hasText(startsWith("af-auth="))).getText();
