...
public class ReSendCodeTest {
    ...
    @DisplayName("Проверка на повторную отправку кода")
    public void shouldClickReSendCode() {
        ...
        basePageSteps.onAuthPage().codeTimer().waitUntil(isDisplayed());
    }
