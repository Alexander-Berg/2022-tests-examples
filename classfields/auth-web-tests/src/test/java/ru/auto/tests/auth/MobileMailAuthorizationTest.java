...
import static ru.auto.tests.desktop.mobile.page.AuthPage.CONTINUE_BUTTON;
import static ru.auto.tests.desktop.mobile.page.AuthPage.MAIL_CODE;
import static ru.lanwen.diff.uri.core.util.URLCoder.encode;
import static ru.yandex.qatools.htmlelements.matchers.WebElementMatchers.hasText;

@DisplayName("Адаптированный тест. Авторизация по email пользователя")
@Feature(AUTH)
@Story("Mobile auth")
@RunWith(GuiceTestRunner.class)
@GuiceModules(MobileTestsModule.class)

public class MobileMailAuthorizationTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionUnauth",
                "mobile/AuthLoginOrRegisterEmailRedirectToMain",
    ...
    public void shouldAuthorizeByEmail() {
        basePageSteps.onAuthPage().mailLink().click();
