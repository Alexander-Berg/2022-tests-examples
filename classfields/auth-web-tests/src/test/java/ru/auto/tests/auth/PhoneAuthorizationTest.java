...
@DisplayName("Авторизация по номеру телефона зарегистрированного пользователя")
@Feature(AUTH)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class PhoneAuthorizationTest {
    ...
    public void shouldAuthorizeByPhoneNumber() {
