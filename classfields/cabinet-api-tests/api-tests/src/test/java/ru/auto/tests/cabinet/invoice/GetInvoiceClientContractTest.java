...
@DisplayName("GET /client/{client_id}/invoice/contracts")
@GuiceModules(CabinetApiModule.class)
@RunWith(GuiceTestRunner.class)
public class GetInvoiceClientContractTest {
    ...
    @Test
    public void shouldGetInfoClientContractHasNoDiffWithProduction() {
        Function<ApiClient, JsonObject> request = apiClient -> apiClient.invoice().getBalanceContracts()
    ...
    public void shouldGetStatusOkForManager() {
        api.invoice().getBalanceContracts()
