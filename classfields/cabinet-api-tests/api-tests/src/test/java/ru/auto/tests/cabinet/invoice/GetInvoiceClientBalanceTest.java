...
@DisplayName("GET /client/{client_id}/invoice/client")
@GuiceModules(CabinetApiModule.class)
@RunWith(GuiceTestRunner.class)
public class GetInvoiceClientBalanceTest {
    ...
    @Test
    public void shouldGetInfoBalanceClientHasNoDiffWithProduction() {
        Function<ApiClient, JsonObject> request = apiClient -> apiClient.invoice().getBalanceClient()
