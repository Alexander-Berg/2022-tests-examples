package ru.auto.tests.cabinet.features;
...
public class GetFeaturesCompareTest {
    ...
    public void shouldGetFeaturesHasNoDiffWithProduction() {
        Function<ApiClient, JsonArray> req = apiClient -> apiClient.features().getFeatures()
                .reqSpec(defaultSpec())
