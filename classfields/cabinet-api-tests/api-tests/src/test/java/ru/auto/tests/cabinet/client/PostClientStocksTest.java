...
public class PostClientStocksTest {
    ...
    @Test
    public void shouldGetListClientStocks() {
        String userId = "19565983";
        api.client().saveClientStocks().reqSpec(defaultSpec()).xAutoruOperatorUidHeader(userId).clientIdPath(DEALER_ID)
