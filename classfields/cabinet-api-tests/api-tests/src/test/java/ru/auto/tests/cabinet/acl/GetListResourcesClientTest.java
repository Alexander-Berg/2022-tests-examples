...
@DisplayName("GET /acl/client/{client_id}/resources")
@GuiceModules(CabinetApiModule.class)
@RunWith(GuiceTestRunner.class)
public class GetListResourcesClientTest {
    ...
    public void shouldGetListAclGroupClientHasNoDiffWithProduction() {
        Function<ApiClient, JsonObject> response = apiClient -> apiClient.acl().getClientAccessResources()
    ...
    public void shouldGetStatusOkForManager() {
        api.acl().getClientAccessResources()
