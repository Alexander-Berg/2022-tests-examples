...
public class GetClientCallsInfoCompareTest {
    ...
    @Test
    public void shouldGetCallsInfoHasNotDiffProduction() {
        Function<ApiClient, JsonObject> response = apiClient -> apiClient.client().getClientCallsInfo()
                .clientIdPath("16453").categoryQuery(category).sectionQuery(section).xAutoruOperatorUidHeader("14090654")
