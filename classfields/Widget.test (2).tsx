...
import Widget, { Props as AbstractProps, State as AbstractState, OwnProps as AbstractOwnProps } from './Widget';
...
function shallowRenderComponent({ props, initialState }: { props: MyWidgetProps & AbstractOwnProps; initialState: Partial<ModelState> }) {
