...
public class CurrentDraftXUserLocationIncorrectHeaderTest {
    ...
    private static List<String> provideHeadersValue() {
        return newArrayList("lat=0;lon=0;acc=-1");
    }

    @Test
    public void shouldSee400WithIncorrectUserLocationHeader() {
        ...
        assertThat(response).hasError(BAD_PARAMS_DETAILS)
                .hasStatus(ERROR)
                .hasDetailedError("Some of lat, lon or acc have incorrect value");
    }
}
