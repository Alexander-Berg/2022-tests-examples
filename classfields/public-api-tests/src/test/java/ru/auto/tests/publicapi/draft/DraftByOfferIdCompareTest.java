...
public class DraftByOfferIdCompareTest {
    ...
    @Test
    public void shouldSeeDraftByOfferIdForAllSubcategoriesNoDiffWithProd() {
        Account account = am.create();
        String sessionId = adaptor.login(account).getSession().getId();
        String offerId = adaptor.createDraft(sessionId, category, new OfferTemplate().process(offer, account.getLogin())).getOfferId();
