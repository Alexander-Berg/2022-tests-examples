...
public class HideWithoutBodyMotoTruckTest {
    ...
    public void shouldSee404WithWrongCategory() {
        ...
        AutoApiErrorResponse errorResponse = api.userOffers().hideWithoutBody().categoryPath(category.name()).offerIDPath(offerId)
