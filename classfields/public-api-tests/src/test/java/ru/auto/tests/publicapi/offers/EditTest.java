...
@DisplayName("POST /user/offers/{category}/{offerID}/edit")
...
public class EditTest {
    ...
    public void shouldSee403WhenNoAuth() {
        api.userOffers().edit().categoryPath(CARS.name()).offerIDPath(Utils.getRandomString())
    ...
    public void shouldSee401WithoutSessionId() {
        ...
        api.userOffers().edit().categoryPath(CARS.name()).offerIDPath(offerId)
    ...
    public void shouldSee400WithIncorrectCategory() {
        ...
        api.userOffers().edit().categoryPath(incorrectCategory).offerIDPath(offerId)
    ...
    public void shouldSee400WithWrongOfferId() {
        ...
        api.userOffers().edit().categoryPath(CARS.name()).offerIDPath(incorrectOfferId)
