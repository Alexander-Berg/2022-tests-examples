...
@DisplayName("GET /search/moto")
@RunWith(classOf[GuiceTestRunner])
@GuiceModules(Array(classOf[PublicApiModule]))
class GetSearchMotoTest {
  ...
  def shouldHasNoDiffWithProduction(): Unit = {
    val request = (apiClient: ApiClient) => apiClient.search.searchMoto
      .reqSpec(defaultSpec)
      .contextQuery("listing")
      .motoCategoryQuery("MOTORCYCLE")
      .ridQuery("213")
      .geoRadiusQuery("200")
