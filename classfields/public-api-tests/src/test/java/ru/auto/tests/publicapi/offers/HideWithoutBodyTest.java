...
public class HideWithoutBodyTest {
    ...
    public void shouldSee403WhenNoAuth() {
        api.userOffers().hideWithoutBody().categoryPath(CARS.name()).offerIDPath(Utils.getRandomString()).execute(validatedWith(shouldBeCode(SC_FORBIDDEN)));
    }
    ...
    public void shouldSee401WithoutSessionId() {
        ...
        api.userOffers().hideWithoutBody().categoryPath(CARS.name()).offerIDPath(offerId)
    ...
    public void shouldSee400WithIncorrectOfferId() {
        ...
        api.userOffers().hideWithoutBody().categoryPath(CARS.name()).offerIDPath(incorrectOfferId)
    ...
    public void shouldSee400WithIncorrectCategory() {
        ...
        api.userOffers().hideWithoutBody().categoryPath(incorrectCategory).offerIDPath(offerId)
                .reqSpec(defaultSpec())
