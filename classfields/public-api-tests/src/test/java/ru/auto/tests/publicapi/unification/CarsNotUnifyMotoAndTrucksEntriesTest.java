...
public class CarsNotUnifyMotoAndTrucksEntriesTest {
    ...
    @Test
    public void shouldNotUnifyMotoAndTrucks() {
        String body = getResourceAsString(entries);

        Function<ApiClient, JsonObject> req = apiClient -> apiClient.unification().unifyCars().reqSpec(defaultSpec())
                .reqSpec(r -> {
