...
/**
 * Generated API tests for all status codes ParseQuery
 */
...
public class ParseQueryTest {
    ...
    @Ignore
    @Owner("generated")
    @Description("Check status code 400 and response for GET /autoparts/parse (Ошибка в запросе)")
    public void shouldSee400ParseQuery() {
        String text = Utils.getRandomString();
        api.autoparts().parseQuery().renderAliasesQuery().reqSpec(defaultSpec())
