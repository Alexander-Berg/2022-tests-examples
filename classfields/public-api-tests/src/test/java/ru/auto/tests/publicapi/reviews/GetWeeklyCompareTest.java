...
public class GetWeeklyCompareTest {
    @Rule
    @Inject
    ...
    @Test
    public void shouldGetWeeklyHasNoDiffWithProduction() {
        Function<ApiClient, JsonObject> req = apiClient -> apiClient.reviews().weekly().reqSpec(defaultSpec())
                .reqSpec(reqSpec)
