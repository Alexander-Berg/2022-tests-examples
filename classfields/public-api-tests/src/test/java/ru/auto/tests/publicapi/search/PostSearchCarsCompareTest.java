...
@DisplayName("POST /search/cars")
@GuiceModules(PublicApiModule.class)
@RunWith(Parameterized.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class PostSearchCarsCompareTest {
    ...
    public static Collection<AutoApiSearchSearchRequestParameters> getParameters() {
        ...
        return newArrayList(
                ...
                new AutoApiSearchSearchRequestParameters().markModelNameplate(newArrayList("AUDI")),
                new AutoApiSearchSearchRequestParameters().markModelNameplate(newArrayList("AUDI#A4")),
                new AutoApiSearchSearchRequestParameters().markModelNameplate(newArrayList("AUDI#A4##20637504"))
        );
    }

    @Test
    public void shouldSearchCarsNoHasDifferenceWithProduction() {
        Function<ApiClient, JsonObject> req = apiClient -> apiClient.search().postSearchCars()
