...
public class PostSearchCarsTest {
    ...
    public void shouldSee403WhenNoAuth() {
        api.search().postSearchCars().body(new AutoApiSearchSearchRequestParameters())
                .execute(validatedWith(shouldBeCode(SC_FORBIDDEN)));
    }

    @Test
    public void shouldSee200WithoutBody() {
        Function<ApiClient, JsonObject> req = apiClient -> apiClient.search().postSearchCars().pageQuery(1).pageSizeQuery(2)
                .reqSpec(defaultSpec())
