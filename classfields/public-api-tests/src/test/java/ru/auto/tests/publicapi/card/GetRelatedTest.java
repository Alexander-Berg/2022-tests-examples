...
@DisplayName("GET /offer/{category}/{offerID}/related")
@RunWith(GuiceTestRunner.class)
@GuiceModules(PublicApiModule.class)
public class GetRelatedTest {
    ...
    @Test
    public void shouldRelatedCarsHasNoDiffWithProduction() {
        ...
        Function<ApiClient, JsonObject> req = apiClient -> apiClient.offerCard().relatedCars()
