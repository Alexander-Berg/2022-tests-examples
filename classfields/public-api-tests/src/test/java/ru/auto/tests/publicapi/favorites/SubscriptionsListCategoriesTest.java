...
public class SubscriptionsListCategoriesTest {
    ...
    @Test
    public void shouldSeeSearches() {
        Account account = am.create();
        String sessionId = adaptor.login(account).getSession().getId();

        adaptor.addSearch(category, sessionId);
        Function<ApiClient, JsonObject> request = apiClient -> apiClient.userFavorites().getSavedSearches()
