...
class FeedsCreateMotoTaskNegativeTest(category: MotoCategoryEnum, section: SectionEnum) extends CreateMotoFeedsTaskOps with Authorization {
  ...
  def shouldSee401WithoutSession(): Unit = {
    createMotoTask(defaultTaskSettings, category, section)
  ...
  def shouldSee403WhenNoAuth(): Unit = {
    createMotoTaskWithoutAuth(defaultTaskSettings, category, section)
...
object FeedsCreateMotoTaskNegativeTest {
