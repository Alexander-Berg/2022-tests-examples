...
class FeedsCreateCarsTaskNegativeTest(section: SectionEnum) extends CreateCarsFeedsTaskOps with Authorization {
  ...
  def shouldSee403WhenNoAuth(): Unit = {
    createCarsTaskWithoutAuth(defaultTaskSettings, section)
...
object FeedsCreateCarsTaskNegativeTest {
