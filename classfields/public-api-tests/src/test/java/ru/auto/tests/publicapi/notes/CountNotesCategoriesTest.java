...
public class CountNotesCategoriesTest {
    ...
    @Test
    @Owner(SCROOGE)
    public void shouldSeeEmptyNotes() {
    ...
    @Test
    @Owner(SCROOGE)
    public void shouldSeeEmptyNotesForAnonym() {
    ...
    @Test
    @Owner(SCROOGE)
    public void shouldSeeNotesForAnonym() {
        Account account = am.create();
        String sessionId = adaptor.login(account).getSession().getId();
        String anonymSessionId = adaptor.session().getSession().getId();
        String offerId = adaptor.createOffer(account.getLogin(), sessionId, category).getOfferId();
