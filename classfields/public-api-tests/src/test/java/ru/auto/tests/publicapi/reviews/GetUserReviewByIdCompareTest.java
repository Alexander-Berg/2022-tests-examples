...
public class GetUserReviewByIdCompareTest {
    ...
    public void shouldNoDiffWithProduction() {
        ...
        Function<ApiClient, JsonObject> request = apiClient -> apiClient.userReviews().userReview().reviewIdPath(reviewId).xSessionIdHeader(sessionId)
