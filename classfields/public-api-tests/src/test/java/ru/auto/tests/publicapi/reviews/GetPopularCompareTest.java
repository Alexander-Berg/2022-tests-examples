...
public class GetPopularCompareTest {
    @Rule
    @Inject
    ...
    @Test
    public void shouldGetPopularHasNoDiffWithProduction() {
        Function<ApiClient, JsonObject> req = apiClient -> apiClient.reviews().popular().reqSpec(defaultSpec())
                .reqSpec(reqSpec)
