...
public class ActualizeTest {
    ...
    public void shouldSee403WhenNoAuth() {
        api.userOffers().actualize().categoryPath(CARS.name()).offerIDPath(Utils.getRandomString())
    ...
    public void shouldSee401WithoutSessionId() {
        ...
        api.userOffers().actualize().categoryPath(CARS.name()).offerIDPath(offerId)
    ...
    public void shouldSee400WithIncorrectCategory() {
        ...
        api.userOffers().actualize().categoryPath(incorrectCategory).offerIDPath(offerId)
    ...
    public void shouldSee400WithWrongOfferId() {
        ...
        api.userOffers().actualize().categoryPath(CARS.name()).offerIDPath(incorrectOfferId)
