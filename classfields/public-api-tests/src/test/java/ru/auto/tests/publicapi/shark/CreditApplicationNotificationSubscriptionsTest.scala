...
@DisplayName("GET /shark/credit-application/notification-subscriptions/{credit_application_id}")
@GuiceModules(Array(classOf[PublicApiModule]))
@RunWith(classOf[GuiceTestRunner])
class CreditApplicationNotificationSubscriptionsTest {
  ...
  def shouldSee403WhenNoAuth(): Unit = {
    api.shark.notificationSubscriptionsCreditApp()
  ...
  def shouldSee401WithoutSessionId(): Unit = {
    val notificationSubscriptions = api.shark.notificationSubscriptionsCreditApp()
      .reqSpec(defaultSpec)
      .creditApplicationIdPath(getRandomString)
  ...
  def shouldGetNotificationSubscriptions(): Unit = {
    ...
    val subscriptions = api.shark.notificationSubscriptionsCreditApp()
      .reqSpec(defaultSpec)
  ...
  def shouldHasNoDiffWithProduction(): Unit = {
    ...
    val req = (apiClient: ApiClient) => apiClient.shark.notificationSubscriptionsCreditApp()
      .reqSpec(defaultSpec)
      .creditApplicationIdPath(creditApplicationId)
      .xSessionIdHeader(sessionId)
