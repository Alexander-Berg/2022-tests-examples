...
public class GetUserReviewsCompareTest {
    ...
    public void shouldNoDiffWithProduction() {
        ...
        adaptor.saveReview(account.getLogin(), sessionId, review);

        Function<ApiClient, JsonObject> request = apiClient -> apiClient.userReviews().userReviews()
