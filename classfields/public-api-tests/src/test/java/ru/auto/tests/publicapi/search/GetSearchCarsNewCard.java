...
@DisplayName("GET /search/cars/new-card")
@RunWith(GuiceTestRunner.class)
@GuiceModules(PublicApiModule.class)
public class GetSearchCarsNewCard {
    @Rule
    @Inject
    ...
    private Response getNewCardResponse(String techParamId, String complectationId, int expectedStatus, ApiClient api) {
        return api.search().newCardGet()
                .groupingIdQuery(String.format("tech_param_id=%s,complectation_id=%s", techParamId, complectationId))
                .reqSpec(defaultSpec())
