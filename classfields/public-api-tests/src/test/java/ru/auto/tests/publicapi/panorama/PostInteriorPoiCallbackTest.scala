...
@DisplayName("POST /panorama/interior/{panorama_id}/poi/upload/callback")
@GuiceModules(Array(classOf[PublicApiModule]))
@RunWith(classOf[GuiceTestRunner])
class PostInteriorPoiCallbackTest {
  ...
  def shouldFailOnInvalidPoiId(): Unit = {
    val panoramaId = "1837506888-1645193019743-a1U7H"
    adaptor.deleteAllInteriorPoi(panoramaId)

    api.interiorPanorama.callbackPoiInt()
      .reqSpec(defaultSpec)
  ...
  def shouldHasNoDiffWithProduction(): Unit = {
    val panoramaId = "1670127936-1645187830128-XNRBv"
    adaptor.deleteAllInteriorPoi(panoramaId)

    val x = Random.between(1, 1000)
    val y = Random.between(1, 1000)
    val poi = adaptor.makeInteriorPoi(x, y, getRandomString, Optional.of("https://avatars.mds.yandex.net/get-zen_doc/1705407/pub_6109ca83621f3b6b19a01a59_6109ca8e1e7e500119e38bbd/scale_1200"))
