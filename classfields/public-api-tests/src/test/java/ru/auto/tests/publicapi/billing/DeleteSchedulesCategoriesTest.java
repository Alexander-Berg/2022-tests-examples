...
public class DeleteSchedulesCategoriesTest {
    ...
    public void shouldDeleteSchedule() {
        ...
        api.billingSchedules().deleteSchedule().categoryPath(category.name()).offerIdPath(offerId).productPath(DEFAULT_PRODUCT)
