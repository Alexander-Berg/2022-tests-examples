...
public class GetTopLikeCompareTest {
    @Rule
    @Inject
    ...
    @Test
    public void shouldGetTopLikerHasNoDiffWithProduction() {
        Function<ApiClient, JsonObject> req = apiClient -> apiClient.reviews().topLike().reqSpec(defaultSpec())
                .reqSpec(reqSpec)
