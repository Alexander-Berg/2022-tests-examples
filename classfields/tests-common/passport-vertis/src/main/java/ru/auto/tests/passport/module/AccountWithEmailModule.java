...
import ru.auto.tests.passport.providers.AccountWithEmailProvider;
 ...
 */
public class AccountWithEmailModule extends AbstractModule {

    @Override
    protected void configure() {
        install(new PassportApiModule());
        install(new PassportApiAdaptor());
        install(new AccountWithEmailProvider());
