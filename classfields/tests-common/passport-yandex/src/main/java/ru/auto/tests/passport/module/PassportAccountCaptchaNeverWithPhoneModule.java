...
import ru.auto.tests.passport.core.PassportAccountCaptchaNeverWithPhoneProvider;
 ...
 */
public class PassportAccountCaptchaNeverWithPhoneModule extends AbstractModule {

    @Override
    protected void configure() {
        install(new PassportYandexModule());
        install(new PassportAccountCaptchaNeverWithPhoneProvider());
