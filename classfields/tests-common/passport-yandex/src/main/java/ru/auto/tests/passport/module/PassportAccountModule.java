...
import ru.auto.tests.passport.core.PassportAccountProvider;
 ...
 */
public class PassportAccountModule extends AbstractModule {

    @Override
    protected void configure() {
        install(new PassportYandexModule());
        install(new PassportAccountProvider());
