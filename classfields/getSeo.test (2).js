...
describe('index', () => {
    ...
    it('должен сгенерировать каноникл с геоурлом для большого региона', () => {
        ...
        expect(result).toHaveProperty('canonical', 'https://autoru_frontend.base_domain/moskva/cars/all/');
    });
    ...
    it('должен сгенерировать каноникл с геоурлом без ?geo_id для маленького региона', () => {
        ...
        expect(result).toHaveProperty('canonical', 'https://autoru_frontend.base_domain/murmansk/cars/all/');
    });
    ...
    it('должен сгенерировать каноникл без rossiya на главной странице', () => {
        const result = getSeo({
            config: {
                data: {
                    pageType: 'index',
...
describe('listing', () => {
    ...
    it('должен сгенерировать правильные данные для листинга по кастом тегу', () => {
        const result = getSeo({
            config: {
                data: {
                    pageType: 'listing',
    ...
    it('должен сгенерировать правильные данные для листинга по цене', () => {
        ...
        expect(result).toHaveProperty('canonical', 'https://autoru_frontend.base_domain/moskva/cars/daewoo/all/do-600000/');
        expect(result).toHaveProperty('amphtml', 'https://autoru_frontend.base_domain/moskva/amp/cars/daewoo/all/do-600000/');
    });
