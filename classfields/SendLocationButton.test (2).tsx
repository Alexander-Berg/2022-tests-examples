...
it('должен передать урл правильного формата при выборе локации на карте', () => {
    ...
    const tree = shallow(
        <SendLocationButton on_select_location={on_select_location_mock}>
    ...
    expect(on_select_location_mock).toHaveBeenCalledWith(
        'https://yandex.ru/maps/?mode=whatshere&whatshere%5Bpoint%5D=37.64946593258509,55.73991898188298&whatshere'
    );
});
