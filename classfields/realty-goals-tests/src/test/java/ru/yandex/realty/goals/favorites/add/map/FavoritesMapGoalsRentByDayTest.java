...
public class FavoritesMapGoalsRentByDayTest {
    ...
    public void before() {
        ...
        favoritesAddParams = params().offerType(RENT)
    ...
    @Test
    @Owner(KANTEMIROV)
    @DisplayName("Снять квартиру посуточно. Клик «Добавить в избранное»")
    ...
    @Test
    @Owner(KANTEMIROV)
    @DisplayName("Снять квартиру посуточно. Добавить заметку")
