...
public class RolesCommentSaveFailReadOnlyUserTest {
    ...
    @Test
    @DisplayName("Пытаемся сохранить комментарий для юзера под ролью для чтения")
    public void shouldSeeSavedFailComment() {
        ...
        lkSteps.onAdminUserPage().errorToast();
    }
}
