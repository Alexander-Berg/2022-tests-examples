...
public class UserTenantAdInfoCheckBoxTest {
    ...
    public void before() {
        ...
        urlSteps.testing().path(LK_PERSONAL_DATA_EDIT).queryParam("spaFromPage", "selection")
                .queryParam("flow", "TENANT").open();
    }

    @Test
    @DisplayName("Оставляем галку сохраняем нового юзера смотрим в инфе о юзере есть галка. Жилец")
    public void shouldSeeSavedTickOnAdInfo() {
        ...
        lkSteps.onLkPage().button(CONTINUE).click();
    ...
    @Test
    @DisplayName("Убираем галку сохраняем нового юзера смотрим в инфе о юзере нет галки. Жилец")
    public void shouldSeeNotSavedTickOnAdInfo() {
