package ru.yandex.arenda.matcher;
...
public class AttributeMatcher extends TypeSafeMatcher<WebElement> {
    ...
    public static Matcher<WebElement> isDisabled() {
        return anyOf(new HasAttributeMatcher("class", containsString("_disabled")),
                new HasAttributeMatcher("disabled", containsString("true")));
    }
