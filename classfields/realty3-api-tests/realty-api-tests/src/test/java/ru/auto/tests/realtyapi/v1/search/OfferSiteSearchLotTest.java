...
public class OfferSiteSearchLotTest {
    ...
    public static Collection<Object[]> getParameters() throws IOException {
        return parseParams("lot", "search/offer_with_site_search_test_cases.txt");
    }
    ...
    public void shouldCategorySameWithRequested() {
        ...
        MatcherAssert.assertThat(offers,
                everyItem(jsonPartMatches("offerCategory", equalTo(category))));

        Assertions.assertThat(offers).describedAs("Все офферы должны иметь тип " + category)
    ...
    public void shouldPriceInUpperBound() {
        BigDecimal value = new BigDecimal(query.get("priceMax"));
