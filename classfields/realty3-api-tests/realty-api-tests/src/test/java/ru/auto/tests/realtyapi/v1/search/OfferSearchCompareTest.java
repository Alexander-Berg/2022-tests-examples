...
@Title("GET /offerSearch.json")
@RunWith(Parameterized.class)
@GuiceModules(RealtyApiModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class OfferSearchCompareTest {
...
//        JsonObject response = api.offerSearchjson().reqSpec(req -> req.addQueryParams(queryParams))
//                .execute(validatedWith(shouldBe200Ok())).as(JsonObject.class, GSON);
//
//        JsonObject responseProd = prodApi.offerSearchjson().reqSpec(req -> req.addQueryParams(queryParams))
//                .execute(validatedWith(shouldBe200Ok())).as(JsonObject.class, GSON);
//
