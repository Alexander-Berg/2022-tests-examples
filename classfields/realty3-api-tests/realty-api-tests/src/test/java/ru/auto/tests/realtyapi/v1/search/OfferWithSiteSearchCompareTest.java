...
public class OfferWithSiteSearchCompareTest {

    private static final String RESOURCE_FILE = "search/offer_with_site_search.txt";
    ...
    public void shouldHasNoDiffWithProduction() {
        ...
        assertThat(request.apply(api), jsonEquals(request.apply(prodApi))
                .whenIgnoringPaths("response.timeStamp", "response.searchQuery.logQueryId", "response.offers.items[*].relevance"));
    }
