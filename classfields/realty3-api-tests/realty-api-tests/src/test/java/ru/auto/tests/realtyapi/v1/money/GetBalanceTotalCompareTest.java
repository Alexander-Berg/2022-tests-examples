...
@Title("GET /money/balance/total/{uid}")
@RunWith(GuiceTestRunner.class)
@GuiceModules(RealtyApiModule.class)
public class GetBalanceTotalCompareTest {

    private static final String VALID_UID = "485576718";
    ...
    public void shouldHasNoDiffWithProduction() {
        Function<ApiClient, JsonObject> request = apiClient -> apiClient.money().clientCreditLimits()
                .reqSpec(authSpec())
                .uidPath(VALID_UID)
