...
public class OfferSiteSearchCategoryTypeTest {
    ...
    public static Collection<Object[]> getParameters() throws IOException {
        return parseParams("categoryType", "search/offer_with_site_search_test_cases.txt");
    }
    ...
    public void shouldTypeSameWithRequested() {
        ...
        Assertions.assertThat(offers).describedAs("Все офферы должны иметь тип " + type)
                .allSatisfy(offer -> MatcherAssert.assertThat(offer, jsonPartMatches("offerType",
                        equalTo(type))));
    }
