...
@Title("PUT /user/{user}/personalization/showOffers")
@RunWith(GuiceTestRunner.class)
@GuiceModules(RealtyApiModule.class)
public class PutShowOffersTest {
    ...
    public void shouldSee403WithNoAuthTest() {
        api.personalization().showOffersRoute()
    ...
    public void should400WithNoOfferIdTest() {
        ...
        api.personalization().showOffersRoute().reqSpec(authSpec())
                .userPath(ME)
