...
public class MapSearchMultihousesTest {
    ...
    public static Collection<Object[]> getParameters() throws IOException {
        return parseParams("multiHouses", "search/map_search_test_cases.txt");
    }

    @Test
    @Owner(ARTEAMO)
    public void shouldMultihousesIsNotEmptyTest() {
        ...
        Assertions.assertThat(response).describedAs("Массив multiHouses не должен быть пустым")
                .satisfies(r -> MatcherAssert.assertThat(r, jsonNodePresent("multiHouses")));
    }
