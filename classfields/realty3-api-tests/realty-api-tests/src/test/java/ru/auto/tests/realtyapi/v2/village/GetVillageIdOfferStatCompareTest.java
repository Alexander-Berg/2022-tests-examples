...
public class GetVillageIdOfferStatCompareTest {
    @Rule
    @Inject
    ...
    public static Collection<Long> getParameters() {
        return Arrays.asList(1773615L, 1879440L);
    }

    @Test
    @Owner(ARTEAMO)
    public void shouldDeveloperSuggestHasNoDiffWithProduction() {
        Function<ApiClient, JsonObject> request = apiClient -> apiClient.village().villageOfferStatRoute()
                .reqSpec(authSpec())
                .idPath(id)
