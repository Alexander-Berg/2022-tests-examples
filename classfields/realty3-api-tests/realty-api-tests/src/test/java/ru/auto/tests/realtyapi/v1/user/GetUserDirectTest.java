...
@Title("GET /user/direct/{uid}")
@RunWith(GuiceTestRunner.class)
@GuiceModules(RealtyApiModule.class)
public class GetUserDirectTest {
    ...
    public void shouldSee403WithoutHeaders() {
        api.user().getDirectUserRoute().uidPath(getRandomUID()).execute(validatedWith(shouldBeCode(SC_FORBIDDEN)));
    }
    ...
    public void shouldUserHasNoDiffWithProduction() {
        ...
        Function<ApiClient, JsonObject> request = apiClient -> apiClient.user().getDirectUserRoute()
