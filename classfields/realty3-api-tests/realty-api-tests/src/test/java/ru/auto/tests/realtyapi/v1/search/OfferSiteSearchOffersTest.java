...
public class OfferSiteSearchOffersTest {
    ...
    public static Collection<Object[]> getParameters() throws IOException {
        return parseParams("offers", "search/offer_with_site_search_test_cases.txt");
    }
    ...
    public void shouldSeeOnlySitesArray() {
        ...
        MatcherAssert.assertThat(response.getAsJsonObject("offers"), notNullValue());
