...
public class GetOffersCompareTest {
    ...
    @Test
    public void shouldOffersHasNoDiffWithProduction() {
        Account account = am.create();
        String token = oAuth.getToken(account);
        adaptor.createOffer(token, offerPath);

        Function<ApiClient, JsonObject> request = apiClient -> apiClient.userOffers().getUserOffersRoute()
