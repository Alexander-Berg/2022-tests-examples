...
public class CreateSubscriptionSuccessTest {
    @Rule
    @Inject
    ...
    private RealtyResponseOfferResponse.OfferCategoryEnum offerCategory;
    ...
    @Test
    public void shouldSuccessCreateSubscription() {
        Account account = am.create();
        String token = oAuth.getToken(account);
        SubscriptionRequest reqBody = getValidSubscriptionRequest();
        reqBody.getQuery().setCategory(offerCategory.getValue());
