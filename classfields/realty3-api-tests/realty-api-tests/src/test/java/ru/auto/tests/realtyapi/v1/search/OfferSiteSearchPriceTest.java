...
public class OfferSiteSearchPriceTest {
    ...
    public static Collection<Object[]> getParameters() throws IOException {
        return parseParams("price", "search/offer_with_site_search_test_cases.txt");
    }
    ...
    public void shouldPriceInUpperBound() {
        ...
        MatcherAssert.assertThat(offers,
                everyItem(jsonPartMatches("price.value", lessThanOrEqualTo(priceMax))));
    ...
    public void shouldUnitIsCorrect() {
        String wholeOffer = "WHOLE_OFFER";

        Assertions.assertThat(offers).describedAs("Все офферы должны иметь оплату " + wholeOffer)
