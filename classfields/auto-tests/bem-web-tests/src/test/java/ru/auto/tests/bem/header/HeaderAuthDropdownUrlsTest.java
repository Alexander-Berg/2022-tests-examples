...
public class HeaderAuthDropdownUrlsTest {
    ...
    public void shouldClickAuthDropdownUrls() {
        ...
        basePageSteps.onCatalogPage().header().authDropdown().button(title).click();
        urlSteps.fromUri(format(expectedUrl, urlSteps.getConfig().getBaseDomain())).ignoreParam("geo_id")
