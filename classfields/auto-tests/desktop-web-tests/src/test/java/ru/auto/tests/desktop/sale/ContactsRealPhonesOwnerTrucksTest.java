...
@DisplayName("Карточка объявления - контакты под владельцем")
@Feature(SALES)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class ContactsRealPhonesOwnerTrucksTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthUser",
                "desktop/OfferTrucksUsedUserOwnerRedirectFalse").post();
