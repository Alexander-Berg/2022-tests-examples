...
public class ElectroBannersOfferCardTest {
    ...
    public void shouldSeeElectroBannerOnCard() {
        ...
        basePageSteps.onCardPage().benefits().benefit(ELECTROCAR).hover();
        basePageSteps.onCardPage().benefitPopup().waitUntil(hasText(ELECTRO_POPUP));
        basePageSteps.onCardPage().benefitPopup().button(LETS_SEE).click();
