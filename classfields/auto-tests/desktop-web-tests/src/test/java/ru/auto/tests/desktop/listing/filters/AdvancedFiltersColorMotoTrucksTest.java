...
public class AdvancedFiltersColorMotoTrucksTest {
    ...
    @DisplayName("Параметр 'Цвет'")
    public void shouldSelectColor() {
        basePageSteps.onListingPage().filter().showAdvancedFilters();
        basePageSteps.onListingPage().filter().color(COLOR_RED).click();
        ...
        urlSteps.addParam("color", COLOR_RED).shouldNotSeeDiff();
