...
public class ActiveSaleUsedUserOwnerMotoTest {
    ...
    public void shouldSeeSale() {
        basePageSteps.onCardPage().contacts().should(hasText("Константин\nМоскваЮго-Западный административный округ\n" +
                "+7 222 222-22-22\nПочему не мой номер"));

        basePageSteps.onCardPage().cardVas().should(hasText("Турбо-продажа\n1 497 ₽\nЭкспресс-продажа\n799 ₽\n" +
                "Поднятие в поиске\n297 ₽\nПАКЕТ ОПЦИЙ\nТурбо-продажа\nx20 просмотров\nВаше предложение увидит максимум " +
                "посетителей — это увеличит шансы на быструю и выгодную продажу. Объявление будет выделено цветом, " +
                "поднято в топ, размещено в специальном блоке на главной странице, на странице марки и в выдаче " +
                "объявлений.\nПодключить за 1 497 ₽\nВместо 2 495 ₽\n" +
