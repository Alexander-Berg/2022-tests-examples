...
@DisplayName("Гараж - Добавление страховки «КАСКО» с фото страховки")
@Story("Страхование")
@Feature(AutoruFeatures.GARAGE)
@RunWith(Parameterized.class)
@GuiceModules(DesktopDevToolsTestsModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class GarageAddInsurancePhotoKaskoTest {

    private static final String CARD_ID = "/1146321503/";
    private final static String CARD_ADD_INSURANCE_WITH_IMAGE = "request/GarageUserCardAddInsuranceKaskoWithImage.json";
    private final static String CARD_ADD_INSURANCE_WITH_FILE = "request/GarageUserCardAddInsuranceKaskoWithFile.json";
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("Проверяем запрос добавления страховки «КАСКО» с фото страховки")
