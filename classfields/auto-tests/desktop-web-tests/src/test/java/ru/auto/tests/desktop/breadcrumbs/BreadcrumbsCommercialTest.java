...
public class BreadcrumbsCommercialTest {
    ...
    public void shouldClickPopularMark() {
        ...
        urlSteps.testing().path(MOSKVA).path(TRUCK).path(firstMark).path(USED).shouldNotSeeDiff();
    }
    ...
    public void shouldClickPopularModel() {
        ...
        urlSteps.testing().path(MOSKVA).path(TRUCK).path(MARK).path(firstModel).path(USED).shouldNotSeeDiff();
    }
