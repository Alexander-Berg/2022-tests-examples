...
public class DeactivateSaleCarsTest {
    ...
    public void before() {
        ...
        urlSteps.testing().path(CARS).path(USED).path(SALE).path(SALE_ID_HASH).open();
    ...
    public void shouldDeactivateSale() {
        mockRule.with("desktop/UserOffersCarsHide").update();
    ...
    public void shouldDeactivateSaleSoldPrice() {
        mockRule.with("desktop/UserOffersCarsPredictBuyers",
                "desktop/UserOffersCarsHideSoldPrice").update();
    ...
    public void shouldDeactivateSaleManySpamCalls() {
        mockRule.with("desktop/UserOffersCarsHideManySpamCalls").update();
    ...
    public void shouldDeactivateSaleBuyersPhoneFromList() {
        mockRule.with("desktop/UserOffersCarsPredictBuyers",
                "desktop/UserOffersCarsHideBuyerPhone").update();
