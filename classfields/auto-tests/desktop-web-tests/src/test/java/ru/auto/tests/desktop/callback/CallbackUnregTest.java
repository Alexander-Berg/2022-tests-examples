...
public class CallbackUnregTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][]{
                ...
                {CARS, "desktop/OfferCarsNewDealer", "desktop/OfferCarsRegisterCallbackForNewCategory"},
    ...
    public void shouldResendCallbackUnreg() {
        ...
        basePageSteps.onCardPage().callbackPopup().error().waitUntil(hasText("Неверный код"));
