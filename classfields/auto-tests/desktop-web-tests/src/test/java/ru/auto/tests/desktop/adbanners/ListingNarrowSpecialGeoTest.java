...
// https://bunker.yandex-team.ru/auto_ru/common/ad_free_rids?v=7&view=raw
...
public class ListingNarrowSpecialGeoTest {
    ...
    @DisplayName("Баннеры. Не Москва. Узкий экран")
    public void shouldOpenBannerSpecialRegion() {
