...
public class PopularMarksMotoCommerceTest {
    ...
    public void shouldClickPopularMark() {
        String mark = basePageSteps.onListingPage().getPopularMarkOrModel(0).getText();
        basePageSteps.onListingPage().getPopularMarkOrModel(0).click();
        String markModelParam = format("mark=%s", mark.toUpperCase());
