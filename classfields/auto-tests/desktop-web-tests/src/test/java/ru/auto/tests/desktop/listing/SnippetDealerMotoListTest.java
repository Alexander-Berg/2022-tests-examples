...
public class SnippetDealerMotoListTest {
    ...
    @DisplayName("Отображение мото сниппета диллера, тип листинга «Список»")
    ...
    @Owner(DSVICHIHIN)
    @Category({Regression.class, Testing.class})
    @DisplayName("Ссылка на страницу дилера, мото сниппет, тип листинга «Список»")
