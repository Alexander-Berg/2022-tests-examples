...
public class InfiniteListingNewTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SearchCarsBreadcrumbsEmpty",
                "desktop/SearchCarsNewNotGroup",
                "desktop/SearchCarsOfferLocatorCountersTotalCountNew",
                "desktop/SearchCarsNewExcludeGeoRadius200",
                "desktop/SearchCarsNewExcludeGeoRadius300").post();
