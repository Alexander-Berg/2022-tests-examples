...
public class SectionsTest {
    ...
    public void shouldClickSection() {
        urlSteps.testing().path(category).path(startSection).open();
        basePageSteps.onListingPage().filter().radioButton(expectedSectionTitle).should(isDisplayed()).click();
        urlSteps.testing().path(MOSKVA).path(category).path(expectedSection).shouldNotSeeDiff();
