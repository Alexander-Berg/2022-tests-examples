...
public class TopSalesListingTrucksTest {
    ...
    @Before
    public void before() {
        mockRule.newMock().with("desktop/SearchTrucksAll",
                "desktop/SearchTrucksBreadcrumbsEmpty").post();
    ...
    public void shouldClickPopupUrl() {
        ...
        urlSteps.testing().path(MY).path(TRUCKS).addParam("from", "listing")
