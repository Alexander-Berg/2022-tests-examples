...
@DisplayName("Карточка объявления - услуги под незарегом")
@Feature(SALES)
@RunWith(Parameterized.class)
@GuiceModules(DesktopTestsModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class AuthVasTabUnregTest {
    ...
    @DisplayName("Не должны показывать табы vas-ов для незарега")
    public void shouldNotSeeVasTabs() {
