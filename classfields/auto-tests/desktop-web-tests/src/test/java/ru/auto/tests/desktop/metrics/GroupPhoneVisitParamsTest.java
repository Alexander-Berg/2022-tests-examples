...
@DisplayName("Метрики - параметры визитов - телефон на группе новых")
@Feature(METRICS)
@GuiceModules(DesktopDevToolsTestsModule.class)
@RunWith(Parameterized.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class GroupPhoneVisitParamsTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][]{
                {"1", "{\"cars\":{\"card-group\":{\"show-phone\":{\"client\":{\"phonePopup\":{\"new\":{}}}}}}}"},
                ...
                {"4", "revenue\":150},\"products\":[{\"id\":\"kia-optima-1076842087\",\"name\":\"Optima\",\"price\":1837210,\"brand\":\"Kia\",\"category\":\"cars\"}]}}]}}"}
        });
    }
    ...
    public void before() {
        mockRule.setStubs(
                ...
                stub("desktop/SearchCarsBreadcrumbsMarkModelGroup"),
                stub("desktop/SearchCarsGroupContextGroup"),
                stub("desktop/SearchCarsGroupContextListing"),
                stub("desktop/SearchCarsGroupComplectations"),
    ...
    public void shouldSendMetrics() {
        basePageSteps.onGroupPage().getOffer(0).showContactsButton().hover().click();
