...
public class NotesSaleDeleteTest {
    ...
    public static Collection<Object> getParameters() {
        return asList(new Object[][]{
                {CARS, "desktop/OfferCarsUsedUserWithNote", "desktop/UserNotesCarsDelete",
                        "desktop/OfferCarsUsedUser"},
                {TRUCK, "desktop/OfferTrucksUsedUserWithNote", "desktop/UserNotesTrucksDelete",
                        "desktop/OfferTrucksUsedUser"},
                {MOTORCYCLE, "desktop/OfferMotoUsedUserWithNote", "desktop/UserNotesMotoDelete",
    ...
    public void shouldDeleteNotesFromHeaderWithoutLogin() {
        basePageSteps.onCardPage().cardHeader().noteBar().hover();
        basePageSteps.onCardPage().cardHeader().noteBar().deleteButton().should(isDisplayed()).click();
        basePageSteps.onCardPage().cardHeader().noteBar().should(not(isDisplayed()));
