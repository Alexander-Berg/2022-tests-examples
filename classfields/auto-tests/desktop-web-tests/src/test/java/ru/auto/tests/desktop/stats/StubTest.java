...
public class StubTest {
    ...
    @Before
    public void before() {
        mockRule.newMock().with("desktop/StatsSummaryMarkEmpty",
                "desktop/StatsSummaryModelEmpty").post();
    ...
    public void shouldSeeStub() {
        basePageSteps.onStatsPage().stub().should(isDisplayed()).should(hasText(stubText));
        basePageSteps.onStatsPage().button("Перейти в каталог").click();
