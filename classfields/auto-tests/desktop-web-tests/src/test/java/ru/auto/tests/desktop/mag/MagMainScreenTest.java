...
public class MagMainScreenTest {
    ...
    public void shouldSeeBlock() {
        basePageSteps.onMainPage().mag().should(isDisplayed());
        basePageSteps.onMainPage().mag().articlesList().subList(0, 2).forEach(i -> {
            i.should(isDisplayed());
            i.title().should(isDisplayed());
        });
    }
}