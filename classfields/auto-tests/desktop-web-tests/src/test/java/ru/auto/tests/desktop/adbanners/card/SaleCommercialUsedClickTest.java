...
@DisplayName("Баннеры на карточке COMMERCIAL/USED, широкий экран. Клик")
@Epic(BANNERS)
@Feature(SALES)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class SaleCommercialUsedClickTest {
    ...
    public void before() {
        ...
        urlSteps.testing().path(MOSKVA).path(TRUCK).path(USED).addParam("seller_group", "PRIVATE")
