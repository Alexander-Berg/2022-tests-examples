...
public class CreditApplicationPopupTest {
    ...
    private static final String POPUP_TEXT = "Подбор кредита на спецусловиях\nЗаполните заявку, которую сможете " +
            "отправить в несколько банков и узнать решение онлайн.\nСумма кредита\nСрок кредита\n7 лет\nПервый " +
            "взнос\n0 ₽\nПлатеж\n10 150 ₽ / мес.\nКак работает «Авто.ру финанс»?\nФИО\nЭлектронная почта\nНомер " +
            "телефона\nПодтвердить\nСогласен на обработку данных: ООО Яндекс.Вертикали для оформления заявки; АО " +
            "Объединенное кредитное бюро и АО Яндекс Банк для подготовки отчета ООО Яндекс.Вертикали; Банками " +
            "партнерами; в соответствии с условиями обработки данных.";
