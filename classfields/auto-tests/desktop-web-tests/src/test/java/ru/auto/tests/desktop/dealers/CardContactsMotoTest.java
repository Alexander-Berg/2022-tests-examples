...
public class CardContactsMotoTest {
    ...
    public void shouldSeeInfo() {
        basePageSteps.onDealerCardPage().info().should(hasText("МОТОГАРАЖ\nМотоциклы в наличии\n" +
                "Москва и Московская область, Москва, ул. Костякова, д.3, м. станция Дмитровская (МЦД-2), Дмитровская\n" +
                "ежедн. 10:00-22:00\nМотосалон"));
    }
