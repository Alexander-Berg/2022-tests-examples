...
public class SaleCallbackButtonGoalsTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][] {
                {CARS, USED, "desktop/OfferCarsUsedDealer", "CALLBACK_OFFER_BUTTON_CLICK"},
                {CARS, NEW, "desktop/OfferCarsNewDealer", "CALLBACK_OFFER_BUTTON_CLICK"},

                {TRUCK, USED, "desktop/OfferTrucksUsedDealer", "CALLBACK_OFFER_BUTTON_CLICK"},

                {MOTORCYCLE, USED, "desktop/OfferMotoUsedDealer", "CALLBACK_OFFER_BUTTON_CLICK"}
        });
    }
