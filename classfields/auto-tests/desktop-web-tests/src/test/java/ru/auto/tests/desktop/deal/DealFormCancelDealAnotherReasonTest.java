...
public class DealFormCancelDealAnotherReasonTest {
    ...
    @DisplayName("Отменяем сделку c причной Другое")
    public void shouldCancelDealWithAnotherReason() {
        ...
        basePageSteps.onDealPage().popup().selectItem("Выберите причину", "Другое");
        basePageSteps.onDealPage().popup().input("Опишите причину", "test test");
