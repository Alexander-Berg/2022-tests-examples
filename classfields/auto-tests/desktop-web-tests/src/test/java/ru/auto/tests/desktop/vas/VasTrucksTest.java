...
public class VasTrucksTest {
    ...
    public void shouldSeeFresh() {
        ...
        basePageSteps.onCardPage().cardVas().waitUntil(isDisplayed()).should(hasText("Турбо-продажа\n697 ₽\n" +
                "Экспресс-продажа\n397 ₽\nПоднятие в поиске\n297 ₽\nПоднятие в поиске\nx3 просмотров\nСамый недорогой " +
                "способ продвижения, который позволит вам в любой момент оказаться наверху списка объявлений, " +
                "отсортированного по актуальности или по дате. Это поможет быстрее найти покупателя — ведь предложения " +
                "в начале списка просматривают гораздо чаще.\nПоднять за 297 ₽"));
    }
}