...
public class UsedNarrowSpecialRegionTableTest {
    ...
    public void before() {
        ...
        urlSteps.testing().path(CARS).path(USED).addParam(OUTPUT_TYPE, TABLE).open();
    }

    @Test
    @Owner(KURAU)
    @Category({Regression.class})
    @DisplayName("Баннеры. CARS/USED. Не Москва + Табличный вид")
