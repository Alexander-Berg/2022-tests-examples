...
public class DealFormBuyerBankDetailTest {
    ...
    public void shouldSeeBankDetailsForPaymentByBuyer() {
        basePageSteps.onDealPage().section("Средства для оплаты").should(hasText("Средства для оплаты\n" +
                "Шаг 2 из 4.\n Подтверждение стоимости\nУкажите стоимость автомобиля, о которой вы договорились с " +
                "продавцом\nСтоимость автомобиля\n1 000 000 ₽\nКомиссия Авто.ру\n1 ₽\nИтого\n1 000 001 ₽\n" +
                "Редактировать\nПереведите 1 000 001 ₽ на счёт Авто.ру по QR-коду\n1. В приложении вашего банка найдите " +
                "оплату по QR-коду\n2. Наведите камеру на QR-код\n3. Проверьте реквизиты и оплатите\nПереводите деньги " +
                "только со своего счета физического лица.\nИначе они не будут зачислены.\nПоказать реквизиты\nВнесенные " +
                "средства\n0 ₽\nЗачисление средств может занять некоторое время. Как только деньги поступят на " +
                "специальный счет, мы сразу вам об этом сообщим"));
    }
