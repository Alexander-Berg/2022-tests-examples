...
@DisplayName("Неактивное б/у объявление дилера под владельцем")
@Feature(SALES)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class InactiveSaleUsedDealerOwnerCarsTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthDealer",
                "desktop/OfferCarsUsedDealerOwnerInactive",
    ...
    public void shouldSeeSale() {
        basePageSteps.onCardPage().contacts().should(not(isDisplayed()));
