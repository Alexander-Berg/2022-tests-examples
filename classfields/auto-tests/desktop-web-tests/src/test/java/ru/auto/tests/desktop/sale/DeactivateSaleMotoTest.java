...
public class DeactivateSaleMotoTest {
    ...
    public void before() {
        ...
        urlSteps.testing().path(MOTORCYCLE).path(USED).path(SALE).path(SALE_ID_HASH).open();

        mockRule.overwriteStub(1, "desktop/OfferMotoUsedUserOwnerInactive");
    }
    ...
    public void shouldDeactivateSale() {
        mockRule.with("desktop/UserOffersMotoHide").update();
    ...
    public void shouldDeactivateSaleSoldPrice() {
        mockRule.with("desktop/UserOffersMotoHideSoldPrice").update();
    ...
    public void shouldDeactivateSaleManySpamCalls() {
        mockRule.with("desktop/UserOffersMotoHideManySpamCalls").update();
    ...
    public void shouldDeactivateSaleBuyersPhoneFromList() {
        mockRule.with("desktop/UserOffersMotoPredictBayers",
                "desktop/UserOffersMotoHideBuyerPhone").update();
