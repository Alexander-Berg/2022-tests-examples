...
public class ContactsRealPhonesUnregCarsTest {
    ...
    public void before() {
        mockRule.setStubs(
                ...
                stub("desktop/OfferCarsPhonesRedirectFalse")).create();
