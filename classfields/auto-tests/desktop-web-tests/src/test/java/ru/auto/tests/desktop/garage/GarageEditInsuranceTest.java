...
public class GarageEditInsuranceTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthUser",
                ...
                "desktop/GarageUserCardEditInsurance").post();
    ...
    public void shouldEditInsurance() {
        ...
        basePageSteps.onGarageCardPage().popup().input(NUMBER_FIELD, "XXX222");
        ...
        mockRule.overwriteStub(2, "desktop/GarageUserCardKaskoAfterUpdate");
