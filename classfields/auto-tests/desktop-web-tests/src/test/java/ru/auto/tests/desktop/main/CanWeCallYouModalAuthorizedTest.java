...
@Story("С авторизацией")
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopDevToolsTestsModule.class)
public class CanWeCallYouModalAuthorizedTest {
    ...
    private static final String PHONE_USAGE_POPUP_SHOW = "{\"cars\":{\"index\":{\"passport\":{\"phone_usage\":{\"pop-up\":{\"show\":{\"authorized\":{}}}}}}}}";
    private static final String PHONE_USAGE_POPUP_CLOSE = "{\"cars\":{\"index\":{\"passport\":{\"phone_usage\":{\"pop-up\":{\"close\":{\"authorized\":{}}}}}}}}";
    private static final String PHONE_USAGE_POPUP_ACCEPT = "{\"cars\":{\"index\":{\"passport\":{\"phone_usage\":{\"pop-up\":{\"accept\":{\"authorized\":{}}}}}}}}";
    private static final String PHONE_USAGE_POPUP_REJECT = "{\"cars\":{\"index\":{\"passport\":{\"phone_usage\":{\"pop-up\":{\"reject\":{\"authorized\":{}}}}}}}}";
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("Текст попапа «Можем ли мы позвонить?» авторизованным")
    ...
    @Category({Regression.class, Testing.class})
    @Owner(ALEKS_IVANOV)
    @DisplayName("Метрика «phone_usage pop-up show authorized» на показ попапа «Можем ли мы позвонить?»")
    public void shouldSeeCanWeCallYouPopupShowMetric() {
        basePageSteps.onMainPage().canWeCallYouPopup().waitUntil(isDisplayed());
    ...
    @Category({Regression.class, Testing.class})
    @Owner(ALEKS_IVANOV)
    @DisplayName("Метрика «phone_usage pop-up close authorized» на закрытие попапа «Можем ли мы позвонить?»")
    ...
    @Category({Regression.class, Testing.class})
    @Owner(ALEKS_IVANOV)
    @DisplayName("Метрика «phone_usage pop-up accept authorized» на «Согласен» в попапе «Можем ли мы позвонить?»")
    ...
    @Category({Regression.class, Testing.class})
    @Owner(ALEKS_IVANOV)
    @DisplayName("Метрика «phone_usage pop-up reject authorized» на «Нет, спасибо» в попапе «Можем ли мы позвонить?»")
