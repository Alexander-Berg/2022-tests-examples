...
@DisplayName("Метрики - параметры визитов - телефон в слайдере")
@Feature(METRICS)
@GuiceModules(DesktopDevToolsTestsModule.class)
@RunWith(Parameterized.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class SalePhoneSliderVisitParamsTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][]{
                //User
                {"1", CARS, USED, "desktop/OfferCarsUsedUser", "{\"cars\":{\"card\":{\"show-phone\":{\"user\":{\"sidebar\":{}}}}}}"},
                ...
                {"5", MOTORCYCLE, USED, "desktop/OfferMotoUsedUser", "{\"motorcycle\":{\"card\":{\"show-phone\":{\"user\":{\"sidebar\":{}}}}}}"},

                {"6", TRUCK, USED, "desktop/OfferTrucksUsedUser", "{\"truck\":{\"card\":{\"show-phone\":{\"user\":{\"sidebar\":{}}}}}}"},

                //Dealer
                {"7", CARS, USED, "desktop/OfferCarsUsedDealer", "{\"cars\":{\"card\":{\"show-phone\":{\"client\":{\"sidebar\":{\"used\":{}}}}}}}"},
                ...
                {"11", MOTORCYCLE, USED, "desktop/OfferMotoUsedDealer", "{\"motorcycle\":{\"card\":{\"show-phone\":{\"client\":{\"sidebar\":{\"used\":{}}}}}}}"},

                {"12", MOTORCYCLE, NEW, "desktop/OfferMotoNew", "{\"motorcycle\":{\"card\":{\"show-phone\":{\"client\":{\"sidebar\":{\"new\":{}}}}}}}"},

                {"13", TRUCK, USED, "desktop/OfferTrucksUsedDealer", "{\"truck\":{\"card\":{\"show-phone\":{\"client\":{\"sidebar\":{\"used\":{}}}}}}}"},

                {"14", TRUCK, NEW, "desktop/OfferTrucksNew", "{\"truck\":{\"card\":{\"show-phone\":{\"client\":{\"sidebar\":{\"new\":{}}}}}}}"}
        });
    }
    ...
    @DisplayName("Параметры визитов при клике на «Показать телефон» в плавающей панели")
    public void shouldSendSliderVisitParams() {
