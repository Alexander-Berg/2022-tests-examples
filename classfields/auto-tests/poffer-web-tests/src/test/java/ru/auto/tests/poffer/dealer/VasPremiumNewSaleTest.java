...
@DisplayName("Дилер - добавление нового объявления с услугой «Премиум-объявление»")
@Feature(POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopDevToolsTestsModule.class)
public class VasPremiumNewSaleTest {

    private static final String OFFER_TEMPLATE = "offers/cars_new_dealer_premium_offer.json";
