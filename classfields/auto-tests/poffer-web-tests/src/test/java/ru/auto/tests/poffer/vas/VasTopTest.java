...
@DisplayName("Частник - добавление объявления с услугой «Поднятие в ТОП»")
@Feature(BETA_POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasTopTest {
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitTop"),
    ...
    @DisplayName("Добавление объявления с услугой «Поднятие в ТОП»")
    public void shouldAddTopSale() {
        ...
        pofferSteps.onBetaPofferPage().userVas().getSnippet(2).waitUntil(hasText("Опции отдельно\n719 ₽/ день\n" +
                ...
                "На 3 дня\n597 ₽\nСпецпредложение\nНа 3 дня\n879 ₽\nПоднятие в ТОП\nНа 3 дня\n2 157 ₽\n" +
                "Разместить за 2 157 ₽ на 60 дней"));
