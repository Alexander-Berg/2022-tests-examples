...
@DisplayName("Дилер - покупка услуги «Премиум-объявление» при редактировании нового объявления")
@Feature(POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopDevToolsTestsModule.class)
public class VasPremiumNewSaleEditTest {

    private static final String OFFER_ID = "/1076842087-f1e84/";
    private static final String OFFER_TEMPLATE = "offers/cars_new_dealer_premium_edit_offer.json";
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthDealer",
                ...
                "poffer/dealer/UserDraftCarsDraftIdPutNewPremium",
                "poffer/dealer/UserDraftCarsDraftIdPublishNewPremium",
    ...
    @DisplayName("Покупка услуги «Премиум-объявление»")
    public void shouldBuyPremium() {
        pofferSteps.onPofferPage().dealerVas().vas("Премиум-объявление").click();
