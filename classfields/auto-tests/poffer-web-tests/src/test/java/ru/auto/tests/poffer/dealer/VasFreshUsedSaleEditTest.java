...
@DisplayName("Дилер - покупка услуги «Поднятие в поиске» при редактировании б/у объявления")
@Feature(POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopDevToolsTestsModule.class)
public class VasFreshUsedSaleEditTest {

    private static final String OFFER_ID = "/1076842087-f1e84/";
    private static final String OFFER_TEMPLATE = "offers/cars_used_dealer_fresh_edit_offer.json";
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthDealer",
                ...
                "poffer/dealer/UserDraftCarsDraftIdPutUsedFresh",
                "poffer/dealer/UserDraftCarsDraftIdPublishUsedFresh",
