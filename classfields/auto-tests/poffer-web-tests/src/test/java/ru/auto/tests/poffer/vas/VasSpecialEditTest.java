...
@DisplayName("Частник - покупка услуги «Спецпредложение» при редактировании объявления")
@Feature(BETA_POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasSpecialEditTest {

    private static final String OFFER_ID = "1076842087-f1e84";
    private static final String DRAFT_ID = "4848705651719180864-7ac6416a";
    private static final String VAS_TITLE = "Спецпредложение";
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitSpecialEdit"),
    ...
    @DisplayName("Покупка услуги «Спецпредложение» при редактировании объявления")
    public void shouldBuySpecial() {
        ...
        pofferSteps.onBetaPofferPage().userVas().getSnippet(2).waitUntil(hasText("Опции отдельно\n293 ₽/ день\n" +
                ...
                "457 ₽\nВыделение цветом\nНа 3 дня\n597 ₽\nСпецпредложение\nНа 3 дня\n879 ₽\nПоднятие в ТОП\n" +
                "На 3 дня\n2 157 ₽\nСохранить и ускорить за 879 ₽\nНа 3 дня"));
        pofferSteps.onBetaPofferPage().vasBlock().free().submitButton()
                .waitUntil(hasText("Сохранить и ускорить за 879 ₽\nНа 3 дня"));
        ...
        pofferSteps.onBetaPofferPage().billingPopup().priceHeader().waitUntil(hasText("697 ₽"));
