...
@DisplayName("Дилер - покупка услуги «Премиум-объявление» при редактировании б/у объявления")
@Feature(POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopDevToolsTestsModule.class)
public class VasPremiumUsedSaleEditTest {

    private static final String OFFER_ID = "/1076842087-f1e84/";
    private static final String OFFER_TEMPLATE = "offers/cars_used_dealer_premium_edit_offer.json";
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthDealer",
                ...
                "poffer/dealer/UserDraftCarsDraftIdPutUsedPremium",
                "poffer/dealer/UserDraftCarsDraftIdPublishUsedPremium",
