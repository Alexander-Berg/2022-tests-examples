...
@DisplayName("Дилер - покупка услуги «Турбо-продажа» при редактировании б/у объявления")
@Feature(POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopDevToolsTestsModule.class)
public class VasTurboUsedSaleEditTest {

    private static final String OFFER_ID = "/1076842087-f1e84/";
    private static final String OFFER_TEMPLATE = "offers/cars_used_dealer_turbo_edit_offer.json";
