...
@DisplayName("Частник - добавление объявления с услугой «Выделение цветом»")
@Feature(BETA_POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasColorTest {
    ...
    public void before() throws IOException {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitColor"),
    ...
    @DisplayName("Добавление объявления с услугой «Выделение цветом»")
    public void shouldAddColorSale() {
        ...
        pofferSteps.onBetaPofferPage().billingPopup().header().waitUntil(hasText("Выделение цветом"));
