...
@DisplayName("Дилер - добавление б/у объявления со скидками")
@Feature(POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopDevToolsTestsModule.class)
public class AddUsedSaleDiscountsTest {

    private static final String OFFER_ID = "/1076842087-f1e84/";
    private static final String OFFER_TEMPLATE = "offers/cars_used_dealer_discounts_offer.json";
    ...
    public void shouldSeePriceTooltip() {
        ...
        pofferSteps.onPofferPage().popup().waitUntil(isDisplayed()).should(hasText("Конечная цена продажи. Чтобы передать дополнительные скидки, используйте поля ниже."));
    }
}
