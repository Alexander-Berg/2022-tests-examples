...
@DisplayName("Частник - покупка пакета услуг «Турбо-продажа» при редактировании объявления")
@Feature(BETA_POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasTurboEditTest {
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitTurboEdit"),
    ...
    @DisplayName("Покупка пакета услуг «Турбо-продажа» при редактировании объявления")
    public void shouldBuyTurbo() {
        pofferSteps.onBetaPofferPage().userVas().getSnippet(1).waitUntil(hasText("Турбо-продажа\n859 ₽/ день\n" +
                "Чёткий 3-х дневный блиц: яркая цена, вы в топе поиска и почти на каждой странице, даже " +
                "главной.\nВыделение цветом\nСпецпредложение\nПоднятие в ТОП\n×3\nбыстрее\nпродажа\n" +
                "Сохранить и ускорить за 2 577 ₽\nНа 3 дня, вместо 4 295 ₽\n-40%"));
        ...
        pofferSteps.onBetaPofferPage().billingPopup().priceHeader().waitUntil(hasText("547 ₽"));
