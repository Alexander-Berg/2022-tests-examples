...
@DisplayName("Частник - добавление объявления с услугой «Спецпредложение»")
@Feature(BETA_POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasSpecialTest {
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitSpecial"),
    ...
    @DisplayName("Добавление объявления с услугой «Спецпредложение»")
    public void shouldAddSpecialSale() {
