...
@DisplayName("Частник - добавление объявления со всеми услугами")
@Feature(BETA_POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasAllTest {
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitAll"),
    ...
    @DisplayName("Частник - добавление объявления со всеми услугами")
    public void shouldAddSaleWithAllServices() {
        ...
        pofferSteps.onBetaPofferPage().userVas().getSnippet(2).waitUntil(hasText("Опции отдельно\n2 379 ₽/ день\n" +
                ...
                "На 3 дня\n597 ₽\nСпецпредложение\nНа 3 дня\n879 ₽\nПоднятие в ТОП\nНа 3 дня\n2 157 ₽\n" +
                "Стикеры быстрой продажи\nНа 60 дней\n1 ₽\nРазместить за 7 139 ₽ на 60 дней"));
        pofferSteps.onBetaPofferPage().vasBlock().free().submitButton()
                .waitUntil(hasText("Разместить за 7 139 ₽ на 60 дней"));
        ...
        pofferSteps.onBetaPofferPage().billingPopup().priceHeader().waitUntil(hasText("2 827 ₽"));
