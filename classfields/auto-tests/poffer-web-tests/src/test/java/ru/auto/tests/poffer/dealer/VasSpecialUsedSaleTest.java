...
@DisplayName("Дилер - добавление б/у объявления с услугой «Спецпредложение»")
@Feature(POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopDevToolsTestsModule.class)
public class VasSpecialUsedSaleTest {

    private static final String OFFER_ID = "/1076842087-f1e84/";
    private static final String OFFER_TEMPLATE = "offers/cars_used_dealer_special_offer.json";
