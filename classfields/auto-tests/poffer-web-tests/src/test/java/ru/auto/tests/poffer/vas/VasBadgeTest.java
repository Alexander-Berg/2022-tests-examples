...
@DisplayName("Частник - добавление объявления с бейджем")
@Feature(BETA_POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasBadgeTest {
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitBadge"),
    ...
    public void shouldAddSaleWithBadge() {
        ...
        pofferSteps.onBetaPofferPage().billingPopup().header().waitUntil(hasText("Стикеры быстрой продажи"));
        pofferSteps.onBetaPofferPage().billingPopup().priceHeader().waitUntil(hasText("99 ₽"));
