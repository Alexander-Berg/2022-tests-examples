...
@DisplayName("Частник - добавление объявления с пакетом услуг «Турбо-продажа»")
@Feature(BETA_POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasTurboTest {
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitTurbo"),
    ...
    public void shouldAddTurboSale() {
