...
@DisplayName("Частник - добавление объявления с пакетом услуг «Экспресс-продажа» со скидкой")
@Feature(BETA_POFFER)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasExpressDiscountsTest {
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitExpressDiscounts"),
    ...
    public void shouldAddSale() {
        ...
        pofferSteps.onBetaPofferPage().billingPopup().priceHeader().waitUntil(hasText("1 297 ₽2 161 ₽"));
