...
@DisplayName("Частник - покупка пакета «Экспресс-продажа» на лендинге VAS")
@Feature(POFFER_VAS_LANDING)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class VasLandingExpressTest {

    private static final String OFFER_ID = "/1076842087-f1e84/";
    private static final String VAS_TITLE = "Экспресс-продажа";
    private static final String VAS_PRICE = "1 297 ₽";
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("poffer/BillingAutoruPaymentInitExpressLanding"),
    ...
    @DisplayName("Покупка пакета «Экспресс-продажа»")
    public void shouldBuy() {
        pofferSteps.onPofferPage().vasLanding().pack("Экспресс").click();
