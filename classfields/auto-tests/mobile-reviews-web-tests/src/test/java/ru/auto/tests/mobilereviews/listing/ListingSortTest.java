...
import static ru.auto.tests.desktop.mobile.page.mobilereviews.ReviewsListingPage.SortBy.COMMENTS;
import static ru.auto.tests.desktop.mobile.page.mobilereviews.ReviewsListingPage.SortBy.DATE;
import static ru.auto.tests.desktop.mobile.page.mobilereviews.ReviewsListingPage.SortBy.LIKE;
import static ru.auto.tests.desktop.mobile.page.mobilereviews.ReviewsListingPage.SortBy.RATING_ASC;
import static ru.auto.tests.desktop.mobile.page.mobilereviews.ReviewsListingPage.SortBy.RATING_DESC;
...
public class ListingSortTest {
    ...
    public void shouldSort() {
        ...
        basePageSteps.onListingPage().sortBar().sortTab(sortBy.getName()).click();
        urlSteps.addParam("sort", sortBy.getAlias()).shouldNotSeeDiff();
