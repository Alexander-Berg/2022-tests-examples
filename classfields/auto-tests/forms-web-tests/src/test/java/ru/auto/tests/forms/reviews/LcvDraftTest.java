...
@DisplayName("Отзывы, лёгкие коммерческие - добавление отзыва - черновик")
@Feature(FORMS)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class LcvDraftTest {
    ...
    public void before() throws IOException {
        formsSteps.createReviewsLcvForm();
        urlSteps.testing().path(TRUCKS).path(REVIEWS).path(ADD).open();
