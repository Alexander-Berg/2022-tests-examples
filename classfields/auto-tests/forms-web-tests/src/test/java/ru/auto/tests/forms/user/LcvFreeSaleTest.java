...
@DisplayName("Частник, лёгкие коммерческие - добавление бесплатного объявления")
@Feature(FORMS)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class LcvFreeSaleTest {

    private static final String OFFER_TEMPLATE = "offers/lcvOffer.json";
