...
@DisplayName("Частник, мотоциклы - добавление объявления битого ТС")
@Feature(FORMS)
@RunWith(GuiceTestRunner.class)
@GuiceModules(DesktopTestsModule.class)
public class MotorcyclesBeatenSaleTest {
    ...
    public void before() throws IOException {
        ...
        formsSteps.getBeaten().setValue("on");
        formsSteps.getCustoms().setValue("on");
    ...
    @DisplayName("Добавление объявления битого и нерастаможенного ТС")
    public void shouldAddBeatenSale() throws IOException {
        ...
        createOfferSteps.setOfferTemplate("offers/motoBeatenOffer.json");
