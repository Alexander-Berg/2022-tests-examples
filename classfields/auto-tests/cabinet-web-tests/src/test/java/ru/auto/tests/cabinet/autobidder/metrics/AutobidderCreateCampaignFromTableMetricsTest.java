...
public class AutobidderCreateCampaignFromTableMetricsTest {
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub().withPostDeepEquals(DEALER_AUCTION_CARS_USED_LISTING_PROMO_CAMPAIGN)
                        .withResponseBody(
                                mockPromoCampaigns(getBaseCampaign()).getBody()),
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("«create_campaign» при создании кампании из таблицы кампаний")
    public void shouldSeeCreateCampaignMetric() {
