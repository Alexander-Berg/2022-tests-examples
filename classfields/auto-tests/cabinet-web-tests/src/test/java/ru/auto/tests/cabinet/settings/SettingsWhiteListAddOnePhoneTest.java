...
public class SettingsWhiteListAddOnePhoneTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthDealer",
                ...
                "cabinet/DealerPhonesWhitelistAddOnePhone").post();
    ...
    @Owner(TIMONDL)
    @DisplayName("Добавляем один телефон")
    public void shouldAddOnePhone() {
        ...
        steps.onSettingsWhiteListPage().notifier().should(isDisplayed()).should(hasText("1 номер добавлен"));
