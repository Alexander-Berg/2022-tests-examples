...
public class SettingsChatsManagerTest {
    ...
    public void before() {
        mockRule.setStubs(
                stub("desktop/SessionAuthManager"),
                stub("cabinet/ApiAccessClientManager"),
                stub("cabinet/CommonCustomerGetManager"),
                stub("cabinet/CrmClientsGet"),
                stub("cabinet/ChatAggregatorNotFound"),
        ...
        urlSteps.subdomain(SUBDOMAIN_CABINET).path(SETTINGS).path(CHATS).addParam(CLIENT_ID, "16453").open();
    }
    ...
    public void shouldEnableAndDisableChats() {
        ...
        steps.onSettingsChatsPage().notifier().waitUntil("", isDisplayed(), 20).should(hasText("Данные сохранены"));
