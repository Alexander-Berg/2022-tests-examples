...
public class BannedOffersWithOneReasonsTest {
    ...
    public void before() {
        mockRule.setStubs(
                ...
                stub("cabinet/UserOffersCarsBannedWithOneReason"),
                stub("cabinet/UserOffersTrucksBannedWithOneReason"),
                stub("cabinet/UserOffersMotoBannedWithOneReason")
        ).create();
    ...
    public void shouldSeeBanReason() {
        steps.onCabinetOffersPage().snippet(0).banPlaceholder()
                .should(hasText("Объявление заблокировано: \nошибка в модели"));
    }
