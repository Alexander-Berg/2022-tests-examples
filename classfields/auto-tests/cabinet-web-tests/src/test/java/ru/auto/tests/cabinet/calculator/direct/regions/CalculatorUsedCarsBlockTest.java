...
public class CalculatorUsedCarsBlockTest {
    ...
    @Owner(JENKL)
    @DisplayName("Подключение тарифа")
    public void shouldSeeEnabledTariff() {
        ...
        steps.onNewCalculatorPage().usedCarsBlock().button("Подключить тариф").should(not(isDisplayed()));
