...
@DisplayName("Удаление телефона из «Информация о салоне»")
@GuiceModules(CabinetTestsModule.class)
@RunWith(GuiceTestRunner.class)
public class CardDeletePhoneTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthDealer",
                ...
                "cabinet/ClientsGet",
                "cabinet/DesktopSalonInfoGetPhone",
                "cabinet/DesktopSalonInfoUpdateDeletePhone").post();
    ...
    public void shouldDeleteNumber() {
        steps.onCabinetSalonCardPage().getPhone(1).deleteButton().click();
