...
import ru.auto.tests.desktop.rule.MobileEmulationWebDriverResource;
import ru.auto.tests.desktop.rule.MockRule;
import ru.auto.tests.desktop.rule.SetCookiesRule;
import ru.auto.tests.publicapi.module.PublicApiModule;
import ru.auto.tests.vos2.module.VosModule;

public class MobileEmulationTestsModule extends AbstractModule {

    @Override
    protected void configure() {
        Multibinder<TestRule> rulesBinder = Multibinder.newSetBinder(binder(), TestRule.class);
        rulesBinder.addBinding().to(MobileEmulationWebDriverResource.class);
