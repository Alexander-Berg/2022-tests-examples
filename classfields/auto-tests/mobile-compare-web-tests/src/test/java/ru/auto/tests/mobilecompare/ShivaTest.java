...
public class ShivaTest {
    ...
    public void shouldSeeDifferentPackages() {
        ...
        assertThat(testingPackage, startsWith("af-mobile-compare="));
        assertThat(prodPackage, startsWith("af-mobile-compare="));
    ...
    public void shouldSeeSamePackages() {
        ...
        urlSteps.autoruProdURI().path(COMPARE_CARS).path("hyundai-sonata-vs-kia-rio/").open();
