...
public class ActivateSaleTrucksTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthUser",
                ...
                "desktop-lk/UserOffersTrucksActivate",
                "desktop-lk/reseller/UserOffersTrucksId",
                "desktop-lk/UserOffersTrucksStats").post();
    ...
    public void shouldClickActivateButton() {
        ...
        basePageSteps.onLkResellerSalesPage().getSale(0).datesColumn().createDate()
                .should(hasText(matchesRegex("Размещено 20 июня 2019 \\(\\d (год|года|лет)\\)")));
    }
}