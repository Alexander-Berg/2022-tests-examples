...
public class FavoritesPopupTrucksTest {
    ...
    public void before() {
        mockRule.setStubs(
                stub().withGetDeepEquals(USER_OFFERS_TRUCKS_COUNT).withRequestQuery(Query.query().setCategory("trucks"))
    ...
    public void shouldSeeCallsStats() {
        mockRule.setStubs(stub("desktop/OfferTrucksCallsStats")).update();
