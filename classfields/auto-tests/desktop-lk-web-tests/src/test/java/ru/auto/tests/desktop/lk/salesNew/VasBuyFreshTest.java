...
public class VasBuyFreshTest {
    ...
    public void shouldBuyVas() {
        basePageSteps.onLkSalesNewPage().getSale(0).vasItem("Поднятие в поиске").click();
        ...
        basePageSteps.onLkSalesNewPage().billingPopup().header().waitUntil(hasText("Поднятие в поиске"));
        ...
        basePageSteps.onLkSalesNewPage().getSale(0).getVas(4)
