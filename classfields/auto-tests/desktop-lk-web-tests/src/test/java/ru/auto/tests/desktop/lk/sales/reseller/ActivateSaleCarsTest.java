...
public class ActivateSaleCarsTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthReseller",
                ...
                "desktop-lk/UserOffersCarsActivate",
                "desktop-lk/reseller/UserOffersCarsId",
                "desktop-lk/UserOffersCarsStats").post();
    ...
    public void shouldClickActivateButton() {
        ...
        basePageSteps.onLkResellerSalesPage().getSale(0).datesColumn().createDate()
                .should(hasText("Размещено 21 декабря 2018 (4 года)"));
    }
}
