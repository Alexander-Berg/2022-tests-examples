...
public class BannedSalesEditButtonTest {
    ...
    public void shouldNotSeeEditButton() {
        ...
        basePageSteps.onLkSalesNewPage().getSale(0).editButton().should(not(exists()));
    }
    ...
    public void shouldClickEditButton() {
        basePageSteps.onLkSalesNewPage().getSale(1).hover();
        basePageSteps.onLkSalesNewPage().getSale(1).editButton().waitUntil(isDisplayed()).click();
