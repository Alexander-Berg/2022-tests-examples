...
public class ActivateOfferTest {
    ...
    public static Collection<Object[]> getData() {
        return asList(new Object[][]{
                {"desktop-lk/UserOffersCarsInactive", "desktop-lk/UserOffersCarsActivate",
                        "desktop-lk/UserOffersCarsId", CARS, "desktop-lk/UserOffersCarsActive"},
                {"desktop-lk/UserOffersMotoInactive", "desktop-lk/UserOffersMotoActivate",
                        "desktop-lk/UserOffersMotoId", MOTO, "desktop-lk/UserOffersMotoActive"},
    ...
    public void shouldClickActivateButton() {
        ...
        basePageSteps.onLkSalesNewPage().getSale(0).activateButton().click();
