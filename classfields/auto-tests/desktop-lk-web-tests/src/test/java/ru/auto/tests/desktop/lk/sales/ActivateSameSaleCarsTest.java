...
public class ActivateSameSaleCarsTest {
    ...
    public void shouldActivate() {
        ...
        basePageSteps.onLkSalesPage().popup().waitUntil(hasText("Повторное размещение\n" +
                ...
                "Разместить за 1 199 ₽\nLifan Solano\n2020 г, 500 км\nСедан, белый\n1.5 MT (100 л.с.)\nбензин, " +
                "передний\nМосква\n, 3 июня 2020\n500 000 ₽"));
        basePageSteps.onLkSalesPage().popup().button("Разместить за 1\u00a0199\u00a0₽").click();
        ...
        basePageSteps.onLkSalesPage().billingPopup().priceHeader().waitUntil(hasText("1 199 ₽"));
