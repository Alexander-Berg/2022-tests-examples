...
public class VasAutoprolongActiveOptionTest {
    ...
    public void shouldProlongActiveOption() {
        basePageSteps.onLkSalesNewPage().getSale(0).getVas(3).hover();
        ...
        basePageSteps.onLkSalesNewPage().getSale(0).getVas(3)
                .should(hasText(matchesPattern("×15 просмотров\nАктивно ещё\\d+ (час|часа|часов)")));
    }
