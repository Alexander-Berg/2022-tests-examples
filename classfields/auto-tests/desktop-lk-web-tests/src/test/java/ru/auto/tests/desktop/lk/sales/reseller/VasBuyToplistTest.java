...
public class VasBuyToplistTest {
    ...
    public void before() {
        ...
        mockRule.newMock().with("desktop/SessionAuthUser",
                ...
                salesMock,
                offerIdMock,
                "desktop-lk/reseller/BillingAutoruPaymentInitToplist",
    ...
    public void shouldBuyVas() {
        basePageSteps.onLkResellerSalesPage().getSale(0).vas("Поднятие в ТОП").should(isDisplayed()).click();
        ...
        basePageSteps.onLkResellerSalesPage().billingPopup().header().waitUntil(hasText("Поднятие в ТОП"));
        basePageSteps.onLkResellerSalesPage().billingPopup().priceHeader().waitUntil(hasText("1 617 \u20BD"));
        ...
        basePageSteps.onLkResellerSalesPage().getSale(0).vas("Поднятие в ТОП")
                .should(hasText("×15 просмотров\nПоднятие в ТОП • 3 дня\nВключено"));
    }
}
