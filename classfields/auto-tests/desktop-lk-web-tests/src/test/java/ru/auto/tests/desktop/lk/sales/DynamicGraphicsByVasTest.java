...
public class DynamicGraphicsByVasTest {
    ...
    @Owner(DENISKOROBOV)
    @DisplayName("Изменение графиков по ховеру на пакеты")
    public void shouldChangeGraphicsByVas() {
        basePageSteps.onLkSalesPage().getSale(0).vas().getTab(vasIndex).should(isDisplayed()).hover();
