...
public class VasBuyFreshTest {
    ...
    public void before() {
        ...
        mockRule.setStubs(
                ...
                stub("desktop/User"),
                stub("desktop-lk/BillingAutoruPaymentInitFresh"),
    ...
    public void shouldBuyVas() {
        ...
        basePageSteps.onLkSalesPage().billingPopup().header().waitUntil(hasText("Поднятие в поиске"));
        ...
        basePageSteps.onLkSalesPage().notifier().waitUntil(isDisplayed())
                .waitUntil(hasText("Опция «Поднятие в поиске» подключена"));
