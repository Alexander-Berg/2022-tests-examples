...
import static ru.auto.tests.desktop.page.lk.LkCreditsPage.SEND_REQUEST;
...
public class CreditEditRequestTest {
    ...
    public void shouldFillCreditApplication() {
        ...
        basePageSteps.onLkCreditsPage().creditsForm().button(SEND_REQUEST).waitUntil(isDisplayed()).click();
