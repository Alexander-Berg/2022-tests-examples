...
public class ShivaTest {
    ...
    public void shouldSeeDifferentPackages() {
        ...
        assertThat(testingPackage, startsWith("af-desktop-compare="));
        assertThat(prodPackage, startsWith("af-desktop-compare="));
    ...
    public void shouldSeeSamePackages() {
        ...
        urlSteps.autoruProdURI().path(COMPARE_OFFERS).open();
