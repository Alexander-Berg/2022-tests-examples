...
public class VasSaleTurboAutoprolongOnOffTrucksTest {
    ...
    @Before
    public void before() {
        mockRule.newMock().with("desktop/OfferTrucksUsedUserOwnerWithServices",
                "desktop/SessionAuthUser",
                "desktop/UserWithTiedCard",
                "desktop/UserOffersTrucksProductPackageTurboProlongablePut",
                "desktop/UserOffersTrucksProductPackageTurboProlongableDelete").post();
