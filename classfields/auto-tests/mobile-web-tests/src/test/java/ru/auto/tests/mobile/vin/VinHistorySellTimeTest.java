...
import static ru.auto.tests.desktop.mobile.element.history.VinReport.BLOCK_SELL_TIME;
...
public class VinHistorySellTimeTest {
    ...
    public void shouldSeeSellTimeInContents() {
        basePageSteps.onHistoryPage().vinReport().contentsBlock().block(AVERAGE_SELL_TIME).value().should(hasText(
