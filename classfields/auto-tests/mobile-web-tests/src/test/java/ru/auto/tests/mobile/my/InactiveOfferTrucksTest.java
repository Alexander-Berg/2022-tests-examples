...
@DisplayName("ЛК - неактивное объявление комТС")
@Epic(LK)
@Feature(SALES)
@Story("Неактивное объявление")
@RunWith(GuiceTestRunner.class)
@GuiceModules(MobileEmulationTestsModule.class)
public class InactiveOfferTrucksTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthUser",
                "desktop/User",
                "desktop/UserOffersTrucksInactive").post();
    ...
    public void shouldSeeSale() {
        basePageSteps.onLkPage().getSale(0).should(hasText("Ford Transit\n750 000 ₽\nСнято с продажи\nАктивировать\n" +
                "Редактировать\nУдалить"));
    }
    ...
    public void shouldClickSale() {
        mockRule.with("desktop/OfferTrucksUsedUserInactive").update();
