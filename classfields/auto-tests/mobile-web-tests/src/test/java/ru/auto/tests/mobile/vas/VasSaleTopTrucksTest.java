...
public class VasSaleTopTrucksTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/OfferTrucksUsedUserOwner",
                ...
                "mobile/BillingAutoruPaymentInitTop",
    ...
    public void shouldBuyVas() {
        basePageSteps.scrollAndClick(basePageSteps.onCardPage().vas().service("Поднятие в ТОП").buyButton());
        buyVas();
    }
    ...
    public void shouldBuyVasInPopup() {
        basePageSteps.openVasPopup("Поднятие в ТОП");
        buyVas();
    }
