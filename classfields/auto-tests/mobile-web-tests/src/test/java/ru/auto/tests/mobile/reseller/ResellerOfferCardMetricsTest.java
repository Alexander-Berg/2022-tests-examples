...
public class ResellerOfferCardMetricsTest {
    ...
    public void shouldSeeLinkShowMetricOfferCard() {
        ...
        urlSteps.open();
        basePageSteps.onCardPage().contacts().offersCount().hover();
    ...
    public void shouldSeeChatOpenMetricOfferCardFromPublicProfile() {
        ...
        basePageSteps.onCardPage().floatingContacts().sendMessageButton().waitUntil(isDisplayed()).click();
