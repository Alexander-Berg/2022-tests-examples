...
@DisplayName("Покупка VAS на карточке через ЮMoney")
@Feature(VAS)
@RunWith(GuiceTestRunner.class)
@GuiceModules(MobileEmulationTestsModule.class)
public class VasSaleFreshCarsYaMoneyTest {
    ...
    public void shouldSeeCorrectUrl() {
        ...
        urlSteps.shouldUrl(startsWith("https://money.yandex.ru/payments/internal/"));
    }
