...
public class RecommendedTest {
    ...
    public void before() {
        ...
        basePageSteps.onListingPage().salesList().should(hasSize(15));
    }
    ...
    public void shouldClosePreset() {
        ...
        basePageSteps.onListingPage().filters().button("Рекомендованные").click();
        basePageSteps.onListingPage().filters().button("Рекомендованные").waitUntil(not(isDisplayed()));
