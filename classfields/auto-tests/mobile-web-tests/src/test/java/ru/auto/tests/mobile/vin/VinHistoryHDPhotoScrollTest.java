...
import static ru.auto.tests.desktop.mobile.element.history.ReportContent.HD_PHOTO;
import static ru.auto.tests.desktop.mobile.element.history.VinReport.BLOCK_AUTORU_OFFERS;
import static ru.auto.tests.desktop.mobile.element.history.VinReport.BLOCK_VEHICLE_PHOTOS;
...
public class VinHistoryHDPhotoScrollTest {
    ...
    public void shouldSeeWithVehiclePhotosWithoutOffers() {
        ...
        basePageSteps.onHistoryPage().vinReport().contentsBlock().block(HD_PHOTO).waitUntil(hasText(matchesRegex(
                format(HD_PHOTO_TEMPLATE, firstRecordPhotoCount + secondRecordPhotoCount)))).hover().click();
    ...
    public void shouldSeeNoHDWithoutHDVehiclePhotosWithoutOffers() {
        ...
        basePageSteps.onHistoryPage().vinReport().contentsBlock().block(HD_PHOTO).should(not(isDisplayed()));
    }
