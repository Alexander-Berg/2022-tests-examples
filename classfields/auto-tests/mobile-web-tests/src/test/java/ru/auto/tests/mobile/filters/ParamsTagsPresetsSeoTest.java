...
public class ParamsTagsPresetsSeoTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][]{
                {CARS, ALL, "Компактный", "compact"},

                {CARS, NEW, "Компактный", "compact"},

                {CARS, USED, "Компактный", "compact"}
        });
    }
    ...
    public void shouldClickTag() {
        ...
        urlSteps.path(TAG).path(paramValue).path("/").shouldNotSeeDiff();
