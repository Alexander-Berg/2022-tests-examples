...
public class CallbackRegWithSeveralPhonesCarsTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthUser",
                ...
                "desktop/UserWithSeveralPhones").post();
    ...
    public void shouldSendDealerCallbackRegWithSeveralPhones() {
        ...
        basePageSteps.onCardPage().callbackPopup().clearInputButton().hover().click();
        basePageSteps.onCardPage().callbackPopup().clearInput("Номер телефона");
