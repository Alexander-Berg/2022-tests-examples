...
public class GarageAllPromoMetricsTest {
    ...
    public void shouldSeeShowPromoPopupMetric() {
        ...
        seleniumMockSteps.assertWithWaiting(onlyOneMetricsRequest(hasSiteInfo(
                "{\"garage\":{\"promo_all\":{\"yandex_market\":{\"popup\":{\"show\":{}}}}}}"
        )));
    }
    ...
    public void shouldSeeShowPromoPopupButtonClickMetric() {
        ...
        seleniumMockSteps.assertWithWaiting(onlyOneMetricsRequest(hasSiteInfo(
                "{\"garage\":{\"promo_all\":{\"yandex_market\":{\"popup\":{\"button_click\":{}}}}}}"
        )));
    }
    ...
    public void shouldSeeDetailsPromoPopupMetric() {
        ...
        seleniumMockSteps.assertWithWaiting(onlyOneMetricsRequest(hasSiteInfo(
                "{\"garage\":{\"promo_all\":{\"ramk_xs\":{\"popup\":{\"details_click\":{}}}}}}"
        )));
    }
    ...
    public void shouldSeeCopyPromoPopupMetric() {
        ...
        seleniumMockSteps.assertWithWaiting(onlyOneMetricsRequest(hasSiteInfo(
                "{\"garage\":{\"promo_all\":{\"ramk_xs\":{\"popup\":{\"copy_click\":{}}}}}}"
        )));
    }
    ...
    public void shouldSeePromoOpenUserAuthMetric() {
        seleniumMockSteps.assertWithWaiting(onlyOneMetricsRequest(hasSiteInfo(
                "{\"garage\":{\"promo_all\":{\"open\":{\"user\":{\"auth\":{}}}}}}"
        )));
    }
    ...
    public void shouldSeeSourceCurrentCarMetric() {
        ...
        seleniumMockSteps.assertWithWaiting(onlyOneMetricsRequest(hasSiteInfo(
                format(GARAGE_SOURCE_TEMPLATE, CURRENT_CAR.toLowerCase())
        )));
    }
    ...
    public void shouldSeeSourceDreamCarMetric() {
        ...
        seleniumMockSteps.assertWithWaiting(onlyOneMetricsRequest(hasSiteInfo(
                format(GARAGE_SOURCE_TEMPLATE, DREAM_CAR.toLowerCase())
        )));
    }
    ...
    public void shouldSeeSourceOrganicMetric() {
        seleniumMockSteps.assertWithWaiting(onlyOneMetricsRequest(hasSiteInfo(
                format(GARAGE_SOURCE_TEMPLATE, ORGANIC)
        )));
    }
