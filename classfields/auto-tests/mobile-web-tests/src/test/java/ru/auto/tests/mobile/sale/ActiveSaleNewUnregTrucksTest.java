...
@DisplayName("Активное новое объявление под незарегом")
@Feature(SALES)
@RunWith(GuiceTestRunner.class)
@GuiceModules(MobileEmulationTestsModule.class)
public class ActiveSaleNewUnregTrucksTest {
    ...
    @Before
    public void before() {
        mockRule.newMock().with("desktop/OfferTrucksNew",
    ...
    public void shouldSeePrice() {
        ...
        basePageSteps.onCardPage().popup().waitUntil(isDisplayed()).should(hasText("Цена с НДС\nот 2 710 000 ₽\n" +
                "Продавец указал, что предоставит счёт-фактуру на основании которой покупатель-юрлицо может заявить " +
                "НДС к вычету.\nЦена без скидки\n2 750 000 ₽\n · \n37 176 $\n · \n34 349 €\nСкидки\nВ кредит\nдо " +
                "30 000 ₽\nС каско\nдо 20 000 ₽\nВ лизинг\nдо 50 000 ₽\nВ трейд-ин\nдо 10 000 ₽\nМаксимальная\n40 " +
    ...
    public void shouldSeeSellerComment() {
        basePageSteps.onCardPage().sellerComment().should(hasText("Комментарий продавца\nHYUNDAI HD78 (Евро-5). " +
                ...
                "Антикоррозионная обработка в подарок!\nНадстройка: Фургон изотермический С/П 50 мм " +
                "(возможно установка ХОУ)., габаритные размеры 4,4х2,2х2,2 м., плакированный металл, " +
                "пол - транспортная ламинированная сетчатая фанера, фурнитура оцинкованная. До 8 европаллет !!!\n" +
                "Комплектация: система курсовой устойчивости (VDC), антиблокировочная система (ABS), " +
                "электростеклоподъемники, обогрев зеркал заднего вида, передние регулируемые противотуманные фары " +
                "с линзой, магнитола AM/FM, AUX\nПоказать полностью"));
    }
    ...
    public void shouldSeePhones() {
        mockRule.with("desktop/OfferMotoPhones",
