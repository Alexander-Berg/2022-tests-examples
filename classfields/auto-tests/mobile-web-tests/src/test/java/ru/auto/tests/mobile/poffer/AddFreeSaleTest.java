...
@DisplayName("Добавление бесплатного объявления с минимальным кол-вом полей")
@Epic(BETA_POFFER)
@Feature(ADD_OFFER)
...
public class AddFreeSaleTest {
    ...
    private static final String OFFER_TEMPLATE = "offers/beta_cars_user_used_offer.json";
    ...
    public void shouldAddFreeSale() {
        ...
        String offerTitle =
                format("%s %s %s, %s", offer.getMark(), offer.getModel(), offer.getGeneration(), offer.getYear());
