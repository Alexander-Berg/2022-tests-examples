...
public class CatalogMarkBannersTest {
    ...
    @DisplayName("Клик по баннеру С2 на странице марки в каталоге")
    public void shouldClickBannerMarkC2() {
        urlSteps.testing().path(CATALOG).path(CARS).path("bmw").open();
