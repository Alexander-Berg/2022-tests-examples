...
@DisplayName("Личный кабинет. Покупка услуг продвижения")
@Feature(VAS)
@RunWith(GuiceTestRunner.class)
@GuiceModules(MobileEmulationTestsModule.class)
public class VasLkTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/User",
                ...
                "mobile/BillingAutoruPaymentInitTurboLk",
    ...
    public void shouldBuyVas() {
        ...
        basePageSteps.onLkPage().notifier().waitUntil("Не появилась плашка «Опция успешно активирована»",
                hasText("Опция успешно активирована"), 15);
