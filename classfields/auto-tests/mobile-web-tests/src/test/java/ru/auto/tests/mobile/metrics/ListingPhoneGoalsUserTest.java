...
public class ListingPhoneGoalsUserTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][] {
                {CARS, ALL, "mobile/SearchCarsAllPrivate", "desktop/SearchCarsBreadcrumbsEmpty",
                        "CONTACT_CARS"},
                {CARS, ALL, "mobile/SearchCarsAllPrivate", "desktop/SearchCarsBreadcrumbsEmpty",
                        "CONTACT_CARS_MOBILE"},
                {CARS, ALL, "mobile/SearchCarsAllPrivate", "desktop/SearchCarsBreadcrumbsEmpty",
                ...
                {CARS, ALL, "mobile/SearchCarsAllPrivate", "desktop/SearchCarsBreadcrumbsEmpty",
                        "MAUTORU_PHONE_CARS_SHOW_PRIV"},

                {TRUCK, ALL, "mobile/SearchTrucksAllPrivate", "desktop/SearchTrucksBreadcrumbsEmpty",
                        "MAUTORU_PHONE_TRUCKS_SHOW"},
                {TRUCK, ALL, "mobile/SearchTrucksAllPrivate", "desktop/SearchTrucksBreadcrumbsEmpty",
                        "MAUTORU_PHONE_TRUCKS_SHOW_PRIV"},
                {TRUCK, ALL, "mobile/SearchTrucksAllPrivate", "desktop/SearchTrucksBreadcrumbsEmpty",
                        "PHONE_COMMERCIAL_HCV_USER"},

                {MOTORCYCLE, ALL, "mobile/SearchMotoAllPrivate", "desktop/SearchMotoBreadcrumbsEmpty",
