...
@DisplayName("Метрики - параметры визитов - сайдбар")
@Feature(METRICS)
@RunWith(GuiceTestRunner.class)
@GuiceModules(MobileDevToolsTestsModule.class)
public class SidebarVisitParamsTest {

    String VISIT_PARAM = "{\"cars\":{\"index\":{\"from_buter_autoru_evaluation\":{}}}}";
    ...
    @DisplayName("Метрики сайдбара")
    public void shouldSendSidebarMetrics() {
        basePageSteps.onMainPage().header().sidebarButton().click();
        basePageSteps.onMainPage().sidebar().button("Оценить авто").click();
