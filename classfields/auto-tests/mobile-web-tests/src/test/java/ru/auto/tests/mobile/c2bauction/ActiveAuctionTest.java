...
public class ActiveAuctionTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][]{
                {NEW, "Назначаем и проводим встречу", "Skoda Octavia III (A7) Рестайлинг, 2020\nШаг\nОсмотр\nНазначаем" +
                        " и проводим встречу, чтобы финально оценить машину\nКак подготовиться к осмотру?\nКак работает" +
                        " «Авто.ру Выкуп»?\nОтозвать заявку"},
                {AUCTION, "Уточняем у дилеров итоговую цену", "Skoda Octavia III (A7) Рестайлинг, 2020\nШаг\nСбор " +
                        "предложений\nУточняем у дилеров итоговую цену и выбираем лучшую\nОстались вопросы?\nЗвоните " +
                        "c 9:00 до 18:00 в будни\n+7 495 792-65-69\nКак работает «Авто.ру Выкуп»?\nОтозвать заявку"},
                {DEAL, "Выбрали лучшее предложение!", "Skoda Octavia III (A7) Рестайлинг, 2020\nШаг\nИтоговая цена\n" +
                        "Выбрали лучшее предложение! Скоро позвоним и расскажем о нём\nОстались вопросы?\nЗвоните c " +
                        "9:00 до 18:00 в будни\n+7 495 792-65-69\nКак работает «Авто.ру Выкуп»?\nОтозвать заявку"},
    ...
    @Owner(DENISKOROBOV)
    @DisplayName("Проверям статус аукциона")
    public void shouldSeeApplicationStatus() {
        basePageSteps.onLkPage().getApplication(0).should(hasText(statusText));
    }
}
