...
public class VasSaleFreshAutoMotoTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/SessionAuthUser",
                ...
                "desktop/OfferMotoUsedUserOwnerWithServices",
                "mobile/BillingSchedulesMotoBoostPut",
                "mobile/BillingSchedulesMotoBoostDelete").post();
