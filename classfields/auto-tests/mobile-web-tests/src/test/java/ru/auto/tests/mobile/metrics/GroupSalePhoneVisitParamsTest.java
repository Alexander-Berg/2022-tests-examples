...
@DisplayName("Метрики - параметры визитов - телефон на групповой карточке c запиненным оффером")
@Feature(METRICS)
@GuiceModules(MobileDevToolsTestsModule.class)
@RunWith(Parameterized.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class GroupSalePhoneVisitParamsTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][]{
                {"1", "{\"cars\":{\"card\":{\"show-phone\":{\"client\":{\"button\":{\"new\":{}}}}}}}"},
    ...
    public void shouldSendVisitParams() {
        ...
        seleniumMockSteps.assertWithWaiting(onlyOneMetricsRequest(hasSiteInfo(visitParams)));
    }
}
