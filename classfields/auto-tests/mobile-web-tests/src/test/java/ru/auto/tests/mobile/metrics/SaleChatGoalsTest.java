...
public class SaleChatGoalsTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][] {
                {CARS, USED, "desktop/OfferCarsUsedUser", "CHAT_OPEN_MOBILE"},

                {MOTORCYCLE, USED, "desktop/OfferMotoUsedUser", "CHAT_OPEN_MOBILE"},

                {TRUCK, USED, "desktop/OfferTrucksUsedUser", "CHAT_OPEN_MOBILE"}
        });
    }
    ...
    public void shouldSendMetrics() {
        basePageSteps.onCardPage().floatingContacts().sendMessageButton().click();
