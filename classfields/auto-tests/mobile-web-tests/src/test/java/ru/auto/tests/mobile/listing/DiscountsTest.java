...
public class DiscountsTest {
    ...
    public void before() {
        mockRule.setStubs(stub("desktop/SearchCarsBreadcrumbsEmpty"),
                stub("mobile/SearchCarsAll")).create();
    ...
    public void shouldSeeDiscounts() {
        basePageSteps.onDealerCardPage().getSale(5).hover();

        basePageSteps.onListingPage().getSale(5).badge("Скидки").waitUntil(isDisplayed());
    }
}
