...
public class FavoritesListingUnregTrucksTest {
    ...
    public void before() {
        mockRule.setStubs(
                stub("desktop/SearchTrucksBreadcrumbsEmpty"),
                stub("mobile/SearchTrucksAll")
        ).create();
    ...
    private void authorize() {
        ...
        mockRule.setStubs(
                ...
                stub("desktop/SearchTrucksBreadcrumbsEmpty"),
                stub("mobile/SearchTrucksAll"),
                stub("desktop/UserFavoritesTrucksPost"),
                stub("desktop/UserFavoritesTrucksDelete")
        ).create();
