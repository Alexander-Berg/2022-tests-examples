...
public class OwnerCarGarageBannerTest {
    ...
    public void shouldSeeGarageBannerClosedCookieRedirected() {
        ...
        basePageSteps.scrollAndClick(basePageSteps.onCardPage().addedToGarageBanner().button(TO_GARAGE));
    ...
    public void shouldSeeGarageBannerClosedCookieClosed() {
        ...
        basePageSteps.scrollAndClick(basePageSteps.onCardPage().addedToGarageBanner().close().waitUntil(isDisplayed()));
