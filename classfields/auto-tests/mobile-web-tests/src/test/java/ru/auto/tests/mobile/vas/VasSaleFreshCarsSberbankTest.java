...
@DisplayName("Покупка VAS на карточке через Сбербанк")
@Feature(VAS)
@RunWith(GuiceTestRunner.class)
@GuiceModules(MobileEmulationTestsModule.class)
public class VasSaleFreshCarsSberbankTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/OfferCarsUsedUserOwner",
                ...
                "mobile/BillingAutoruPaymentProcessSaleSberbankRedirect").post();
    ...
    public void shouldSeeCorrectUrl() {
        basePageSteps.clickButton("оплатите на сайте Сбербанка");
        urlSteps.shouldSeeCertainNumberOfTabs(2);
        //urlSteps.switchToNextTab();
        //urlSteps.fromUri("https://kassa.yandex.ru/checkout/payments/sberbank?orderId=264c9689-000f-5000-8000-1b661a08a180")
        //        .shouldNotSeeDiff();
    }
    ...
    public void shouldBuyVas() throws InterruptedException {
        ...
        paymentSteps.onPaymentPage().input().sendKeys("9111111111");
