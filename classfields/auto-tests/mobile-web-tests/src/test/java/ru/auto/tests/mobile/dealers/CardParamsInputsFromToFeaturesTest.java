...
@DisplayName("Карточка дилера - параметры - характеристики - инпуты от/до")
@Feature(FILTERS)
@RunWith(Parameterized.class)
@GuiceModules(MobileEmulationTestsModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class CardParamsInputsFromToFeaturesTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][]{
                {CARS, ALL, "Мощность, л.с.", "power"},
                {CARS, ALL, "Пробег, км", "km_age"},
                {CARS, ALL, "Разгон до 100 км/ч, с", "acceleration"},

                {CARS, NEW, "Мощность, л.с.", "power"},
                {CARS, NEW, "Разгон до 100 км/ч, с", "acceleration"}
        });
    }
