...
public class ActiveSaleNewUnregMotoTest {
    ...
    @Before
    public void before() {
        mockRule.newMock().with("desktop/OfferMotoNew",
    ...
    public void shouldSeeSellerComment() {
        basePageSteps.onCardPage().sellerComment().should(hasText("Комментарий продавца\nКомпания АО \"Авилон АГ\", " +
                "крупнейший дилер BMW Motorrad в России, предлагает вам лучшие условия на покупку " +
                "нового мотоцикла BMW.\n\nОсобые привилегии от BMW Bank: Программа «3ASY Ride»\n\n" +
