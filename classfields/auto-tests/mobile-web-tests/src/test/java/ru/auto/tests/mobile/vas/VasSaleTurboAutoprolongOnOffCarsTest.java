...
public class VasSaleTurboAutoprolongOnOffCarsTest {
    ...
    public void before() {
        mockRule.newMock().with("desktop/OfferCarsUsedUserOwnerWithServices",
                ...
                "desktop/UserOffersCarsProductPackageTurboProlongablePut",
                "desktop/UserOffersCarsProductPackageTurboProlongableDelete").post();
