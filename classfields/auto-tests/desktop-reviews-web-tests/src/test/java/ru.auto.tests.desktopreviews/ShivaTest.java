package ru.auto.tests.desktopreviews;
...
public class ShivaTest {
    ...
    public void shouldSeeDifferentPackages() {
        ...
        assertThat(testingPackage, startsWith("af-desktop-reviews="));
        assertThat(prodPackage, startsWith("af-desktop-reviews="));
    ...
    public void shouldSeeSamePackages() {
        ...
        urlSteps.autoruProdURI().path(REVIEWS).open();
