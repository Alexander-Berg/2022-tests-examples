...
import type { DesktopCompareAppState } from 'www-desktop-compare/react/DesktopCompareAppState';
...
let state: DesktopCompareAppState;

describe('должен корректно сформировать seo-данные для сравнения', () => {
    beforeEach(() => {
        state = _.cloneDeep(stateMock) as unknown as DesktopCompareAppState;
