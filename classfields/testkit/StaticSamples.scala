...
import baker.common.client.dadata.model.{Address, Organization}
...
trait StaticSamples {
  ...
  private val jsonDadataOrganization: String =
    """
      ...
      |          {
      |            "value": "+7 495 7397000",
      |            "unrestricted_value": "+7 495 7397000",
      |            "data": {
      |              "contact": null,
      |              "source": "84957397000",
      |              "qc": null,
  ...
  private val jsonDadataAddress1: String =
    """
      |{
      |  "suggestions": [
      |    {
      |      "value": "г Москва, пр-кт Вернадского, д 99 к 1",
      |      "unrestricted_value": "119526, г Москва, пр-кт Вернадского, д 99 к 1",
      |      "data": {
      |        "postal_code": "119526",
      |        "country": "Россия",
      |        "country_iso_code": "RU",
      ...
      |        "stead": null,
      |        "house_fias_id": "89441876-8f58-4aa1-92ed-417eb8f07e79",
      |        "house_kladr_id": "7700000000009530230",
      |        "house_cadnum": null,
      |        "house_type": "д",
      |        "house_type_full": "дом",
      |        "house": "99",
      ...
      |        "flat_price": null,
      |        "postal_box": null,
      |        "fias_id": "89441876-8f58-4aa1-92ed-417eb8f07e79",
      |        "fias_code": "77000000000000009530230",
      |        "fias_level": "8",
      |        "fias_actuality_state": "0",
      |        "kladr_id": "7700000000009530230",
      |        "geoname_id": "524901",
      |        "capital_marker": "0",
      |        "okato": "45268592000",
      |        "oktmo": "45327000",
  ...
  private val jsonDadataAddress2: String =
    """
      |{
      |  "suggestions": [
      |    {
      |      "value": "Самарская обл, г Тольятти, Обводное шоссе, д 3",
      |      "unrestricted_value": "Самарская обл, г Тольятти, Обводное шоссе, д 3",
      |      "data": {
      |        "postal_code": null,
      |        "country": "Россия",
      |        "country_iso_code": "RU",
      ...
      |        "settlement_type_full": null,
      |        "settlement": null,
      |        "street_fias_id": "98c1babe-5633-4dad-8bd6-48846f8e29f3",
      |        "street_kladr_id": "63000007000079900",
      |        "street_with_type": "Обводное шоссе",
      |        "street_type": "ш",
      ...
      |        "flat_price": null,
      |        "postal_box": null,
      |        "fias_id": "98c1babe-5633-4dad-8bd6-48846f8e29f3",
      |        "fias_code": "6300000700000000799",
      |        "fias_level": "7",
      |        "fias_actuality_state": "0",
      |        "kladr_id": "63000007000079900",
      |        "geoname_id": "482283",
      |        "capital_marker": "0",
      |        "okato": "36440373000",
      |        "oktmo": "36740000001",
      |        "tax_office": "6382",
      |        "tax_office_legal": "6382",
      |        "timezone": null,
      |        "geo_lat": "53.576946",
      |        "geo_lon": "49.400345",
      |        "beltway_hit": null,
  ...
  def sampleDadataAddress1: SuccessResponse[Address] = parseDadataAddress(jsonDadataAddress1)
  def sampleDadataAddress2: SuccessResponse[Address] = parseDadataAddress(jsonDadataAddress2)
  ...
  private def parseDadataAddress(json: String): SuccessResponse[Address] = {
    import baker.common.client.dadata.converter.JsonConverter._
    parse[SuccessResponse[Address]](json)
  }
