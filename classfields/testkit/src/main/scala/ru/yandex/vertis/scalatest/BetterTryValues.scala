  ...
  class SuccessOrFailure[T](theTry: Try[T], pos: source.Position) {
    ...
    def failure: Failure[T] = {
      theTry match {
        ...
        case success =>
          throw new TestFailedException((_: StackDepthException) => Some(s"The Try on which failure was invoked was not a Failure: $success"), None, pos)
      }
    }
    ...
    def success: Success[T] = {
      theTry match {
        ...
        case Failure(cause) =>
          throw new TestFailedException((_: StackDepthException) => Some("The Try on which success was invoked was not a Success."), Some(cause), pos)
      }
    }
  }
}
