const expandMmmMultiInfoOldToMmmInfo = require('./expandMmmMultiInfoOldToMmmInfo');

it('должен разобрать сгруппированные ммм по марке и модели', () => {
    const mmmInfo = [
    ...
    expect(expandMmmMultiInfoOldToMmmInfo(mmmMultiInfo)).toEqual(mmmInfo);
});
