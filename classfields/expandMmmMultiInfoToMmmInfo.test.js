const expandMmmMultiInfoToMmmInfo = require('./expandMmmMultiInfoToMmmInfo');

it('должен разобрать сгруппированные ммм', () => {
    const mmmInfo = [
        { mark: 'BMW', model: 'X5', nameplate_name: '1', generation: '111' },
        { mark: 'BMW', model: 'X5', nameplate_name: '1', generation: '222' },
        { mark: 'BMW', model: 'X5', nameplate_name: '2', generation: '111' },
        { mark: 'BMW', model: 'X5', nameplate_name: '2', generation: '222' },
    ...
    const mmmMultiInfo = [
        { mark: 'BMW', models: [ { id: 'X5', nameplates: [ '1', '2' ], generations: [ '111', '222' ] } ] },
        { mark: 'AUDI', models: [ { id: 'Q5', nameplates: [ '1', '2' ], generations: [] }, { id: 'Q3', nameplates: [], generations: [] } ] },
        { vendor: 'VENDOR1' },
    ];
    expect(expandMmmMultiInfoToMmmInfo(mmmMultiInfo)).toEqual(mmmInfo);
});

it('должен разобрать сгруппированные ммм с учетом исключения', () => {
    const mmmInfo = [
        { mark: 'BMW', model: 'X5', nameplate_name: '1', generation: '111' },
        { mark: 'BMW', model: 'X5', nameplate_name: '1', generation: '222' },
        { mark: 'BMW', model: 'X5', nameplate_name: '2', generation: '111' },
