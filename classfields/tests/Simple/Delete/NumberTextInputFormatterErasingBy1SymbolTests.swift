...
class NumberTextInputFormatterErasingBy1SymbolTests: XCTestCase {
    ...
    func test9() {
        ...
        let expectedResult = TextInputFormatterResult(text: "555", carriagePosition: 1, unformattedText: "555")
        XCTAssert(actualResult == expectedResult, "\n\(actualResult) must be equal to\n\(expectedResult)")
    }
    ...
    func test10() {
        ...
        let expectedResult = TextInputFormatterResult(text: "5.55", carriagePosition: 1, unformattedText: "5.55")
        XCTAssert(actualResult == expectedResult, "\n\(actualResult) must be equal to\n\(expectedResult)")
    }
}
