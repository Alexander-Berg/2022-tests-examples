...
class PreliminaryCreditSteps: BaseSteps {
    ...
    @discardableResult
    func validateSnapShot(accessibilityId: String, snapshotId: String, message: String = "", onFail: ((PreliminaryCreditSteps) -> Void)? = nil) -> Self {
    ...
    @discardableResult
    func fill() -> Self {
        return enterFio("Вася Пупкин")
            .enterEmail("asd@asds.ru")
            .enterPhone("9162131212")
            .tapSubmit()
    }
}
