...
const TESTS = [
    ...
    {
        headers: {
            cookie: '_csrf_token=36201940%7C1563384608735.7776000',
            host: 'auto.ru'
        },
        result: {
            cookie: '_csrf_token=36201940%7C156338***',
            host: 'auto.ru'
        }
    },
    {
        headers: {
            cookie: 'foo=bar; _csrf_token=36201940%7C1563384608735.7776000',
            host: 'auto.ru'
        },
        result: {
            cookie: 'foo=bar; _csrf_token=36201940%7C156338***',
            host: 'auto.ru'
        }
    },
    {
        headers: {
            cookie: '_csrf_token=36201940%7C1563384608735.7776000; foo=bar',
            host: 'auto.ru'
        },
        result: {
            cookie: '_csrf_token=36201940%7C156338***; foo=bar',
            host: 'auto.ru'
        }
    },
    {
        headers: {
            cookie: 'bar=baz; _csrf_token=36201940%7C1563384608735.7776000; foo=bar',
            host: 'auto.ru'
        },
        result: {
            cookie: 'bar=baz; _csrf_token=36201940%7C156338***; foo=bar',
            host: 'auto.ru'
        }
    },
    {
    ...
    },
    {
        ...
        headers: {
            cookie: '_csrf_token=36201',
            host: 'auto.ru'
        },
        result: {
            cookie: '_csrf_token=36***',
            host: 'auto.ru'
        }
    }
];
