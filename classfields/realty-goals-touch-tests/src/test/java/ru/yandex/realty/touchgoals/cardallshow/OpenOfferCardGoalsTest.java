package ru.yandex.realty.touchgoals.cardallshow;
...
public class OpenOfferCardGoalsTest {
        ...
        return asList(new Object[][]{
                ...
                {"Снять квартиру",
                        mockOffer(RENT_APARTMENT)
                                .setService(GoalsConsts.Parameters.PREMIUM).setService(PROMOTED).setExtImages(),
                        params()
                                .offerType(RENT)
                                .offerCategory(APARTMENT)
                                .hasGoodPrice(FALSE)
                ...
                {"Снять коммерческую",
                        mockOffer(RENT_COMMERCIAL_WAREHOUSE)
                                .setService(GoalsConsts.Parameters.PREMIUM),
                        params()
                                .offerType(RENT)
                                .offerCategory(COMMERCIAL)
                                .hasGoodPrice(FALSE)
    ...
    public void shouldSeeOfferGoalsWithoutAll() {
        cardAllShowParams.offerId(offer.getOfferId());
        ...
        goalsSteps.urlMatcher(containsString(CARD_ALL_SHOW)).withGoalParams(
                goal().setCard(cardAllShowParams)).shouldExist();
    }
}
