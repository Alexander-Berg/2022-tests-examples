package ru.yandex.realty.touchgoals.favorites.add.listing;
...
public class FavoritesListingGoalsTest {
    ...
    public void shouldSeeListingFavoritesAddGoal() {
        ...
        basePageSteps.onMobileSaleAdsPage().offer(FIRST).buttonWithTitle(ADD_TO_FAV).click();
