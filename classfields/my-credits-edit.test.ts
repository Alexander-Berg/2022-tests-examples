...
import controller from './my-credits-edit';

describe('контроллер my-credits-edit', () => {
    ...
    it('если нет кредитной анкеты, редиректит в my-credits', function() {
        publicApi
            .get('/1.0/session/')
            ...
            .then(
                ...
                (error) => {
                    expect(error).toMatchObject({
                        error: {
                            code: RedirectError.CODES.CREDITS_LK_EDIT_TO_ROOT,
                        },
                    });
                },
            );
