...
$task_values = [
    ...
    [
        'name' => 'img_1',
        'value' => 'http://is16.dev.autoru.yandex.net/all/images/b7/29/900x675/b729c34050d190ddbfd1492d8d15eda9.jpg'
    ],
    [
        'name' => 'img_2',
        'value' => 'http://is7.dev.autoru.yandex.net/all/images/46/db/900x675/46dbbea2224d3383fb1d23145d141af6.jpg'
    ],
    [
        'name' => 'img_3',
        'value' => 'http://is17.dev.autoru.yandex.net/all/images/32/c9/900x675/32c9dbefad8704f69dc85722a5b1d832.jpg'
    ]
];
...
//Создаем задачу
$task_response = $toloka->createTask($pool_id, $task_request);

$task_id = $task_response->id;
$hConsole->log('Create Task ID: ' . $task_id);
