...
import { OwnerFlatTenantCandidateGroupContainer } from '../container';

import { filledStore, longNameStore, skeletonStore, filledStoreWithOnlyContent } from './stub/store';
...
const Component: React.FunctionComponent<{ store: DeepPartial<IUniversalStore>; Gate?: AnyObject }> = (props) => (
    ...
    >
        <OwnerFlatTenantCandidateGroupContainer />
    </AppProvider>
);

describe('OwnerFlatTenantCandidateGroup', () => {
