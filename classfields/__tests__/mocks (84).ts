...
const site = {
    ...
    salesDepartment: {
        ...
        statParams: '',
        encryptedPhones: [{ phoneWithMask: '+7 495 154 ×× ××', phoneHash: 'KzcF0OHTUJxNLTQNyMPzIR0' }],
        encryptedPhonesWithTag: [],
        encryptedDump: '',
    },
    phone: { phoneWithMask: '+7 495 154 ×× ××', phoneHash: 'KzcF0OHTUJxNLTQNyMPzIR0' },
    backCallTrafficInfo: {} as TrafficSourceInfo,
    withBilling: true,
    awards: {},
    limitedCard: false,
    phoneHash: 'KzcF0OHTUJxNLTQNyMPzIR0',
