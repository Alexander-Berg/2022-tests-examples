...
describe('Form', () => {
    ...
    it('should render form in error state without checkbox', async() => {
        await render(
            <NewbuildingSpecialSubscriptionFormComponent
                formControllerProps={{
                    hasSubmitError: true,
    ...
    it('should render form in success state without checkbox', async() => {
        await render(
            <NewbuildingSpecialSubscriptionFormComponent
                formControllerProps={{
                    subscription: {
    ...
    it('should render form in success state with unconfirmed email without checkbox', async() => {
        await render(
            <NewbuildingSpecialSubscriptionFormComponent
                formControllerProps={{
                    subscription: {
    ...
    it('should render form in success state with long unconfirmed email without checkbox', async() => {
        await render(
            <NewbuildingSpecialSubscriptionFormComponent
                formControllerProps={{
                    subscription: {
