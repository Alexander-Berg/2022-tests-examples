...
export const fixtures = {
    'Author service findByPk Возвращает существующего автора с его соц.сетями': {
        AUTHOR_DATA: {
            id: 1,
        ...
        SOCIAL_NETWORK_VK_DATA: {
            url: 'https://vk.com/id123',
            type: SocialNetworkType.vk,
        },
    },
    'Author service findByUrlPart Возвращает существующего автора с его соц.сетями': {
        AUTHOR_DATA: {
            id: 1,
            urlPart: 'redakciya-avtoru',
            name: 'Редакция Авто.ру',
    ...
    'Author service create Создает и возвращает автора вместе с его соц.сетями': {
        AUTHOR_DATA: {
            urlPart: 'redakciya-avtoru',
            name: 'Редакция Авто.ру',
            position: Position.editor,
    ...
    'Author service update Обновляет и возвращает автора вместе с его соц.сетями': {
        AUTHOR_DATA: {
            urlPart: 'redakciya-avtoru',
            name: 'Редакция Авто.ру',
            position: Position.editor,
        ...
        AUTHOR_UPDATE_DATA: {
            urlPart: 'testovyy',
            name: 'Тестовый',
            position: Position.outstaffEditor,
            photo: {
                meta: {
            ...
            socialNetworks: [
                {
                    type: SocialNetworkType.vk,
                    url: 'https://vk.com/id111-222',
                },
            ],
        },
        USER_LOGIN: 'editor-1',
    },
    'Author service delete Удаляет автора и его соц.сети': {
        AUTHOR_DATA: {
            urlPart: 'redakciya-avtoru',
            name: 'Редакция Авто.ру',
            position: Position.editor,
