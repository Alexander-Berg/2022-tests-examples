...
import { HouseServicesMeterReadingsNotSentModal } from '../index';
...
const Component: React.FunctionComponent<{ store: DeepPartial<IUniversalStore>; Gate?: AnyObject }> = (props) => (
    <AppProvider rootReducer={userReducer} Gate={props.Gate} initialState={props.store}>
        <HouseServicesMeterReadingsNotSentModal isOpen={true} closeModal={() => undefined} />
    </AppProvider>
);

describe('HouseServicesMeterReadingsNotSentModal', () => {
