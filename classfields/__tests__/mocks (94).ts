...
export const getSiteSnippet = ({ withoutMetro = false, withoutFlats = false, suspended = false } = {}) =>
    (({
        id: 375274,
        name: 'Саларьево парк',
        ...
        buildingFeatures: {
            state: suspended ? 'CONSTRUCTION_SUSPENDED' : 'UNFINISHED',
            ...
            wallTypes: [
                ...
                },
                {
                    ...
                    text:
                        'Обеспечивает высокую скорость строительства. Собирается из готовых блоков, что позволяет лучше контролировать качество.',
                },
            ],
        },
        flatStatus: withoutFlats ? 'SOLD' : 'ON_SALE',
        ...
        description:
            'Жилой район «Саларьево парк» расположен на Юго-Западе Москвы рядом с метро «Саларьево». Масштабная концепция развития района предусматривает  возведение современных жилых домов и всей необходимой инфраструктуры в несколько очередей.',
        developers: [
            {
                id: 52308,
        ...
        price: {
            ...
            to: 21840000,
            currency: 'RUR',
            minPricePerMeter: 184500,
            maxPricePerMeter: 246999,
            rooms: {
                '1': {
                    soldout: false,
                    from: 7937600,
