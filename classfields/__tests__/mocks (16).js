...
export const getOffers = () => [
    ...
    },
    {
        ...
        price: {
            ...
            trend: 'UNCHANGED',
            hasPriceHistory: false,
            valuePerPart: 27670172,
            unitPerPart: 'SQUARE_METER',
            valueForWhole: 1000000000,
            unitForWhole: 'WHOLE_OFFER',
            price: {
                value: 1000000000,
                currency: 'RUB',
...
export const getOffersWithVirtualTour = () => getOffers().map(
    offer => ({
        ...offer,
        virtualTours: [
            { enabled: true }
