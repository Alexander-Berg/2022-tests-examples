...
import { DeclineHouseServicesPaymentConfirmationModal } from '../index';
...
const Component: React.FunctionComponent<{ store: DeepPartial<IUniversalStore>; Gate?: AnyObject }> = (props) => (
    <AppProvider rootReducer={userReducer} Gate={props.Gate} initialState={props.store}>
        <DeclineHouseServicesPaymentConfirmationModal isOpen={true} onClick={noop} closeModal={() => undefined} />
    </AppProvider>
);

describe('DeclineHouseServicesPaymentConfirmationModal', () => {
