...
import { HouseServicesPeriodReceiptNotSentModal } from '../index';
...
const Component: React.FunctionComponent<{ store: DeepPartial<IUniversalStore>; Gate?: AnyObject }> = (props) => (
    <AppProvider rootReducer={userReducer} Gate={props.Gate} initialState={props.store}>
        <HouseServicesPeriodReceiptNotSentModal isOpen={true} closeModal={() => undefined} />
    </AppProvider>
);

describe('HouseServicesPeriodReceiptNotSentModal', () => {
