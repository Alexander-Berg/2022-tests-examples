...
import { OwnerHouseServicesPeriodPaymentConfirmationContainer } from '../container';
...
const Component: React.FunctionComponent<{ store: DeepPartial<IUniversalStore> }> = ({ store }) => (
    <AppProvider initialState={store} rootReducer={userReducer} bodyBackgroundColor={AppProvider.PageColor.USER_LK}>
        <OwnerHouseServicesPeriodPaymentConfirmationContainer />
    </AppProvider>
);

describe('OwnerHouseServicesPeriodPaymentConfirmation', () => {
