...
import { rejectPromise, AppProvider } from 'view/react/libs/test-helpers';
...
describe('SubscriptionsD', () => {
    ...
    it('should open delete confirmation modal when "delete" is clicked on a subscription tile', async() => {
        ...
        await page.click('[data-test=subscription-tile-delete]');
    ...
    it('should open settings modal when "settings" is clicked on a subscription tile', async() => {
        ...
        await page.click('[data-test=subscription-tile-settings]');
        await page.waitFor(500);
