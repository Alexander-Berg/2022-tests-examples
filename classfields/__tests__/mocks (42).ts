...
import { IMetroStationPageStore } from 'view/reducers/pages/MetroStationPage';
...
export const baseInitialState: Partial<IMetroStationPageStore> = {
    metroStation: metroStationBaseStore,
};

export const initialStateWithoutNewbuildings: Partial<IMetroStationPageStore> = {
    ...baseInitialState,
    metroStation: {
...
export const initialStateWithoutLinks: Partial<IMetroStationPageStore> = {
    ...baseInitialState,
    metroStation: {
        ...metroStationBaseStore,
        links: {},
...
export const initialStateWitOneNewbuilding: Partial<IMetroStationPageStore> = {
    ...baseInitialState,
    metroStation: {
        ...metroStationBaseStore,
...
export const initialStateWithoutNewbuildingsAndWithLowLinks: Partial<IMetroStationPageStore> = {
    ...baseInitialState,
    metroStation: {
        ...metroStationBaseStore,
        newbuildings: [],
