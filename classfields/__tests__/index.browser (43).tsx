...
import { SuccessfulReviewSubmitModal } from '../index';
...
const Component: React.FunctionComponent<{ store: DeepPartial<IUniversalStore>; Gate?: AnyObject }> = (props) => (
    <AppProvider rootReducer={userReducer} Gate={props.Gate} initialState={props.store}>
        <SuccessfulReviewSubmitModal isOpen={true} onSubmit={() => undefined} closeModal={() => undefined} />
    </AppProvider>
);

describe('SuccessfulReviewSubmitModal', () => {
