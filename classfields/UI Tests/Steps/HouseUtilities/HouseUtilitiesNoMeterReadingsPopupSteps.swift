//
//  HouseUtilitiesNoMeterReadingsPopupSteps.swift
//  UI Tests
//
...
final class HouseUtilitiesNoMeterReadingsPopupSteps {
    @discardableResult
    ...
    private typealias Identifiers = HouseUtilitiesMetersAccessibilityIdentifiers.NoMeterReadingsPopup
