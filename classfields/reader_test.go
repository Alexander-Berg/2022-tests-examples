...
var testReaderOpts = &TraceReaderOptions{
...
func TestTraceReader_FindTraceIDs(t *testing.T) {
	...
	traceReader := NewTraceReader(testReaderOpts, db)
	service := "service"
	start := testStartTime
...
func TestTraceReader_GetServicesNoTable(t *testing.T) {
	...
	traceReader := NewTraceReader(&TraceReaderOptions{IndexTable: testIndexTable, SpansTable: testSpansTable}, db)
...
func TestTraceReader_GetOperations(t *testing.T) {
	...
	cfg := &TraceReaderOptions{
		IndexTable:      testIndexTable,
		SpansTable:      testSpansTable,
		OperationsTable: testOperationsTable,
	}
	traceReader := NewTraceReader(cfg, db)
