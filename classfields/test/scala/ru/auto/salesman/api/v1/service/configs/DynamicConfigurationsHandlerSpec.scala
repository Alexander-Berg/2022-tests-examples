package ru.auto.salesman.api.v1.service.configs
...
/*should work as features, so the test is the same*/
class DynamicConfigurationsHandlerSpec extends RoutingSpec {
  ...
  private val route = new DynamicConfigurationsHandler(featureRegistry).route
