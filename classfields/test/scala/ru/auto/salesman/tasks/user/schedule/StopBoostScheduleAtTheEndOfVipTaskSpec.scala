...
class StopBoostScheduleAtTheEndOfVipTaskSpec
    extends BaseSpec
  ...
  val task = new StopBoostScheduleAtTheEndOfVipTask(
    bundleService,
    productScheduleDao,
    epochService
  )
  ...
  "StopBoostScheduleAtTheEndOfVipTask" should {
      ...
      forAll(EpochInPastGen) { epoch =>
        forAll(
          ...
          (epochService
            ...
            .expects(Markers.StopBoostScheduleAtTheEndOfVipEpoch)
