...
import ru.yandex.realty2.extdataloader.loaders.lucene.readers.{FeedOffersProcessor, MyTargetAppBuilder}

import java.text.SimpleDateFormat
import java.util.Calendar

class MyTargetAppBuilderSpec extends SpecBase {
  ...
  private val feed2GISBuilder =
    new MyTargetAppBuilder(regionGraphProvider, feedOfferProcessor, filter, new MdsUrlBuilder("//avatarnica.test"))
  ...
  "Correct write body" in {
    feed2GISBuilder
      ...
      s"""<offer id="6302897158613069191" available="">
        ...
        <ios_url>app://path/to/scr/?adjust_tracker=w1f3je</ios_url>
        <android_url>app://path/to/scr/?adjust_tracker=58px97</android_url>
        <bundle_id>com.yandex.mobile.realty</bundle_id>
        <ios_app_store_id>1020247568</ios_app_store_id>
      </offer>"""
  }
