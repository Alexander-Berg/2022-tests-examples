...
import com.yandex.ydb.core.{Result, StatusCode, UnexpectedResultException}
...
class QueryRetriesTest extends AnyFunSuite with Matchers with MockitoSupport {
