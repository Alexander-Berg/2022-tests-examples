...
import ru.yandex.vertis.telepony.model.{CallId, Operator, Record, RecordId, RecordMeta, TypedDomain, Url}
...
class RecordServiceProbe(probe: ActorRef) extends RecordService {
  ...
  override def saveExisting(meta: RecordMeta, domain: TypedDomain)(implicit rc: RequestContext): Future[Unit] =
    throw new NotImplementedError
