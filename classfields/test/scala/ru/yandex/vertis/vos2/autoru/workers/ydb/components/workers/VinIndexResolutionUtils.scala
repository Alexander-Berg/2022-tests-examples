...
trait VinIndexResolutionUtils {
  ...
  def resolutionOnlyPledgesError(ms: Option[Long] = None): VinIndexResolution = {
    val builder = VinIndexResolution
      .newBuilder()
      .setVersion(version)
      .addEntries(
  ...
  def resolutionOffersHistoryBadMileage: VinIndexResolution = {
    val builder = VinIndexResolution
      .newBuilder()
      .setVersion(version)
      .addEntries(
  ...
  def resolutionExtendedWarranty: VinIndexResolution = {
    val builder = VinIndexResolution
      .newBuilder()
      .setVersion(version)
      .addEntries(
      ...
      .addEntries(
        ResolutionEntry
          .newBuilder()
          .setPart(ResolutionPart.RP_EXTENDED_WARRANTY)
          .setStatus(VinResolutionEnums.Status.OK)
      )
    builder.build()
  }
