...
class PhoneRedirectTest extends AnyFunSuite with Matchers {
  ...
  test("parse PhoneRedirect from json") {
    ...
    Json.parse(json).as[PhoneRedirect] shouldBe PhoneRedirect(
      ...
      deadline = Some(DateTime.parse("2016-11-02T13:40:45.839+03:00")),
      source = "+79175446755",
      target = "+79671686464"
    )
  }

  test("parse PhoneRedirect from json without deadline") {
    val json = """{
                 |  "source": "+79175446755",
                 |  "createTime": "2016-11-02T12:34:13.578+03:00",
                 |  "id": "3kJPPqQ5gmc",
