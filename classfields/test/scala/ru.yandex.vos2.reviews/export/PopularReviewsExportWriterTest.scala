...
import ru.yandex.vos2.reviews.export.writer.PopularReviewsExportWriter

/**
  * Created by Karpenko Maksim (knkmx@yandex-team.ru) on 22/08/2017.
  */
class PopularReviewsExportWriterTest extends BaseReviewsTest {

  val exportWriter = new PopularReviewsExportWriter(stream, 4, commentsDao, features)
