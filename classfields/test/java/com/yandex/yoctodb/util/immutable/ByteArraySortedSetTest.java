...
public class ByteArraySortedSetTest {
  ...
  @Test
  public void buildingFromFixedLengthByteArraySortedSetTest() throws IOException {
    // unsorted elements
    ...
    final Buffer bb = prepareDataFromFixedLengthByteArraySortedSet(elements);
    final ByteArraySortedSet ss = FixedLengthByteArraySortedSet.from(bb);
    ...
    for (int i = 0; i < elements.size(); i++) {
      assertEquals(elements.get(i).toByteBuffer(), ss.get(i));
    }
  }

  @Test
  public void buildingFromFixedLengthByteArraySortedSetTestLongUnsafe() throws IOException {
    // unsorted elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  @Test
  public void buildingFromFixedLengthByteArraySortedSetTestIntUnsafe() throws IOException {
    // unsorted elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  @Test
  public void buildingFromFixedLengthByteArraySortedSetTestShortUnsafe() throws IOException {
    // unsorted elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  @Test
  public void buildingFromFixedLengthByteArraySortedSetTestCharUnsafe() throws IOException {
    // unsorted elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  @Test
  public void buildingFromFixedLengthByteArraySortedSetTestByteUnsafe() throws IOException {
    // unsorted elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  private Buffer prepareDataFromFixedLengthByteArraySortedSet(
    ...
    final com.yandex.yoctodb.util.mutable.impl.FixedLengthByteArraySortedSet
        fixedLengthByteArrayIndexedList =
    ...
    assertEquals(os.size(), fixedLengthByteArrayIndexedList.getSizeInBytes());

    return Buffer.from(os.toByteArray());
  }

  @Test
  public void buildingFromVariableLengthByteArraySortedSetTest() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    ...
    final Buffer bb = prepareDataFromVariableLengthByteArraySortedSet(elements);
    final ByteArraySortedSet ss = VariableLengthByteArraySortedSet.from(bb);
  ...
  @Test
  public void buildingFromVariableLengthByteArraySortedSetTestLongUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    elements.add(UnsignedByteArrays.from(0L));
    elements.add(UnsignedByteArrays.from(1L));
  ...
  @Test
  public void buildingFromVariableLengthByteArraySortedSetTestIntUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    elements.add(UnsignedByteArrays.from(0));
    elements.add(UnsignedByteArrays.from(1));
  ...
  @Test
  public void buildingFromVariableLengthByteArraySortedSetTestShortUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    elements.add(UnsignedByteArrays.from((short) 0));
    elements.add(UnsignedByteArrays.from((short) 1));
  ...
  @Test
  public void buildingFromVariableLengthByteArraySortedSetTestCharUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    elements.add(UnsignedByteArrays.from('a'));
    elements.add(UnsignedByteArrays.from('b'));
  ...
  @Test
  public void buildingFromVariableLengthByteArraySortedSetTestByteUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  private Buffer prepareDataFromVariableLengthByteArraySortedSet(
    ...
    final com.yandex.yoctodb.util.mutable.impl.VariableLengthByteArraySortedSet
        fixedLengthByteArrayIndexedList =
  ...
  public void lessThanTest() throws IOException {
    ...
    for (int i = 0; i < SIZE; i++) {
      ...
      assertEquals(i, ss.indexOfLessThan(buffer, true, 0));

      final int indexWithoutOrEquals = ss.indexOfLessThan(buffer, false, 0);
    ...
    assertEquals(-1, ss.indexOfLessThan(from(0).toByteBuffer(), false, 1));
  }
  ...
  public void greaterThanTest() throws IOException {
    ...
    for (int i = 0; i < SIZE; i++) {
      ...
      assertEquals(i, ss.indexOfGreaterThan(buffer, true, SIZE - 1));

      final int indexWithoutOrEquals = ss.indexOfGreaterThan(buffer, false, SIZE - 1);
    ...
    assertEquals(-1, ss.indexOfGreaterThan(from(SIZE - 1).toByteBuffer(), false, SIZE - 2));
  }
}
