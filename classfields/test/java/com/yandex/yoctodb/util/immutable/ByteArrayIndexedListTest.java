...
public class ByteArrayIndexedListTest {
  @Test
  public void buildingFromFixedLengthByteArrayIndexedListTest() throws IOException {
    // elements
    ...
    final Buffer bb = prepareDataFromFixedLengthByteArrayIndexedList(elements);
    final ByteArrayIndexedList list = FixedLengthByteArrayIndexedList.from(bb);

    Assert.assertEquals(elements.size(), list.size());

    for (int i = 0; i < elements.size(); i++) {
      Assert.assertEquals(elements.get(i).toByteBuffer(), list.get(i));
    }
  }

  @Test
  public void buildingFromFixedLengthByteArrayIndexedListTestLongUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  @Test
  public void buildingFromFixedLengthByteArrayIndexedListTestIntUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  @Test
  public void buildingFromFixedLengthByteArrayIndexedListTestShortUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  @Test
  public void buildingFromFixedLengthByteArrayIndexedListTestCharUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  @Test
  public void buildingFromFixedLengthByteArrayIndexedListTestByteUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
  ...
  private Buffer prepareDataFromFixedLengthByteArrayIndexedList(
    ...
    final com.yandex.yoctodb.util.mutable.impl.FixedLengthByteArrayIndexedList
    ...
    Assert.assertEquals(os.size(), fixedLengthByteArrayIndexedList.getSizeInBytes());

    return Buffer.from(os.toByteArray());
  }

  @Test
  public void buildingFromVariableLengthByteArrayIndexedListTest() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    ...
    final Buffer bb = prepareDataFromVariableLengthByteArrayIndexedLength(elements);
    final ByteArrayIndexedList list = VariableLengthByteArrayIndexedList.from(bb);
  ...
  @Test
  public void buildingFromVariableLengthByteArrayIndexedListTestLongUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    elements.add(UnsignedByteArrays.from(0L));
    elements.add(UnsignedByteArrays.from(1L));
  ...
  @Test
  public void buildingFromVariableLengthByteArrayIndexedListTestIntUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    elements.add(UnsignedByteArrays.from(0));
    elements.add(UnsignedByteArrays.from(1));
  ...
  @Test
  public void buildingFromVariableLengthByteArrayIndexedListTestShortUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    elements.add(UnsignedByteArrays.from((short) 0));
    elements.add(UnsignedByteArrays.from((short) 1));
  ...
  @Test
  public void buildingFromVariableLengthByteArrayIndexedListTestCharUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    elements.add(UnsignedByteArrays.from('a'));
    elements.add(UnsignedByteArrays.from('b'));
  ...
  @Test
  public void buildingFromVariableLengthByteArrayIndexedListTestByteUnsafe() throws IOException {
    // elements
    final List<UnsignedByteArray> elements = new ArrayList<>();
    elements.add(UnsignedByteArrays.from((byte) 0));
    elements.add(UnsignedByteArrays.from((byte) -2));
  ...
  private Buffer prepareDataFromVariableLengthByteArrayIndexedLength(
      final Collection<UnsignedByteArray> elements) throws IOException {
    final com.yandex.yoctodb.util.mutable.impl.VariableLengthByteArrayIndexedList
        variableLengthByteArrayIndexedList =
    ...
    Assert.assertEquals(os.size(), variableLengthByteArrayIndexedList.getSizeInBytes());
