...
public class TrieByteArraySortedSetTest {
  ...
  private static final Collection<String> falseQueries =
      Arrays.asList(
          "",
          "z",
          "a",
  ...
  private static com.yandex.yoctodb.util.mutable.impl.VariableLengthByteArraySortedSet
      mutableVariable;
  ...
  private static final com.yandex.yoctodb.util.immutable.impl.VariableLengthByteArraySortedSet
      variableSet;
  ...
  static {
    ...
    emptyTrieSet =
        com.yandex.yoctodb.util.immutable.impl.TrieByteArraySortedSet.from(
            Buffer.from(ByteBuffer.allocate(4)));
    trieSet =
        com.yandex.yoctodb.util.immutable.impl.TrieByteArraySortedSet.from(
            Buffer.from(trieOutput.toByteArray()));
    variableSet =
        com.yandex.yoctodb.util.immutable.impl.VariableLengthByteArraySortedSet.from(
  ...
  public void indexOfEmpty() {
    for (String q : queries) {
      assertEquals(String.format("for query <%s>", q), -1, emptyTrieSet.indexOf(query(q)));
    }
  }
  ...
  public void indexOfLessThanEmpty() {
    for (String q : queries) {
      assertEquals(
          String.format("for query <%s>", q), -1, emptyTrieSet.indexOfLessThan(query(q), true, 0));
    }
  }
