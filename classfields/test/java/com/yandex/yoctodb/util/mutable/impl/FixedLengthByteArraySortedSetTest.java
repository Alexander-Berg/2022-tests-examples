...
public class FixedLengthByteArraySortedSetTest {
  ...
  public void indexing() {
    ...
    final ByteArraySortedSet set = new FixedLengthByteArraySortedSet(elements);
    for (int i = 0; i < size; i++) assertEquals(i, set.indexOf(from(i)));
  }
  ...
  public void expectFixed() throws IOException {
    ...
    new FixedLengthByteArraySortedSet(elements).writeTo(new ByteArrayOutputStream());
  }
