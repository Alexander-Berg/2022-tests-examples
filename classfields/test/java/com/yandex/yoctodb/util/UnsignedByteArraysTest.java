...
public class UnsignedByteArraysTest {
  ...
  public void testInt() {
    ...
    assertTrue(from(Integer.MIN_VALUE).compareTo(from(Integer.MIN_VALUE)) == 0);
    assertTrue(from(Integer.MAX_VALUE).compareTo(from(Integer.MAX_VALUE)) == 0);

    assertTrue(from(1).compareTo(from(2)) < 0);
    assertTrue(from(-2).compareTo(from(-1)) < 0);
    assertTrue(from(-1).compareTo(from(1)) < 0);
    assertTrue(from(Integer.MIN_VALUE).compareTo(from(Integer.MAX_VALUE)) < 0);
