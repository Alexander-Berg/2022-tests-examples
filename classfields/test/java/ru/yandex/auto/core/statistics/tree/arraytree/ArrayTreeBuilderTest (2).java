...
public class ArrayTreeBuilderTest {
    ...
    public void getChildrenByIntKeysTest() {
        ArrayTreeBuilder atb = new ArrayTreeBuilder(TestNodeType.values(),Collections.EMPTY_MAP,  null) {
            @Override
            protected byte[] serializeLeaf(LeafNode leafNode) {
    ...
    public void getIntKeysTest() {
        ...
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70), new int[]{104, 106, 119, 132});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, null, null), new int[]{104, 106, 119, 132});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, null, 9), new int[]{106, 119});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, null, 11), new int[]{106, 119, 132});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, 5, null), new int[]{106, 119, 132});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, 7, null), new int[]{119, 132});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, 5, 11), new int[]{106, 119, 132});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, 7, 11), new int[]{119, 132});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, 6, 11), new int[]{106, 119, 132});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, 6, 9), new int[]{106, 119});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, 6, 6), new int[]{106});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, 6, 7), new int[]{106});
        Assert.assertArrayEquals(ArrayTreeUtils.getChildrenOfIntTree(result, 70, 7, 7), new int[]{});
    }


    private static enum TestNodeType implements ArrayNodeType {L1, L2, L3;
    ...
    private TreeNodeImpl<Integer> buildSimpleTestTree() {
        TreeNodeImpl<Integer> root = new TreeNodeImpl<Integer>();
