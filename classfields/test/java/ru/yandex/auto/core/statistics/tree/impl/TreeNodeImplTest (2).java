...
public class TreeNodeImplTest {
    ...
    public void testStorage() {
        TreeNodeImpl<Integer> treeNodeImpl = new TreeNodeImpl<Integer>(new Integer[]{}, new LeafNodeImpl[]{});
    ...
    public void testSearchStorage() {
        ...
        TreeNodeImpl<Integer> nodeStorage = new TreeNodeImpl<Integer>(new Integer[]{}, new LeafNodeImpl[]{});
