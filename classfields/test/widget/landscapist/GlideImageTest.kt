...
package ru.auto.ara.test.widget.landscapist
...
import ru.auto.widget.landscapist.GlideImage
import ru.auto.widget.landscapist.GlideImageState
import ru.auto.widget.landscapist.LocalGlideRequestBuilder
import ru.auto.widget.landscapist.Reveal
import ru.auto.widget.landscapist.ShimmerParams
...
internal class GlideImageTest {
    ...
    @Test
    fun requestSuccess_withSuccessAndLoadingComposables() {
        ...
        composeTestRule.runOnIdle {
            ...
            assertThat(state[0], instanceOf(GlideImageState.Loading::class.java))
            assertThat(state[1], instanceOf(GlideImageState.Success::class.java))
        }
    }
