...
class OnlineViewTest {
    ...
    @Test
    fun shouldShowOnlineViewOnAllStateGroups() {
        performFilter {
            scrollToFilterField(FIELD_TO_SCROLL)
        }.checkResult {
            isCheckboxDisplayed(R.string.filter_online_view)
        }
    }

    @Test
    fun shouldShowOnlineViewOnNewStateGroups() {
        performFilter {
            scrollToState()
    ...
    @Test
    fun shouldShowOnlineViewOnUsedStateGroups() {
        performFilter {
            scrollToState()
