...
class TinkoffSendAnotherCarNegativeTest {
    ...
    private val webServerRule = WebServerRule {
        ...
        postPreliminary("tinkoff").watch { checkRequestWasNotCalled() }
        getTinkoffClaims("second_agreement_for_swap")
    }
    ...
    @Test
    fun shouldNotSendCarForSwapAfterClickNegativeButton() {
        performSwapCar { clickNegativeButton() }
        checkLoan { isApprovedLoanDisplayed() }
    }

    @Test
    fun shouldNotSendCarForSwapAfterClickCloseIcon() {
        performSwapCar { clickCloseIcon() }
        checkLoan { isApprovedLoanDisplayed() }
    }
