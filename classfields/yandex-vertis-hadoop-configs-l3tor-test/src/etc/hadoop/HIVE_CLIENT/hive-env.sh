...
export HADOOP_OPTS="$HADOOP_OPTS -Duser.timezone="Europe/Moscow""

if [ "$SERVICE" = "metastore" ]; then

  export HADOOP_HEAPSIZE=5120 # Setting for HiveMetastore
...
if [ "$SERVICE" = "hiveserver2" ]; then
  ...
  export HADOOP_HEAPSIZE=22000 # Setting for HiveServer2 and Client
