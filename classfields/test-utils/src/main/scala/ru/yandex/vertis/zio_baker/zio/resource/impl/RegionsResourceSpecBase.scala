...
object RegionsResourceSpecBase {
  val RussiaRegionId: GeobaseId = 225L.taggedWith[zio_baker.Tag.GeobaseId]

  val MoscowRegionId: GeobaseId = 213L.taggedWith[zio_baker.Tag.GeobaseId]
  val SpbRegionId: GeobaseId = 2L.taggedWith[zio_baker.Tag.GeobaseId]

  val CrimeaRegionId: GeobaseId = 977L.taggedWith[zio_baker.Tag.GeobaseId]
  val YaltaRegionId: GeobaseId = 11470L.taggedWith[zio_baker.Tag.GeobaseId]

  val ChechenRegionId: GeobaseId = 11024L.taggedWith[zio_baker.Tag.GeobaseId]
  val GroznyRegionId: GeobaseId = 1106L.taggedWith[zio_baker.Tag.GeobaseId]

  val KarachayCherkessRegionId: GeobaseId = 11020L.taggedWith[zio_baker.Tag.GeobaseId]
  val CherkesskRegionId: GeobaseId = 1104L.taggedWith[zio_baker.Tag.GeobaseId]
