...
import { C2bAuctionAutoAddress } from '../C2bAuctionAutoAddress/C2bAuctionAutoAddress';

import { C2bAuctionAutoForm } from './C2bAuctionAutoForm';
...
describe('C2bAuctionAutoForm', () => {
    ...
    it('кнопка активна, если заполнены все поля, включен чекбокс и выбран правильный адрес', async() => {
        ...
        const addressForm = wrapper.find(C2bAuctionAutoAddress).at(0);
