...
public class OfferCardStatisticsGraphBarsTest {
    ...
    public void shouldSeeOfferCardStatisticsBars() {
        basePageSteps.onOfferCardPage().sidebar().statistics().dataBarsExceptToday().should(hasSize(dataBarsCount));
        basePageSteps.onOfferCardPage().sidebar().statistics().dataBarsToday().should(hasSize(todayDataBarsCount));
        basePageSteps.onOfferCardPage().sidebar().statistics().noDataBars().should(hasSize(noDataBarsCount));
    }
