...
@DisplayName("Переход с «Избранное» на другие страницы ЛК через сайдбар")
@RunWith(Parameterized.class)
@GuiceModules(GeneralWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class NavigationFavoritesSidebarTest {
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("Переход с «Избранное» на другие страницы ЛК через сайдбар")
    public void shouldSeeFavoritesToOtherLkPagesFromSidebar() {
