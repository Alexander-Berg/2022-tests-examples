...
@DisplayName("Листинг с кукой «classified_listing_display_type = list»")
@RunWith(GuiceTestRunner.class)
@GuiceModules(GeneralWebModule.class)
public class ListingWithListCookieTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Отображение листинга списком на выдаче по категории, с кукой «classified_listing_display_type = list»")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Отображение листинга списком на выдаче по текстовому поиску, с кукой «classified_listing_display_type = list»")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Отображение листинга плиткой на главной, с кукой «classified_listing_display_type = list»")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Отображение листинга плиткой на профиле продавца, с кукой «classified_listing_display_type = list»")
