...
@Epic(EVENTS_FEATURE)
@DisplayName("Отправка «snippetClick», «snippetShow» с листинга категории, листинг списком")
@RunWith(GuiceTestRunner.class)
@GuiceModules(GeneralProxyWebModule.class)
public class ListListingSendEventTest {
    ...
    @DisplayName("Отправка «snippetClick» с листинга категории, листинг списком")
    public void shouldSeeSnippetClickSendEventFromListListings() {
    ...
    @DisplayName("Отправка «snippetShow» с листинга категории, листинг списком")
    public void shouldSeeSnippetShowSendEventFromListListings() {
        basePageSteps.slowScrolling(1000);
