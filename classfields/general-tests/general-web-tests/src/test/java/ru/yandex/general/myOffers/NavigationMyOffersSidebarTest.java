...
@DisplayName("Переход с «Мои объявления» на другие страницы ЛК через сайдбар")
@RunWith(Parameterized.class)
@GuiceModules(GeneralWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class NavigationMyOffersSidebarTest {
    ...
    public void shouldSeeMyOffersToOtherLkPagesFromSidebar() {
        basePageSteps.onMyOffersPage().lkSidebar().link(linkName).click();
