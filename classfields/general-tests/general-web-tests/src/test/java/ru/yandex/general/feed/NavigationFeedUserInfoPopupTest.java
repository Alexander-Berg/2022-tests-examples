...
@DisplayName("Переход с «Автозагрузка» на другие страницы ЛК через попапа «Юзер инфо»")
@RunWith(Parameterized.class)
@GuiceModules(GeneralWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class NavigationFeedUserInfoPopupTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Переход с «Автозагрузка» через ссылки из попапа «Юзер инфо» на странички ЛК")
    public void shouldSeeFeedToLkPagesFromUserInfoPopup() {
