...
public class AdultSnippetGridListingTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Отображается иконка «18+» на сниппете на главной/листинге/похожих")
    public void shouldSeeAdultAgeIcon() {
        urlSteps.open();
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Отображается кнопка «Мне уже есть 18» на сниппете на главной/листинге/похожих")
    public void shouldSeeIm18ButtonOnHover() {
        urlSteps.open();
