...
@Epic(GOALS_FEATURE)
@DisplayName("Цели на финальный шаг на форме")
@RunWith(GuiceTestRunner.class)
@GuiceModules(GeneralProxyWebModule.class)
public class FormFinalStepGoalsTest {
    ...
    public void shouldSeeFormOfferAddressMoreClickGoal() {
        offerAddSteps.fillToPublishStep();
    ...
    public void shouldSeeFormOfferAddressReadyGoal2Addresses() {
        offerAddSteps.withCategory(PERENOSKA).withAddress(ADDRESS, SECOND_ADDRESS).addOffer();
    ...
    public void shouldSeeFormOfferContentReadyGoalWorkCategory() {
        offerAddSteps.withCategory(REZUME_IN_SELLING).withName(REZUME_IN_SELLING.getTitle()).fillToAddressStep();
