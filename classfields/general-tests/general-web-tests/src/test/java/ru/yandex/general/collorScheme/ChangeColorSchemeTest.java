...
import static ru.yandex.general.page.ContactsPage.SYSTEM;
...
import static ru.yandex.general.step.BasePageSteps.SYSTEM_THEME;
...
public class ChangeColorSchemeTest {
    ...
    public void shouldSeeChangeDarkToLight() {
        basePageSteps.setCookie(CLASSIFIED_USER_THEME, DARK_THEME);
        urlSteps.open();
        basePageSteps.onContactsPage().colorSchemeSelector().click();
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Смена куки на тёмную, при установке темы")
    public void shouldSeeChangeCookieToDarkTheme() {
        basePageSteps.setCookie(CLASSIFIED_USER_THEME, LIGHT_THEME);
        urlSteps.open();
        basePageSteps.onContactsPage().colorSchemeSelector().click();
        basePageSteps.onContactsPage().popup().menuItem(DARK).click();
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Смена куки на системную, при установке темы")
    public void shouldSeeChangeCookieToSystemTheme() {
        basePageSteps.setCookie(CLASSIFIED_USER_THEME, DARK_THEME);
        urlSteps.open();
        basePageSteps.onContactsPage().colorSchemeSelector().click();
        basePageSteps.onContactsPage().popup().menuItem(SYSTEM).click();
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Смена куки на светлую, при установке темы")
    public void shouldSeeChangeCookieToLightTheme() {
        basePageSteps.setCookie(CLASSIFIED_USER_THEME, DARK_THEME);
        urlSteps.open();
        basePageSteps.onContactsPage().colorSchemeSelector().click();
        basePageSteps.onContactsPage().popup().menuItem(LIGHT).click();
