...
import ru.yandex.general.step.PaymentSteps;
...
import static ru.yandex.general.page.PaymentPage.PAYMENT_SUCCESS;
import static ru.yandex.general.page.PaymentPage.THANKS;
...
public class VasUseTest {
    ...
    public void shouldSeeVasSuccessfullFromCard() {
        ...
        offerAddSteps.onOfferCardPage().mainPhoto().waitUntil(isDisplayed());
    }
    ...
    public void shouldSeeVasSuccessfullFromLk() {
        ...
        offerAddSteps.onMyOffersPage().snippetFirst().button(RAISE_UP).click();
