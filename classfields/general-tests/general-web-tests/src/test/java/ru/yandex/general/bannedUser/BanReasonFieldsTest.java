...
import static ru.yandex.general.element.BanReason.FIRST;
import static ru.yandex.general.element.BanReason.SECOND;
...
public class BanReasonFieldsTest {
    ...
    public void shouldSeeBanMessageTitle1Reason() {
        ...
        basePageSteps.onBasePage().banMessage().title().should(hasText("Личный кабинет заблокирован по 1 причине"));
    }
    ...
    public void shouldSeeBanMessageTitle2Reason() {
        ...
        basePageSteps.onBasePage().banMessage().title().should(hasText("Личный кабинет заблокирован по 2 причинам"));
    }
    ...
    public void shouldSeeReasonTitle() {
        ...
        basePageSteps.onBasePage().banMessage().banReasons().get(FIRST).title()
    ...
    public void shouldSeeReasonDescription() {
        ...
        basePageSteps.onBasePage().banMessage().banReasons().get(FIRST).description()
    ...
    public void shouldSeeSecondReasonTitle() {
        ...
        basePageSteps.onBasePage().banMessage().banReasons().get(SECOND).title()
    ...
    public void shouldSeeSecondReasonDescriptions() {
        ...
        basePageSteps.onBasePage().banMessage().banReasons().get(SECOND).description()
    ...
    public void shouldSeeBanMessageChatWithSupportLink() {
        ...
        basePageSteps.onBasePage().banMessage().chatWithSupport().link().should(hasAttribute(HREF, SUPPORT_LINK));
    }
