...
@DisplayName("Смена оповещения сохраненного поиска")
@RunWith(Parameterized.class)
@GuiceModules(GeneralWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class FavoriteSearchNotificationsSaveTest {
    ...
    @Parameterized.Parameters(name = "Оповещение сохраненного поиска, смена на «{0}»")
    ...
    public void shouldSeeSearchNotificationChange() {
        ...
        basePageSteps.onFavoritesPage().popup().menuItem(nameInPopup).waitUntil(isDisplayed()).click();
