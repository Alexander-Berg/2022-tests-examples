...
public class FavoriteSearchNotificationsTest {
    ...
    @Parameterized.Parameters(name = "Оповещение сохраненного поиска «{0}»")
    ...
    public void before() {
        ...
        mockRule.graphqlStub(mockResponse()
                .setFavorites(favoritesResponse().searches(asList(
                        mockBasicSearch().addNotification(notification))).build())
