...
@DisplayName("Переход с «Статистика» на другие страницы ЛК через попапа «Юзер инфо»")
@RunWith(Parameterized.class)
@GuiceModules(GeneralWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class NavigationStatisticsUserInfoPopupTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Переход с «Статистика» через ссылки из попапа «Юзер инфо» на странички ЛК")
    public void shouldSeeStatisticsToLkPagesFromUserInfoPopup() {
