...
@DisplayName("Переход с «Автозагрузка» на другие страницы ЛК через сайдбар")
@RunWith(Parameterized.class)
@GuiceModules(GeneralWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class NavigationFeedSidebarTest {
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("Переход с «Автозагрузка» на другие страницы ЛК через сайдбар")
    public void shouldSeeFeedToOtherLkPagesFromSidebar() {
