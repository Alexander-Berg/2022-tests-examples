...
public class MockRuleWithoutWebdriver extends ExternalResource {
    ...
    public MockRuleWithoutWebdriver graphqlStub(String toResponseResource) {
    ...
    public MockRuleWithoutWebdriver transparent(String from, String to) {
    ...
    public MockRuleWithoutWebdriver withDefaults() {
