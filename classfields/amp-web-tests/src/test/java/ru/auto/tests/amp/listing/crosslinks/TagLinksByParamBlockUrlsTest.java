...
public class TagLinksByParamBlockUrlsTest {
    ...
    public static Collection<Object[]> getParameters() {
        return asList(new Object[][]{
                {"/moskva/amp/cars/all/", "Компактные автомобили", "/tag/compact/"},
                {"/leningradskaya_oblast/amp/cars/all/", "Семиместные семейные автомобили", "/tag/7seatsfamily/"},
        });
    }
    ...
    public void before() {
        ...
        basePageSteps.onListingPage().tagsBlock().waitUntil(isDisplayed());
    }
