...
public class SellerProfileFieldsTest {
    ...
    public void shouldSeeSellerName() {
        ...
        basePageSteps.onProfilePage().userInfo().sellerName().should(hasText(SELLER_NAME));
    }
    ...
    public void shouldSeeSellerAvatar() {
        ...
        basePageSteps.onProfilePage().userInfo().image().should(hasAttribute(SRC, AVATAR_URL));
    }
    ...
    public void shouldSeeSellerNoAvatar() {
        ...
        basePageSteps.onProfilePage().userInfo().image().should(hasAttribute(SRC, AVATAR_DUMMY_IMG_URL));
    }
    ...
    public void shouldSeeSellerFollowers() {
        ...
        basePageSteps.onProfilePage().userInfo().followersCount().should(hasText(String.valueOf(count)));
    }
    ...
    public void shouldSeeSellerFollowing() {
        ...
        basePageSteps.onProfilePage().userInfo().followingCount().should(hasText(String.valueOf(count)));
    }
