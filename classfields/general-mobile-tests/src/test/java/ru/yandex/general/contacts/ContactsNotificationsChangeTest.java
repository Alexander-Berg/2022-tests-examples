...
public class ContactsNotificationsChangeTest {
    ...
    public void shouldSeeNewsAndAdsPush() {
        ...
        basePageSteps.onContactsPage().notificationSettings(NEWS_AND_ADS).row(PUSH_ROW).checkboxEmptyLabel().click();
    ...
    public void shouldSeeNewsAndAdsEmail() {
        ...
        urlSteps.open();
        basePageSteps.onContactsPage().spanLink(NOTIFICATIONS).click();
        basePageSteps.onContactsPage().notificationSettings(NEWS_AND_ADS).row(EMAIL_ROW).checkboxEmptyLabel().click();
    ...
    public void shouldSeeChatSettingsEmail() {
        ...
        urlSteps.open();
        basePageSteps.onContactsPage().spanLink(NOTIFICATIONS).click();
        basePageSteps.onContactsPage().notificationSettings(UNREAD_CHAT_MESSAGES).row(EMAIL_ROW).checkboxEmptyLabel().click();
    ...
    public void shouldSeeChatSettingsSms() {
        ...
        urlSteps.open();
        basePageSteps.onContactsPage().spanLink(NOTIFICATIONS).click();
        basePageSteps.onContactsPage().notificationSettings(UNREAD_CHAT_MESSAGES).row(SMS_ROW).checkboxEmptyLabel().click();
