...
public class ListListingSendEventTest {
    ...
    public void before() {
        ...
        mockRule.graphqlStub(mockResponse()
                .setSearch(listingCategoryResponse().offers(
                        asList(mockSnippet(BASIC_SNIPPET).getMockSnippet().setPrice(PRICE).setId(ID)
    ...
    @DisplayName("Отправка «snippetClick» с листинга списком")
    public void shouldSeeSnippetClickListListingSendEvent() {
    ...
    @DisplayName("Отправка «snippetShow» с листинга списком")
    public void shouldSeeSnippetShowListListingSendEvent() {
