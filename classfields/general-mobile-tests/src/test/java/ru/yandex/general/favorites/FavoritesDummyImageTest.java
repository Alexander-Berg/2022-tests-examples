...
public class FavoritesDummyImageTest {
    ...
    @DisplayName("Заглушка фото сохраненного поиска")
    public void shouldSeeFavoriteSearchDummyImg() {
        urlSteps.queryParam(TAB_PARAM, SEARCHES_TAB_VALUE).open();

        basePageSteps.onFavoritesPage().firstFavCard().searchDummyImg().should(isDisplayed());
    }
