...
@Epic(GOALS_FEATURE)
@Feature(CHAT_INIT)
@DisplayName("Нет цели «CHAT_INIT» для старого чата")
@RunWith(Parameterized.class)
@GuiceModules(GeneralProxyMobileWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class FavoritesNoChatInitOldChatGoalTest {
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("Нет цели «CHAT_INIT» для старого чата")
    public void shouldNotSeeFavoritesChatInitGoalOldChat() {
        basePageSteps.onFavoritesPage().firstFavCard().button(WRITE).hover().click();
