...
public class ListingAppSplashTest {

    private static final String SPLASH_LINK = "https://redirect.appmetrica.yandex.com/serve/387432876397905378/?afpub_id=list";
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Ссылка сплэш баннера установки приложения на листинге категории")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Устанавливается кука «APP_SPLASH_SHOWN = seen» при показе сплэш баннера на листинге категории")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Не отображается сплэш баннер с кукой «APP_SPLASH_SHOWN = seen» на листинге категории")
