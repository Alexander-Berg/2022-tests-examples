...
import static ru.yandex.general.mobile.page.ProfilePage.ACTIVE;
...
@DisplayName("Страница профиля без таба «Активные»")
@RunWith(GuiceTestRunner.class)
@GuiceModules(GeneralMobileWebModule.class)
public class SellerProfileWithoutActiveTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Нет таба «Активные»")
    public void shouldNotSeeActive() {
        basePageSteps.onProfilePage().tab(ACTIVE).should(not(isDisplayed()));
    }

    @Test
    @Owner(ALEKS_IVANOV)
    @Feature(SCREENSHOT_TESTS)
    @DisplayName("Скриншот страницы профиля без таба «Активные»")
    public void shouldSeeProfileScreenshotWithoutActive() {
