...
public class SeoJobPostingLdJsonCardMarkingTest {
    ...
    public void shouldSeeCardLdJsonMarkingWithAllFields() {
        ...
        String actualJobPostingMark = jSoupSteps.getLdJsonMark(JOB_POSTING);
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("LD-JSON разметка для карточке вакансии, нет зарплаты и описания, указан район")
