...
public class ListListingAddOfferToFavoritesTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @Feature(ADD_OFFER_TO_FAVORITES)
    @DisplayName("Отправка «addOfferToFavorites» с листинга списком")
    public void shouldSeeAddOfferToFavoritesListListingSendEvent() {
