...
public class SellerProfileOwnerTest {
    ...
    public void shouldSeeUrlAfterEditClickOwner() {
        ...
        basePageSteps.onProfilePage().button(EDIT).click();
    ...
    public void shouldSeeNoEditForNotOwner() {
        ...
        basePageSteps.onProfilePage().button(EDIT).should(not(isDisplayed()));
    }
    ...
    public void shouldSeeNoSubscribeForOwner() {
        ...
        basePageSteps.onProfilePage().button(SUBSCRIBE).should(not(isDisplayed()));
    }
