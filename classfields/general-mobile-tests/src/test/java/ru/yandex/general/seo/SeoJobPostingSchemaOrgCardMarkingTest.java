...
public class SeoJobPostingSchemaOrgCardMarkingTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Schema.org разметка для карточке вакансии, есть зарплата и описание, указан адрес")
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Schema.org разметка для карточке вакансии, нет зарплаты и описания, указан район")
