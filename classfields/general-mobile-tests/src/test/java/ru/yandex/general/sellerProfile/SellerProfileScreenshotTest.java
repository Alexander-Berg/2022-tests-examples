...
public class SellerProfileScreenshotTest {
    ...
    @Parameterized.Parameters(name = "Скриншот профиля. Тема «{0}»")
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("Скриншот страницы профиля, светлая/темная темы на разных разрешениях")
    public void shouldSeeProfileScreenshotFullPage() {
