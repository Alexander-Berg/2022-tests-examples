...
public class SnippetDeleteBannedOfferTest {
    ...
    public void shouldSeeDeleteBannedOffer() {
        ...
        basePageSteps.onMyOffersPage().popup().spanLink(DELETE).waitUntil(isDisplayed()).click();
        basePageSteps.onMyOffersPage().popup().button(DELETE).waitUntil(isDisplayed()).click();
