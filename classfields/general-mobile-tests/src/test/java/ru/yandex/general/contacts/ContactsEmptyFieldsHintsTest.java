...
public class ContactsEmptyFieldsHintsTest {
    ...
    public void shouldSeeClearNameHint() {
        basePageSteps.onContactsPage().field(NAME).setInput("");
        basePageSteps.onContactsPage().pageTitle().click();
    ...
    public void shouldSeeClearAddressHint() {
        ...
        basePageSteps.onContactsPage().wrapper(ADDING_ADDRESS).setTextarea("");
        basePageSteps.onContactsPage().wrapper(ADDING_ADDRESS).closePopup().click();
