...
public class ListingSortUrlTest {
    ...
    public void shouldSeeSortValue() {
        ...
        basePageSteps.onListingPage().filters().checkboxWithLabel(sortName).click();
    ...
    public void shouldSeeSortName() {
        ...
        basePageSteps.onListingPage().searchBar().filters().click();
        basePageSteps.onListingPage().filters().activeSort().should(hasText(sortName));
    }
