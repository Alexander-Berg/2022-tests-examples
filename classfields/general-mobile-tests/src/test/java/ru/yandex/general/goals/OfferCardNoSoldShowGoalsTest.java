...
@Epic(GOALS_FEATURE)
@DisplayName("Нет цели «CARD_OFFER_SOLD_SHOW», при показе карточки не проданного оффера для покупателя/продавца")
@RunWith(Parameterized.class)
@GuiceModules(GeneralProxyMobileWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class OfferCardNoSoldShowGoalsTest {
    ...
    @DisplayName("Нет цели «CARD_OFFER_SOLD_SHOW», при показе карточки не проданного оффера для продавца")
    public void shouldSeeNoCardOfferSoldShowGoalOnOpenCardOwner() {
    ...
    @Owner(ALEKS_IVANOV)
    @Feature(CARD_OFFER_SOLD_SHOW)
    @DisplayName("Нет цели «CARD_OFFER_SOLD_SHOW», при показе карточки не проданного оффера для покупателя")
    public void shouldSeeNoCardOfferSoldShowGoalOnOpenCardBuyer() {
        mockRule.graphqlStub(mockResponse
