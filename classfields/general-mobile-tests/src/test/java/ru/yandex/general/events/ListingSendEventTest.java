...
@Epic(EVENTS_FEATURE)
@DisplayName("Отправка «snippetClick», «snippetShow» с разных типов листингов")
@RunWith(Parameterized.class)
@GuiceModules(GeneralProxyMobileWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class ListingSendEventTest {
    ...
    @Before
    public void before() {
        urlSteps.testing().path(SANKT_PETERBURG).path(path);
    ...
    @DisplayName("Отправка «snippetClick» с разных типов листингов")
    public void shouldSeeSnippetClickSendEventFromListings() {
    ...
    @DisplayName("Отправка «snippetShow» с разных типов листингов")
    public void shouldSeeSnippetShowSendEventFromListings() {
