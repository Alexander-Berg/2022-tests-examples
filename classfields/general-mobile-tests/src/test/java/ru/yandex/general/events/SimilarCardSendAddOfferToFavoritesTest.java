...
@DisplayName("Отправка «addOfferToFavorites» с листинга похожих офферов")
@RunWith(GuiceTestRunner.class)
@GuiceModules(GeneralProxyMobileWebModule.class)
public class SimilarCardSendAddOfferToFavoritesTest {
    ...
    public void before() {
        ...
        urlSteps.testing().path(CARD).path(CARD_ID).path(SLASH).open();
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("Отправка «addOfferToFavorites» с листинга похожих офферов")
    public void shouldSeeAddOfferToFavoritesSendEventFromSimilarCardListing() {
