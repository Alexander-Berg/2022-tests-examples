...
public class ContactsFieldsTest {
    ...
    public void shouldSeeNameInSidebar() {
        basePageSteps.onContactsPage().userInfo().userName().should(hasText(USER_NAME));
    }
    ...
    public void shouldSeeEmailInSidebar() {
        basePageSteps.onContactsPage().userInfo().userEmail().should(hasText(USER_EMAIL));
    }
    ...
    public void shouldSeeUserId() {
        basePageSteps.onContactsPage().userInfo().userId().should(hasText(format("ID %s", USER_ID)));
    }
