...
public class OfferCardPriceBuyerTest {
    ...
    public void shouldSeePrice() {
        ...
        basePageSteps.onOfferCardPage().priceBuyer().should(hasText("3 600 ₽"));
    }
    ...
    public void shouldSeeFreePrice() {
        ...
        basePageSteps.onOfferCardPage().priceBuyer().should(hasText("Даром"));
    }
    ...
    public void shouldSeeNoPrice() {
        ...
        basePageSteps.onOfferCardPage().priceBuyer().should(hasText("Не указана"));
    }
    ...
    public void shouldSeeSallary() {
        ...
        basePageSteps.onOfferCardPage().priceBuyer().should(hasText("120 000 ₽"));
    }
