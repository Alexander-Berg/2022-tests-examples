...
public class FormCategoryChoseEventTest {
    ...
    public void shouldSeeCategoryChosenEventFromWithChoose() {
        ...
        offerAddSteps.fillToCategoryStep();
        offerAddSteps.onFormPage().categorySelect().spanLink(SADOVII_INVENTAR.getCategoryName()).click();
        offerAddSteps.onFormPage().link("Лопаты и движки для снега").waitUntil(isDisplayed()).click();
