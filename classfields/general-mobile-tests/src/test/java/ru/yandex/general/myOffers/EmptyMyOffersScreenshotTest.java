...
@DisplayName("Скриншотный тест пустой страницы моих объявлений")
@RunWith(Parameterized.class)
@GuiceModules(GeneralMobileWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class EmptyMyOffersScreenshotTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Скриншот пустой страницы моих объявлений, светлая/темная темы")
    public void shouldSeeEmptyMyOffersScreenshot() {
