...
@Epic(EVENTS_FEATURE)
@DisplayName("Отправка «addOfferToFavorites», «chatInit», карточка с разными типами price")
@RunWith(Parameterized.class)
@GuiceModules(GeneralProxyMobileWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class OfferCardDifferentPriceTypesAuthorizedSendEventsTest {
    ...
    @DisplayName("Отправка «addOfferToFavorites» с карточки оффера, с разными типами price")
    public void shouldSeeAddOfferToFavoritesSendEventOnCardPriceTypes() {
        basePageSteps.onOfferCardPage().addToFavorite().click();

        event.setEventInfo(eventInfo().setAddOfferToFavorites(addOfferToFavorites().setOffer(eventOffer)));
    ...
    @DisplayName("Отправка «chatInit» с карточки оффера, с разными типами price")
    public void shouldSeeChatInitSendEventOnCardPriceTypes() {
        basePageSteps.onOfferCardPage().button(WRITE).click();

        event.setEventInfo(eventInfo().setChatInit(chatInit().setOffer(eventOffer)));
