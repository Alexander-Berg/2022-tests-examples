package ru.yandex.general.errors;
...
import static ru.yandex.general.consts.GeneralFeatures.ERRORS;
import static ru.yandex.general.consts.GeneralFeatures.SCREENSHOT_TESTS;
import static ru.yandex.general.consts.Owners.ALEKS_IVANOV;
import static ru.yandex.general.consts.Pages.OFFER;
...
@DisplayName("Скриншот 404 ошибки")
@RunWith(Parameterized.class)
@GuiceModules(GeneralMobileWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class Error404ScreenshotTest {
    ...
    public void before() {
        ...
        urlSteps.testing().path(OFFER).open();
    }

    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Скриншот 404 ошибки, светлая/темная темы")
