...
public class VasGoalsTest {
    ...
    public void shouldSeeProfileListingVasTopBuyFromLkSnippet() {
        ...
        basePageSteps.scrollingToElement(basePageSteps.onMyOffersPage().snippetFirst().button(RAISE_UP_FOR));
        basePageSteps.onMyOffersPage().snippetFirst().button(RAISE_UP_FOR).click();
