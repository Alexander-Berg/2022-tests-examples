...
@DisplayName("Форма подачи оффера. Скриншот блока пресетов.")
@RunWith(Parameterized.class)
@GuiceModules(GeneralMobileWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class AddOfferPresetsScreenshotTest {
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Форма подачи оффера. Скриншот блока пресетов, светлая/темная темы")
