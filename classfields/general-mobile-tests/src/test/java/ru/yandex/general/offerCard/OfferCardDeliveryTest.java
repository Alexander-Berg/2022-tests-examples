...
import static ru.yandex.general.mobile.page.OfferCardPage.DELIVERY_RUSSIA;
import static ru.yandex.general.mobile.page.OfferCardPage.DELIVERY_TAXI;
...
public class OfferCardDeliveryTest {
    ...
    public void shouldSeeCourierDelivery() {
        ...
        basePageSteps.onOfferCardPage().deliveryBadge(DELIVERY_TAXI).should(isDisplayed());
        basePageSteps.onOfferCardPage().deliveryBadge(DELIVERY_RUSSIA).should(not(isDisplayed()));
    }
    ...
    public void shouldSeeRussiaDelivery() {
        ...
        basePageSteps.onOfferCardPage().deliveryBadge(DELIVERY_RUSSIA).should(isDisplayed());
        basePageSteps.onOfferCardPage().deliveryBadge(DELIVERY_TAXI).should(not(isDisplayed()));
    }
    ...
    public void shouldNotSeeDeliveryBadges() {
        ...
        basePageSteps.onOfferCardPage().deliveryBadge().should(not(isDisplayed()));
    }
