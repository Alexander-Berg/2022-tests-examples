...
public class OfferCardComplainRequestTest {
    ...
    public void shouldSeeSendedComplainWithMessage() {
        ...
        basePageSteps.wait500MS();
        basePageSteps.onOfferCardPage().popup().button(NEXT).click();
        basePageSteps.onOfferCardPage().popup().textarea().sendKeys(TEXT);
        basePageSteps.onOfferCardPage().popup().button(SEND).click();
    ...
    public void shouldSeeSendedComplainFraudWithoutMessage() {
        basePageSteps.onOfferCardPage().popup().radioButtonWithLabel("Мошенник").waitUntil(isDisplayed()).hover().click();
        basePageSteps.wait500MS();
        basePageSteps.onOfferCardPage().popup().button(NEXT).click();
        basePageSteps.onOfferCardPage().popup().button(SEND).click();
    ...
    private CreateComplaint getComplaint() {
        return createComplaint().setPlacement("offerCard").setApplication("Touch")
