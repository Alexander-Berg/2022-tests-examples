...
import static ru.yandex.general.mobile.page.ListingPage.MORE_OFFERS_AUTORU;
...
public class TextSearchAutoTest {
    ...
    public static final String MOBILE_AUTORU_CARS_ALL_LINK = "https://m.test.avto.ru/moskva/cars/all/?from=classified&sort_offers=fresh_relevance_1-DESC&utm_content=search_results&utm_source=yandex_ads";
    ...
    @Test
    @Owner(ALEKS_IVANOV)
    @DisplayName("Текстовый поиск для получения выдачи авто, есть чипсина «Категория поиска: Авто»")
    ...
    public void shouldSeeMoreAutoOffersLink() {
        ...
        basePageSteps.onListingPage().link(MORE_OFFERS_AUTORU).should(hasAttribute(HREF, MOBILE_AUTORU_CARS_ALL_LINK));
    }
