...
public class BanReasonScreenshotTest {
    ...
    public void shouldSeeBanMessageScreenshot() {
        urlSteps.open();
        Screenshot testing = compareSteps.takeScreenshot(basePageSteps.onMyOffersPage().banMessage());

        urlSteps.setProductionHost().open();
        Screenshot production = compareSteps.takeScreenshot(basePageSteps.onMyOffersPage().banMessage());
