...
public class OfferCardSellerInfoTest {
    ...
    public void shouldSeeSellerLink() {
        ...
        basePageSteps.onOfferCardPage().sellerInfo().link().should(
    ...
    public void shouldSeeSellerName() {
        ...
        basePageSteps.onOfferCardPage().sellerInfo().name().should(hasText(NAME));
    }
    ...
    public void shouldSeeSellerOfferCount() {
        ...
        basePageSteps.onOfferCardPage().sellerInfo().offersCount().should(
    ...
    public void shouldSeeSellerAvatar() {
        ...
        basePageSteps.onOfferCardPage().sellerInfo().image().should(hasAttribute(SRC, containsString(AVATAR_IMG)));
    }
    ...
    public void shouldSeeSellerAvatarDummyImg() {
        ...
        basePageSteps.onOfferCardPage().sellerInfo().image().should(hasAttribute(SRC, containsString(DUMMY_IMG)));
    }
