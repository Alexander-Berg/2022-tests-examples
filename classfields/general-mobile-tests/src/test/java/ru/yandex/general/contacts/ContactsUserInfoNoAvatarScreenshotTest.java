...
@DisplayName("Скриншот заглушки аватара на странице контактов, светлая/темная темы")
@RunWith(Parameterized.class)
@GuiceModules(GeneralMobileWebModule.class)
@Parameterized.UseParametersRunnerFactory(GuiceParametersRunnerFactory.class)
public class ContactsUserInfoNoAvatarScreenshotTest {
    ...
    @Owner(ALEKS_IVANOV)
    @DisplayName("Скриншот заглушки аватара на странице контактов, светлая/темная темы")
    public void shouldSeeWithoutAvatarScreenshot() {
        Screenshot testing = compareSteps.takeScreenshot(basePageSteps.onContactsPage().userInfo().avatar());

        urlSteps.setProductionHost().open();
        Screenshot production = compareSteps.takeScreenshot(basePageSteps.onContactsPage().userInfo().avatar());
