...
public class StatisticsBarsDifferentPeriodTest {
    ...
    public void shouldSeeBarsCount() {
        ...
        basePageSteps.onStatisticsPage().popup(VIEWS).stats().emptyBars().should(hasSize(0));
        basePageSteps.onStatisticsPage().popup(VIEWS).stats().notEmptyBars().should(hasSize(daysCount));
    }
