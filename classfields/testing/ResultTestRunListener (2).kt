...
/**
 * @author rogovalex on 2019-10-31.
 */
class ResultTestRunListener(
    ...
    private val retryFilters = listOf(
        ...
        { trace: String -> trace.startsWith(ROOT_EXCEPTION) },
    )
    private val testsToRetry = HashSet<TestIdentifier>()

    override fun getPropertiesAttributes(): MutableMap<String, String> {
        return runResult.runFailureMessage?.let { mutableMapOf("testRunFailed" to it) }
            ?: super.getPropertiesAttributes()
    }
    ...
    companion object {
        ...
        private const val ROOT_EXCEPTION =
            "androidx.test.espresso.base.RootViewPicker\$RootViewWithoutFocusException: Waited"
    }
}
