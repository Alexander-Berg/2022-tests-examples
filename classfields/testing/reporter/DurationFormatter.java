...
// This class was copied from gradle 5.x, as it was removed in gradle 6.x
public class DurationFormatter {
    ...
    public String format(long duration) {
        if (duration == 0L) {
            ...
            result.append(BigDecimal.valueOf(duration).divide(BigDecimal.valueOf(MILLIS_PER_SECOND)).setScale(secondsScale, 4));
            result.append("s");
