...
$domain = 'test.avto.ru';  // главные тестовый домен
$mainHost = '.' . $domain;
...
$adminConfig = [
    ...
    'log_dir'            => '/var/log/php-fpm/autoru-backend-octopus/',
    ...
    'img'                => [
        ...
        'storage_mds'   => [ // https://beta.wiki.yandex-team.ru/mds/#Интерфейс доступа к данным хранилища
            'write'             => ['host' => 'storage-int.mds.yandex.net', 'port' => 1111],
            'read_int'          => ['host' => 'storage-int.mds.yandex.net', 'port' => 80],
            'read_int_secure'   => ['host' => 'storage-int.mds.yandex.net', 'port' => 443],
            'read'              => ['host' => 'storage.mds.yandex.net',     'port' => 80],
            'read_secure'       => ['host' => 'storage.mds.yandex.net',     'port' => 443],
        ],
...
//        'host'        => 'img.' . $developer . $mainHost,                           // Основная часть генерируемого доменного имени хоста картинок
    ...
    'captcha7'           => [
        ...
        'form_url'          => 'https://captcha.auto.ru/',
        'default_back_url' => 'https://auto.ru/'
    ],
    ...
    // Вертикальные подписки
    'vertisubs_url' => 'http://csbo1ft.yandex.ru:36134',
    // Рассылятор
    'sender' => [
        'api_url' => 'https://test.sender.yandex-team.ru',
        'account_name' => 'autoru'
    ],
    // endregion
    // Видео
    'yandex_video' => [
        'api_domain' => 'http://api.vd.yandex.net:8080/v1/',
        'embed_url' => '//video.vd.yandex.ru/iframe/office-autoru/',
        'streaming_url' => 'http://streaming.video.vd.yandex.ru/get/office-autoru/',
        'provider' => 'yandex_dev',
    ],
];
