...
import VinReportPreviewDesktop from './VinReportPreviewDesktop';
...
it('должен передавать правильный from для покупки отчёта в десктопе', () => {
    const wrapper = shallow(
        <VinReportPreviewDesktop
    ...
    expect(wrapper.find('CardVinReportButtons').props().from).toEqual('vincheck');
});
