...
final class ReferralProgramFeedbackTest: LocalMockTestCase {
    ...
    func testFeedbackRatingBlockWithPlusBefore3000() {
        Allure.addTestPalmLink("https://testpalm.yandex-team.ru/testcase/bluemarketapps-4491")
    ...
    func testFeedbackRatingBlockWithPlusAfter3000() {
        Allure.addTestPalmLink("https://testpalm.yandex-team.ru/testcase/bluemarketapps-4492")
        Allure.addEpic("Реферальная программа")
        Allure.addFeature("Отзыв")
...
extension ReferralProgramFeedbackTest: ReferralProgramMockHelper {}

extension ReferralProgramFeedbackTest {
...
private extension ReferralProgramFeedbackTest {
