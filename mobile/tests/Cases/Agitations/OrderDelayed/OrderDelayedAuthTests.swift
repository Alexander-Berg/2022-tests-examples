...
final class OrderDelayedAuthTests: AgitationsAuthTestCase {
    ...
    func test_OrderDelayed_OpenChat() {
        Allure.addTestPalmLink("https://testpalm.yandex-team.ru/testcase/bluemarketapps-4378")
        Allure.addEpic("Информирование и подтверждение пользователем переноса доставки в DSBS")
        Allure.addTitle("Продавец не доставит вовремя + чат")
