...
final class SKUCardModelTransitionToCartAuth: LocalMockTestCase {
    ...
    func testAuthorizedUser() {
        Allure.addTestPalmLink("https://testpalm.yandex-team.ru/testcase/bluemarketapps-1013")
        Allure.addEpic("КМ")
        Allure.addFeature("Переход в корзину")
        Allure.addTitle("Проверяем переход в корзину при добавлении товара у пользователя, залогиненного в приложении")
