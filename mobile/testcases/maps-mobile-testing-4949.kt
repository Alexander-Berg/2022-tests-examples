...
// https://testpalm.yandex-team.ru/testcase/maps-mobile-testing-4949
private val TEST_CASE_LINK = TestCaseLink("TEST-CASE-4949", "https://testpalm.yandex-team.ru/testcase/maps-mobile-testing-4949")

internal class MapsMobileTesting4949 : TestCaseBasedTest("Построение автомаршрута", TEST_CASE_LINK) {
    ...
    override fun TestCaseDsl.run() {
        ...
        perform("Выбрать тип транспортного средства - Автомобиль") {
