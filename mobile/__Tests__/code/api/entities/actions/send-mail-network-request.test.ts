...
import { SendMailNetworkRequest } from '../../../../../code/api/entities/actions/send-mail-network-request'
...
describe(SendMailNetworkRequest, () => {
  it('should build Send Mail request', () => {
    const mailSendRequest: MailSendRequest = new MailSendRequestBuilder()
      ...
      .build()
    const request = new SendMailNetworkRequest(mailSendRequest)
