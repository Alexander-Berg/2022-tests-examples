...
/**
 * Version of FragmentController that can be used for androidx.fragment.app.Fragment. Only
 * necessary if more complex lifecycle management is needed, otherwise SupportFragmentTestUtil
 * should be sufficient.
 *
 * Wait until https://github.com/robolectric/robolectric/issues/3985 will be done
 */
