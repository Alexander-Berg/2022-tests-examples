...
public class AcceptTheirsRecordMergeStrategyTest {
    ...
    public void test_WithoutNewCollection_WithoutChanges_WithoutSnapshot_WithoutLocalChanges()
        ...
        final MergeStrategy mergeStrategy = new AcceptTheirsRecordMergeStrategy(MOCK_CONTEXT,
                                                                                MOCK_DATABASE_ID,
                                                                                MOCK_REVISION,
                                                                                databaseManager,
                                                                                api,
    ...
    public void test_WithoutNewCollection_WithoutChanges_WithoutSnapshot_WithLocalChanges()
        ...
        final ChangesRequest expectedChangeRequest =
                getChangesFromFile("merge/TheirsRecord/expected_changes.json");
    ...
    public void test_WithoutNewCollection_WithChanges_WithoutSnapshot_WithLocalChanges()
        ...
        final ChangesRequest expectedChangeRequest =
                getChangesFromFile("merge/TheirsRecord/intersected_changes.json");
