...
public class AcceptMineCollectionsMergeStrategyTest {
    ...
    public void setUp() throws Exception {
        ...
        when(api.postChanges(eq(MOCK_CONTEXT),
                             ...
                             anyLong(),
                             any()))
                .thenReturn(getApplyChangesRequest());
    }
    ...
    public void test_WithoutNewCollection_WithoutChanges_WithoutSnapshot_WithoutLocalChanges()
        ...
        final MergeStrategy mergeStrategy = new AcceptMineCollectionsMergeStrategy(MOCK_CONTEXT,
                                                                                   MOCK_DATABASE_ID,
                                                                                   MOCK_REVISION,
                                                                                   databaseManager,
                                                                                   api,
    ...
    public void test_WithoutNewCollection_WithoutChanges_WithoutSnapshot_WithLocalChanges()
        ...
        final ChangesRequest expectedChangeRequest =
                getChangesFromFile("merge/MineCollection/expected_changes.json");
    ...
    public void test_WithoutNewCollection_WithChanges_WithoutSnapshot_WithLocalChanges()
        ...
        final ChangesRequest expectedChangeRequest =
                getChangesFromFile("merge/MineCollection/intersected_changes.json");
    ...
    private DeltasResponse getDeltasFromFile(@NonNull final String fileName) throws IOException {
        return new Moshi.Builder().build().adapter(DeltasResponse.class)
                .fromJson(getTextFromFile(fileName));
    }

    private SnapshotResponse getSnapshotFromFile(@NonNull final String fileName)
            throws IOException {
    ...
    private ApplyChangesResponse getApplyChangesRequest() throws IOException {
        final ApplyChangesResponse applyChangesResponse =
                new Moshi.Builder().build().adapter(ApplyChangesResponse.class)
                        .fromJson(getTextFromFile("merge/apply_changes.json"));
        applyChangesResponse.setRevision(MOCK_REVISION_2);
        return applyChangesResponse;
    }

    private ChangesRequest getChangesFromFile(@NonNull final String fileName) throws IOException {
