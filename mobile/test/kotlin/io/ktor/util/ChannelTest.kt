...
class ChannelTest {
    ...
    @Test
    fun testCopyToBoth() = runBlocking(EmptyCoroutineContext) {
    ...
    @Test
    fun testCopyToBothCancelSource() = runBlocking(EmptyCoroutineContext) {
        val source = ByteChannel()
        val first = ByteChannel()
        val second = ByteChannel()
    ...
    @Test
    fun testCopyToBothCancelFirstReader() = runBlocking(EmptyCoroutineContext) {
        val data = ByteArray(16 * 1024) { it.toByte() }
        val source = ByteChannel()
        val first = ByteChannel()
        val second = ByteChannel()
    ...
    @Test
    fun testCopyToBothCancelSecondReader() = runBlocking(EmptyCoroutineContext) {
        val data = ByteArray(16 * 1024) { it.toByte() }
        val source = ByteChannel()
        val first = ByteChannel()
        val second = ByteChannel()
