...
class KHorizontalPriceRedesignView : KBaseCompoundView<KHorizontalPriceRedesignView>, PriceViewAssertions {
    ...
    override val currentPrice = KTextView {
        isDescendantOfA { withMatcher(this@KHorizontalPriceRedesignView.parentMatcher) }
