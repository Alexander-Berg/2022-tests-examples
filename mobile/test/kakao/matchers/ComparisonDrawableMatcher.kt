...
class ComparisonDrawableMatcher(
    ...
    override fun describeTo(description: Description) {
        description.appendText("Comparison item visible and " + (if (isSelected) "" else "not ") + "added to comparison")
    }

    override fun matchesSafely(view: View): Boolean {
        val id = if (isSelected) R.drawable.ic_compare_18_active else R.drawable.ic_compare_18
