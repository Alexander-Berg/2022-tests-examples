...
class OnboardingProUserTest {
    ...
    fun shouldEnableAutouploadViaUnlimOnboarding() {
        ...
        onSettings.disablePhotoAndVideoAutoupload()
        ...
        onLogin.shouldDisplayPhotonAndVideoUnlimWizard()
        onLogin.actionWizardButtonClick()
        onLogin.closeWizards()
        onBasePage.openSettings()
        onSettings.openAutouploadSettings()
        onSettings.shouldAutouploadBeEnabled()
        onSettings.shouldAutouploadOverMobileNetworkBeDisabled()
    }
}
