...
public open class AllMailTests private constructor() {
    private val registry: TestsRegistry<MailboxBuilder> = TestsRegistry<MailboxBuilder>()
    private fun registerAllTestsAndGetThem(): TestsRegistry<MailboxBuilder> {
