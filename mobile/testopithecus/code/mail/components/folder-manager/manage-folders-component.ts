...
export class ManageFoldersComponent implements MBTComponent {
  public static readonly type: string = 'ManageFoldersComponent'
  ...
  public async assertMatches(model: App, application: App): Throwing<Promise<void>> {
    ...
    if (manageableFolderModel !== null && manageableFolderApplication !== null) {
      const folderListModel = manageableFolderModel
        .getFolderListForManageFolderScreen()
...
export class ManageFoldersActions implements MBTComponentActions {
