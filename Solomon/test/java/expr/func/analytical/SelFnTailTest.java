 ...
 */
public class SelFnTailTest {

    @Test
    public void tailOnShortLine() throws Exception {
        ...
        GraphData result = ProgramTestSupport.execExprOnSingleLine("tail(graphData, 10);", source);

        Assert.assertThat(result, CoreMatchers.equalTo(source));
    }

    @Test
    public void tailOnEmptyLine() throws Exception {
        GraphData result = ProgramTestSupport.execExprOnSingleLine("tail(graphData, 10);", GraphData.empty);
        Assert.assertThat(result, CoreMatchers.equalTo(GraphData.empty));
    }

    @Test
    public void tailOnSingleLine() throws Exception {
        GraphData source = GraphData.of(
            point("2017-06-08T10:50:14Z", 123),
        ...
        GraphData result = ProgramTestSupport.execExprOnSingleLine("tail(graphData, 3);", source);
    ...
    @Test
    public void tailForMultipleLines() throws Exception {
        ...
        GraphData[] result = ProgramTestSupport.expression("tail(graphData, 3);")
    ...
    @Test
    public void tailByDurationShort() {
        GraphData source = GraphData.of(
                point("2017-06-08T10:50:14Z", 123),
                point("2017-06-08T10:50:30Z", 321),
                point("2017-06-08T10:50:50Z", 1)
        ...
        GraphData result = ProgramTestSupport.expression("tail(graphData, 1d);")
                .onSingleLine(source)
                .exec()
                .getAsSingleLine();
    ...
    public void tailByDuration() {
        ...
        GraphData result = ProgramTestSupport.expression("tail(graphData, 2m);")
                .onSingleLine(source)
                .exec()
                .getAsSingleLine();
    ...
    @Test
    public void tailVectorByDuration() {
