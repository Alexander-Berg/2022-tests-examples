 ...
 */
public class SelFnKronosVarianceTest {
    ...
    public void emptyTest() {
        GraphData result = ProgramTestSupport
                .expression("kronos_variance(drop_tail(graphData, 10m), graphData, 24 * 60, 5m, +3h, 0.1, 10);")
    ...
    public void singleTest() {
        ...
        GraphData expectedVar = GraphData.of(
                point("2018-06-13T12:00:00Z", 20d / 9), // Wed
                point("2018-06-14T12:00:00Z", 20d / 9), // Thu
                point("2018-06-15T12:00:00Z", 20d / 9), // Fri
                point("2018-06-16T12:00:00Z", 224d / 13), // Sat*
                point("2018-06-17T12:00:00Z", 224d / 13), // Sun*
                point("2018-06-18T12:00:00Z", 20d / 9), // Mon
                point("2018-06-19T12:00:00Z", 20d / 9), // Tue
                point("2018-06-20T12:00:00Z", 20d / 9), // Wed
                point("2018-06-21T12:00:00Z", 20d / 9), // Thu
                point("2018-06-22T12:00:00Z", 20d / 9), // Fri
                point("2018-06-23T12:00:00Z", 224d / 13), // Sat*
                point("2018-06-24T12:00:00Z", 224d / 13), // Sun*
                point("2018-06-25T12:00:00Z", 20d / 9), // Mon
                point("2018-06-26T12:00:00Z", 20d / 9)  // Tue
        );

        GraphData result = ProgramTestSupport
                .expression("kronos_variance(graphData, graphData, 12, 1h, +0h, 0.3, 5);")
                .onSingleLine(source)
                .exec()
                .getAsSingleLine();

        assertApproxEquals(expectedVar, result, 1e-15);
    }

    private SelType getResultTypeFor(String train, String test) {
        return ProgramTestSupport.expression("kronos_variance(" + train + ", " + test + ", 12, 1h, +0h, 0.3, 5);")
    ...
    public void multipleTest() {
        ...
        GraphData expectedVarOne = GraphData.of(
                point("2018-06-13T12:00:00Z", 20d / 9), // Wed
                point("2018-06-14T12:00:00Z", 20d / 9), // Thu
                point("2018-06-15T12:00:00Z", 20d / 9), // Fri
                point("2018-06-16T12:00:00Z", 224d / 13), // Sat*
        ...
        GraphData expectedVarTwo = GraphData.of(
        ...
        GraphData[] result = ProgramTestSupport
                .expression("kronos_variance(graphData, graphData, 12, 1h, +0h, 0.3, 10);")
                .onMultipleLines(one, two)
                .exec()
                .getAsMultipleLines();

        assertApproxEquals(expectedVarOne, result[0], 1e-15);
        assertApproxEquals(expectedVarTwo, result[1], 1e-15);
    }
